...
REPORT r_report(v_rep,v_codigo,v_reg)
   ...
   DEFINE v_rep         CHAR(600),   #registro a tratar
   ...
   DEFINE espacio       SMALLINT       --agregado
   ...
   ON EVERY ROW
      ...
      FOREACH cur_mae INTO p_tabcampo.*
         ...
         IF p_tabcampo.campo_desc = "nom_trabajador"   OR
            p_tabcampo.campo_desc = "rfc" THEN
                  ...
                  ELSE 
                     IF blanco THEN
                        ...
                        IF  p_tabcampo.tipo_dato <> "#" THEN
                            IF  espacio = 0 THEN     --agregado
                                LET v_campo = v_campo CLIPPED, " ", v_rep[j,i]

                                LET espacio = 1         --agregado
                            ELSE                    --agregado
                                LET v_campo = v_campo,v_rep[j,i] --agregado
                            END IF                  --agregado
                        ELSE
                           LET v_campo = v_campo CLIPPED, v_rep[j,i]
                        END IF
