...
MAIN
    ...
    OPEN WINDOW excr0021 AT 4,4 WITH FORM "EXCR0021" ATTRIBUTE(BORDER)
    DISPLAY "                             <CTRL-C> SALIR                                    " AT 1,1 ATTRIBUTE(REVERSE)
    DISPLAY " EXCR002                REVERSO DE PAGOS EN EXCESO ISSSTE                      " AT 3,1 ATTRIBUTE(REVERSE)
    ...
    END RECORD
{
    ...
    DELETE FROM exc_cza_exceso_issste
    WHERE  folio = reg_1.folio
    AND    fecha_recepcion = reg_1.fecha_proceso

    DELETE FROM exc_det_exceso_issste
    WHERE  folio = reg_1.folio

    DELETE FROM exc_dep_exceso_issste
    WHERE  folio = reg_1.folio
    AND    fecha_estado = reg_1.fecha_proceso

    DELETE FROM exc_sum_exceso_issste
    WHERE  folio = reg_1.folio
    AND    fecha_estado = reg_1.fecha_proceso
