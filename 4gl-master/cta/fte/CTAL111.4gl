...
FUNCTION proceso_principal()
    ...
    DISPLAY " CTAL111 " AT 3,1 ATTRIBUTE(REVERSE)
...
FUNCTION Consulta()
    ...
    OPEN WINDOW ventana_21 AT 10,4 WITH FORM "CTAL1112" ATTRIBUTE( BORDER)
    ...
    IF (pos-1) >= 1 THEN
       ...
       ERROR ""
       OPEN WINDOW ventana_2 AT 6,4 WITH FORM "CTAL1111" ATTRIBUTE( BORDER)
       ...
       DISPLAY " CTAL111    Consulta de Provision de Transferencia Decimos               " AT 3,1 ATTRIBUTE(REVERSE,green) 
...
#i-----------------
    ...
    LET G_IMPRE = g_seg_modulo.ruta_listados CLIPPED,"/",g_usuario CLIPPED,
             ".PROV_TRANS_DEC.",HOY USING "DDMMYY","_",hora CLIPPED
...
REPORT rpt_cuenta_imp(g)
    ...
    FORMAT
      PAGE HEADER
        ...
        PRINT COLUMN  2,"CTAL111",
              COLUMN 15,"LISTADO DE PROVISION TRANSFERENCIA DE DECIMOS",
