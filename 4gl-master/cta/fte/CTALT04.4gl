--------------------------------------------------------------------------- 
--Programa    : CTALT04 
--Descripcion : Genera Reporte de Cifras Preliminares TES Id. X EDAD
--Fecha       : 01 Sep 2010 
...
MAIN
 ...
 DISPLAY "CTALT04.",fecha_valuacion using"ddmmyyyy",
         ": INICIANDO GENERACION DE REPORTE SALDOS INICIALES"
 CALL asigna_globales()
 CALL fol_procesados()
 CALL genera_reporte()

 DISPLAY "CTALT04.",fecha_valuacion using"ddmmyyyy",
         ": REPORTE SALDOS INICIALES CONCLUIDO"
 ...
 LET lanzador = "fglgo CTALT03 ",fecha_valuacion
 RUN lanzador 
...
#ag-----------------------
  ...
  LET     g_tabname         =    'safre_tmp:tmp_saldo_edad b '
...
#ci--------------------
 ...
 CALL define_querys()   
---
--- para el previo inicial no se ocupa el tipo de mov
---
...
-- FINISH REPORT rpt_tipmov       
 ...
 DISPLAY " "
 DISPLAY  "CTALT04:REPORTE GLOBAL DE TRANSFERENCIA ID X EDAD GENERADO..."
 DISPLAY " "
