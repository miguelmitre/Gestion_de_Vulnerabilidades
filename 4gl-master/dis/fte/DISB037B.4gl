...
#Sistema           => DIS                                                     #
#Programa          => DISB037B                                                #
#Descripcion       => Inhabilita indices e inserta intereses integrados       #
#                  => a dis_cuenta                                            #
...
MAIN
   ...
   LET nom_spl = "EXECUTE PROCEDURE integra_interes () "
   ...
   LET cla_upd="UPDATE safre_tmp:cta_valida_int ",
               "SET estado_int = 2 "
   PREPARE claupdexe2 FROM cla_upd
   EXECUTE claupdexe2
