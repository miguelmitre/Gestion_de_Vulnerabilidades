...
FUNCTION Integra_interes()
  ...
  LET ins_cursor = "INSERT INTO safre_tmp:dis_cuenta_fov2 values ( 3, ?,0,?,?,?,NULL,0,?,?,?,?,0,0,0,NULL,?,5,TODAY,?,TODAY,1)"
...
FUNCTION Inicializa_tabla()
   ...
   WHENEVER ERROR CONTINUE
      DATABASE safre_tmp
         DROP TABLE dis_cuenta_fov2

         CREATE TABLE dis_cuenta_fov2
           (
