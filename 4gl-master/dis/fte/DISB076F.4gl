...
-- Modulo       => DIS                                                       --
-- Programa     => DISB076F                                                  --
-- Descripcion  => RESPALDO 888 POR nohup saldo de RETIRO BANXICO            --
-- Autor        => DMR                                                       --
...
FUNCTION Respaldo()
   ...
   UNLOAD TO "/safre_dat/resp888/saldo_retbnx"
   SELECT * 
   FROM cta_saldo_retbnx

 LET vchar="mv /safre_dat/resp888/saldo_retbnx /safre_dat/resp888/saldo_retbnx." 
