...
MAIN
   ...
   INTO   g_bat.*
   FROM   dis_ctrl_proceso
   WHERE  dis_ctrl_proceso.proceso_cod = "DISB073B"
...
LET nom_spl="EXECUTE PROCEDURE calcula_interes_fov(",g_reg.tasa_oper,",",
                                                "'",g_reg.fecha_aplica,"'",",",
                                                "'",vfecha_inicio,"'",",",
                                                "'",vfecha_final,"'",",",
                                                "'",usuario,"'",
...
FUNCTION Inicializa_tabla()
   ...
   WHENEVER ERROR CONTINUE
      DATABASE safre_tmp
         DROP TABLE cta_interes_fov

         CREATE TABLE cta_interes_fov
           (
      ...
      CREATE index cta_interes_fov_1 on cta_interes_fov
