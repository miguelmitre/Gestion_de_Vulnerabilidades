...
#Sistema           => DIS   					              #
#Programa          => DISB073F                                                #
#Descripcion       => CALCULA INTERESES DE MONTOS DE RETIRO BANXICO           #
#Modificado por    => DMR                                                     #
...
MAIN
   ...
   INTO   g_bat.*
   FROM   dis_ctrl_proceso
   WHERE  dis_ctrl_proceso.proceso_cod = "DISB073F"
...
FUNCTION agrega()
   ...
   LET nom_spl="EXECUTE PROCEDURE calcula_interes_retbnx(",g_reg.tasa_oper,",",
                                                "'",g_reg.fecha_aplica,"'",",",
                                                "'",vfecha_inicio,"'",",",
                                                "'",vfecha_final,"'",",",
                                                "'",usuario,"'",
...
FUNCTION Inicializa_tabla()
   WHENEVER ERROR CONTINUE
      DATABASE safre_tmp
         DROP TABLE cta_interes_retbnx

         CREATE TABLE cta_interes_retbnx
           (
      ...
      CREATE index cta_interes_bnx_1 on cta_interes_retbnx
