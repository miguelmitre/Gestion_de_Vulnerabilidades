...
#Modulo            => DIS                                                     #
#Programa          => DISB2001I                                               #
#Descripcion       => GENERA HISTORICOS (dis_det_inttran, dis_dep_inttran     #
#                  => dis_cza_inttran, dis_sum_inttran) de ISSSTE             # 
#                  => INTERESES EN TRANSITO,GENERA ARCHIVO DE RESP.           #
#Fecha Inicio      => 23 Octubre 2009                                         #
#Elaboro           => DMR                                                     #
...
#Fecha Mod         => 11 Feb sum solo inttran, cza fechas cambiadas           #
#Fecha Mod         => 29 Ago 2012 Cambio de decimales sumario,reportes para   #
#                  => no enviar warnings al archivo log por variable no cabe  #
#                  => ,se cambio archivo lote y fecha_lote ahora se agrega int#
#Fecha Mod         => 22 Feb 2013 cursor de linea 4019, incorrecto cur_ccta   #
#Fecha Mod         => 29 Abril 2014 DMR  MLM-2602 STARTLOG personalizado,caso #
#                     de 1 curp con 2 nss y 1 inhab. marca 120 nss se rechaza #
#Fecha Mod         => 06 Junio 2014 DMR  MLM-2602 para aportes de retiro en   #
#                     las lineas 1219 y 1234 se validaba si ind_trab_bonos = 0#
#                     se mandaba aporte a la subcta 13 de lo contrario subct30#
#Fecha Mod         => DMR CPL-1645 12/Ene/2015 Estandarizacion de versiones   #
###############################################################################
DATABASE safre_af
...
GLOBALS
   ...
   DEFINE 
      ...
      tot_acep RECORD
         ...
         inte_ext_ahr_sol_tra DECIMAL(15,2),
         inte_ext_ahr_sol_dep DECIMAL(15,2),
         itra_sar_isss        DECIMAL(15,2),
         itra_ret_isss        DECIMAL(15,2),
         itra_cv_isss_pat     DECIMAL(15,2),
         itra_cv_isss_tra     DECIMAL(15,2),
         itra_ext_sar_isss    DECIMAL(15,2),
         itra_ext_ret_isss    DECIMAL(15,2),
         itra_ext_cv_isss_pat DECIMAL(15,2),
         itra_ext_cv_isss_tra DECIMAL(15,2),
         itra_ahr_sol_tra     DECIMAL(15,2),
         itra_ahr_sol_dep     DECIMAL(15,2),
         itra_ext_ahr_sol_tra DECIMAL(15,2),
         itra_ext_ahr_sol_dep DECIMAL(15,2)
      END RECORD,
...
MAIN
   CALL STARTLOG(FGL_GETENV("USER")||".DISB2001I.log")
...
FUNCTION Proceso_principal()
   ...
   IF vfolio <> 0 THEN
      ...
      LET cla_mon = "SELECT h.n_seguro,",
                    ...
                    " h.impt_ahr_sol_tra,",
                    " h.impt_ahr_sol_dep,",
                    " h.inte_ext_ahr_sol_tra,",
                    " h.inte_ext_ahr_sol_dep,",
                    " h.itra_sar_isss,",
                    " h.itra_ret_isss,",
                    " h.itra_cv_isss_pat,",
                    " h.itra_cv_isss_tra,",
                    " h.itra_ext_sar_isss,",
                    " h.itra_ext_ret_isss,",
                    " h.itra_ext_cv_isss_pat,",
                    " h.itra_ext_cv_isss_tra,",
                    " h.itra_ahr_sol_tra,",
                    " h.itra_ahr_sol_dep,",
                    " h.itra_ext_ahr_sol_tra,",
                    " h.itra_ext_ahr_sol_dep,",
                    " h.periodo_pago,",
                    " h.result_operacion,",
                    " h.consec_reg_lote,",
                    " h.n_rfc_entidad,",
                    " h.ind_trab_bono",
                    " FROM   dis_det_inttran h ",
                    " WHERE  h.folio = ? ",
                    " AND    h.n_unico = ? "

      --- crea tabla tmporal para contestar confaf (dis_dep_inttran) ---c22-6
...
FUNCTION Inicializa()
   ...
   LET tot_acep.inte_ext_ahr_sol_tra = 0
   LET tot_acep.inte_ext_ahr_sol_dep = 0
   LET tot_acep.itra_sar_isss        = 0
   LET tot_acep.itra_ret_isss        = 0
   LET tot_acep.itra_cv_isss_pat     = 0
   LET tot_acep.itra_cv_isss_tra     = 0
   LET tot_acep.itra_ext_sar_isss    = 0
   LET tot_acep.itra_ext_ret_isss    = 0
   LET tot_acep.itra_ext_cv_isss_pat = 0
   LET tot_acep.itra_ext_cv_isss_tra = 0
   LET tot_acep.itra_ahr_sol_tra     = 0
   LET tot_acep.itra_ahr_sol_dep     = 0
   LET tot_acep.itra_ext_ahr_sol_tra = 0
   LET tot_acep.itra_ext_ahr_sol_dep = 0
   ...
   LET tot_rech.inte_ext_ahr_sol_tra = 0
   LET tot_rech.inte_ext_ahr_sol_dep = 0
   LET tot_rech.itra_sar_isss        = 0
   LET tot_rech.itra_ret_isss        = 0
   LET tot_rech.itra_cv_isss_pat     = 0
   LET tot_rech.itra_cv_isss_tra     = 0
   LET tot_rech.itra_ext_sar_isss    = 0
   LET tot_rech.itra_ext_ret_isss    = 0
   LET tot_rech.itra_ext_cv_isss_pat = 0
   LET tot_rech.itra_ext_cv_isss_tra = 0
   LET tot_rech.itra_ahr_sol_tra     = 0
   LET tot_rech.itra_ahr_sol_dep     = 0
   LET tot_rech.itra_ext_ahr_sol_tra = 0
   LET tot_rech.itra_ext_ahr_sol_dep = 0
...
FUNCTION Separa_archivo()  -- ETAPA 3
  ...
  reg_ident.nom_archivo CLIPPED," >",gparam_dis.ruta_rescate CLIPPED,"/cza_inttran"
  RUN ejecuta

  LET ejecuta = "grep '^02' ",gparam_dis.ruta_rescate CLIPPED,"/",
  reg_ident.nom_archivo CLIPPED," >",gparam_dis.ruta_rescate CLIPPED,"/det_inttran"
  RUN ejecuta

  LET ejecuta = "grep '^08' ",gparam_dis.ruta_rescate CLIPPED,"/",
  reg_ident.nom_archivo CLIPPED," >",gparam_dis.ruta_rescate CLIPPED,"/dep_inttran"
  RUN ejecuta

  LET ejecuta = "tail -1 ",gparam_dis.ruta_rescate CLIPPED,"/",
  reg_ident.nom_archivo CLIPPED," >",gparam_dis.ruta_rescate CLIPPED,"/sum_inttran"
  RUN ejecuta
END FUNCTION
...
FUNCTION Sube_datos()     -- ETAPA 4
   ...
   LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,
                 "; cut -c 17-24 cza_inttran > fecha_lote_int"
   RUN ejecuta

   LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,
                 "; cut -c 25-27 cza_inttran > lote_int"
   RUN ejecuta
   ...
   LET ejecuta = gparam_dis.ruta_rescate CLIPPED,"/fecha_lote_int" CLIPPED
   LOAD FROM ejecuta INSERT INTO fecha_lote

   LET ejecuta = gparam_dis.ruta_rescate CLIPPED,"/lote_int" CLIPPED
   ...
   IF STATUS = NOTFOUND THEN
      ...
      --------------------   GENERA dis_cza_inttran   --------------------

      LET vreporte = gparam_dis.ruta_rescate CLIPPED,"/vfolio_cza_inttran"
      ...
      LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,
                    "; paste vfolio_cza_inttran cza_inttran > cza1" CLIPPED
      RUN ejecuta

      LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,
                    "/;sed 's/	//g' cza1 > cza_inttran "
      RUN ejecuta

      LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,
            "/;dbload -d safre_af -c sube_cza_inttran -l dbload-i.log"
      RUN ejecuta
      ...
      LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,
                    "; cut -c 1-640 det_inttran > det2"   --c22-11
      RUN ejecuta

      LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,
                    "; cut -c 612-620 det_inttran > det3" --c22-11
      RUN ejecuta

      LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,
                    "; paste -d '1' det2 det3 > det_inttran"
      RUN ejecuta
      ...
      LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,
                    "; paste vfolio_det_inttran det_inttran > det1" CLIPPED
      RUN ejecuta

      -- Se crea det eliminando espacio en blanco que se genera cuando
      -- se pegan los 2 archivos
      LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,
                    "/;sed 's/	//g' det1 > det_inttran "
      RUN ejecuta

      LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,
                    "; rm det1 vfolio_det_inttran"
      RUN ejecuta

      -- Se suben los datos del detalle
      LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,
                    "/;dbload -d safre_af -c sube_det_inttran -l dbload-i.log;"
      RUN ejecuta

      LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,"; rm det_inttran"
      RUN ejecuta

      --------------------   GENERA dis_dep_inttran  --------------------

      LET vreporte = gparam_dis.ruta_rescate CLIPPED,"/vfolio_dep_inttran"
      START REPORT salida TO vreporte
      ...
      LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,
                    "; cat adi vfolio_dep_inttran > dep01_1 " CLIPPED
      RUN ejecuta
      ...
      LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,
                    "; sed -f dep01_1 dep_inttran > dep01_2 " CLIPPED
      RUN ejecuta

      LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,
                    "; sed -f dep02_1 dep_inttran > dep02_2 " CLIPPED
      RUN ejecuta
      ...
      LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,
                    "; cut -c 1-84 dep_inttran > dep2; mv dep2 dep_inttran "
      RUN ejecuta

      LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,
                    "; paste dep01_3 dep_inttran dep02_3 > dep1;"
      RUN ejecuta

      LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,
                    "/;sed 's/	//g' dep1 > dep_inttran "
      RUN ejecuta

      LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,
"/;DBDATE=Y4MD0;export DBDATE;dbload -d safre_af -c sube_dep_inttran -l dbload-i.log"
      RUN ejecuta

      LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,
      "; rm  vfolio_dep_inttran vfolio_dep2 dep01_1 dep02_1 dep01_2 dep02_2 dep01_3 dep02_3 dep_inttran dep1"

      RUN ejecuta


      --------------------   GENERA dis_sum_inttran   --------------------

      LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,
                    "; paste vfolio_cza_inttran sum_inttran > sum1" CLIPPED
      RUN ejecuta

      LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,
                    "/;sed 's/	//g' sum1 > sum_inttran "
      RUN ejecuta

      LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,
            "/;dbload -d safre_af -c sube_sum_inttran -l dbload-i.log"
      RUN ejecuta

      LET ejecuta = "cd ",gparam_dis.ruta_rescate CLIPPED,
            "; rm sum1 sum_inttran lote_int fecha_lote_int vfolio_cza_inttran dbload-i.log"
      RUN ejecuta
...
FUNCTION Genera_aportes_nor(vfolio)    -- ETAPA 5 
   DEFINE
     ...
     vinte_ext_ahr_sol_tra     DECIMAL(15,2),
     vinte_ext_ahr_sol_dep     DECIMAL(15,2),
     vitra_sar_isss            DECIMAL(15,2),
     vitra_ret_isss            DECIMAL(15,2),
     vitra_cv_isss_pat         DECIMAL(15,2),
     vitra_cv_isss_tra         DECIMAL(15,2),
     vitra_ext_sar_isss        DECIMAL(15,2),
     vitra_ext_ret_isss        DECIMAL(15,2),
     vitra_ext_cv_isss_pat     DECIMAL(15,2),
     vitra_ext_cv_isss_tra     DECIMAL(15,2),
     vitra_ahr_sol_tra         DECIMAL(15,2),
     vitra_ahr_sol_dep         DECIMAL(15,2),
     vitra_ext_ahr_sol_tra     DECIMAL(15,2),
     vitra_ext_ahr_sol_dep     DECIMAL(15,2),
    ...
    FOREACH cur_val INTO dcurp
       ...
       FOREACH cur_hist INTO  reg.*, ind_trab_bonos
          ...
          LET vinte_ext_ahr_sol_tra = reg.inte_ext_ahr_sol_tra / 100
          LET vinte_ext_ahr_sol_dep = reg.inte_ext_ahr_sol_dep / 100
          LET vitra_sar_isss        = reg.itra_sar_isss        / 100
          LET vitra_ret_isss        = reg.itra_ret_isss        / 100
          LET vitra_cv_isss_pat     = reg.itra_cv_isss_pat     / 100
          LET vitra_cv_isss_tra     = reg.itra_cv_isss_tra     / 100
          LET vitra_ext_sar_isss    = reg.itra_ext_sar_isss    / 100
          LET vitra_ext_ret_isss    = reg.itra_ext_ret_isss    / 100
          LET vitra_ext_cv_isss_pat = reg.itra_ext_cv_isss_pat / 100
          LET vitra_ext_cv_isss_tra = reg.itra_ext_cv_isss_tra / 100
          LET vitra_ahr_sol_tra     = reg.itra_ahr_sol_tra     / 100
          LET vitra_ahr_sol_dep     = reg.itra_ahr_sol_dep     / 100
          LET vitra_ext_ahr_sol_tra = reg.itra_ext_ahr_sol_tra / 100
          LET vitra_ext_ahr_sol_dep = reg.itra_ext_ahr_sol_dep / 100
          ...
          IF vind_rechazo = 1 THEN
             ...
             CALL Sumatoria_rechazo(vimpt_sar_isss,
                                    ...
                                    vimpt_ahr_sol_tra,
                                    vimpt_ahr_sol_dep,
                                    vinte_ext_ahr_sol_tra,
                                    vinte_ext_ahr_sol_dep,
                                    vitra_sar_isss,
                                    vitra_ret_isss,
                                    vitra_cv_isss_pat,
                                    vitra_cv_isss_tra,
                                    vitra_ext_sar_isss,
                                    vitra_ext_ret_isss,
                                    vitra_ext_cv_isss_pat,
                                    vitra_ext_cv_isss_tra,
                                    vitra_ahr_sol_tra,
                                    vitra_ahr_sol_dep,
                                    vitra_ext_ahr_sol_tra,
                                    vitra_ext_ahr_sol_dep)

             UPDATE dis_det_inttran
...
{#APORTES    IF vimpt_sar_isss > 0 THEN
...
CALL Dispersa_aporte(vfolio,reg.nss,reg.curp,vcoduni,reg.fecha_pago,reg.fecha_rviv,vimpt_cv_isss_tra,31,1,vfentcons,reg.consec_reg_lote,0,0,reg.n_rfc_entidad)
             END IF
...
CALL Dispersa_aporte(vfolio,reg.nss,reg.curp,vcoduni,reg.fecha_pago,reg.fecha_rviv,vinte_ext_cv_isss_tra,31,3,vfentcons,reg.consec_reg_lote,0,0,reg.n_rfc_entidad)
             END IF
...
CALL Dispersa_aporte(vfolio,reg.nss,reg.curp,vcoduni,reg.fecha_pago,reg.fecha_rviv,vimpt_ahr_sol_dep,33,1,vfentcons,reg.consec_reg_lote,0,0,reg.n_rfc_entidad)
             ...
             IF vinte_ext_ahr_sol_tra > 0 THEN
CALL Dispersa_aporte(vfolio,reg.nss,reg.curp,vcoduni,reg.fecha_pago,reg.fecha_rviv,vinte_ext_ahr_sol_tra,34,3,vfentcons,reg.consec_reg_lote,0,0,reg.n_rfc_entidad)
             END IF

             IF vinte_ext_ahr_sol_dep > 0 THEN
CALL Dispersa_aporte(vfolio,reg.nss,reg.curp,vcoduni,reg.fecha_pago,reg.fecha_rviv,vinte_ext_ahr_sol_dep,33,3,vfentcons,reg.consec_reg_lote,0,0,reg.n_rfc_entidad)
             END IF
 APORTES #}

             IF vitra_sar_isss > 0 THEN
CALL Dispersa_aporte(vfolio,reg.nss,reg.curp,vcoduni,reg.fecha_pago,reg.fecha_rviv,vitra_sar_isss,13,4,vfentcons,reg.consec_reg_lote,0,0,reg.n_rfc_entidad)
             END IF

             IF vitra_ret_isss > 0 THEN           ##MLM-2602
CALL Dispersa_aporte(vfolio,reg.nss,reg.curp,vcoduni,reg.fecha_pago,reg.fecha_rviv,vitra_ret_isss,30,4,vfentcons,reg.consec_reg_lote,0,0,reg.n_rfc_entidad)
             END IF

             IF vitra_cv_isss_pat > 0 THEN
CALL Dispersa_aporte(vfolio,reg.nss,reg.curp,vcoduni,reg.fecha_pago,reg.fecha_rviv,vitra_cv_isss_pat,31,4,vfentcons,reg.consec_reg_lote,0,0,reg.n_rfc_entidad)
             END IF

             IF vitra_cv_isss_tra > 0 THEN
CALL Dispersa_aporte(vfolio,reg.nss,reg.curp,vcoduni,reg.fecha_pago,reg.fecha_rviv,vitra_cv_isss_tra,31,4,vfentcons,reg.consec_reg_lote,0,0,reg.n_rfc_entidad)
             END IF

             IF vitra_ext_sar_isss > 0 THEN
CALL Dispersa_aporte(vfolio,reg.nss,reg.curp,vcoduni,reg.fecha_pago,reg.fecha_rviv,vitra_ext_sar_isss,13,2,vfentcons,reg.consec_reg_lote,0,0,reg.n_rfc_entidad)
             END IF

             IF vitra_ext_ret_isss > 0 THEN       ##MLM-2602
CALL Dispersa_aporte(vfolio,reg.nss,reg.curp,vcoduni,reg.fecha_pago,reg.fecha_rviv,vitra_ext_ret_isss,30,2,vfentcons,reg.consec_reg_lote,0,0,reg.n_rfc_entidad)
             END IF

             IF vitra_ext_cv_isss_pat > 0 THEN
CALL Dispersa_aporte(vfolio,reg.nss,reg.curp,vcoduni,reg.fecha_pago,reg.fecha_rviv,vitra_ext_cv_isss_pat,31,2,vfentcons,reg.consec_reg_lote,0,0,reg.n_rfc_entidad)
             END IF

             IF vitra_ext_cv_isss_tra > 0 THEN
CALL Dispersa_aporte(vfolio,reg.nss,reg.curp,vcoduni,reg.fecha_pago,reg.fecha_rviv,vitra_ext_cv_isss_tra,31,2,vfentcons,reg.consec_reg_lote,0,0,reg.n_rfc_entidad)
             END IF

             IF vitra_ahr_sol_tra > 0 THEN
CALL Dispersa_aporte(vfolio,reg.nss,reg.curp,vcoduni,reg.fecha_pago,reg.fecha_rviv,vitra_ahr_sol_tra,34,4,vfentcons,reg.consec_reg_lote,0,0,reg.n_rfc_entidad)
             END IF

             IF vitra_ahr_sol_dep > 0 THEN
CALL Dispersa_aporte(vfolio,reg.nss,reg.curp,vcoduni,reg.fecha_pago,reg.fecha_rviv,vitra_ahr_sol_dep,33,4,vfentcons,reg.consec_reg_lote,0,0,reg.n_rfc_entidad)
             END IF

             IF vitra_ext_ahr_sol_tra > 0 THEN
CALL Dispersa_aporte(vfolio,reg.nss,reg.curp,vcoduni,reg.fecha_pago,reg.fecha_rviv,vitra_ext_ahr_sol_tra,34,2,vfentcons,reg.consec_reg_lote,0,0,reg.n_rfc_entidad)
             END IF

             IF vitra_ext_ahr_sol_dep > 0 THEN
CALL Dispersa_aporte(vfolio,reg.nss,reg.curp,vcoduni,reg.fecha_pago,reg.fecha_rviv,vitra_ext_ahr_sol_dep,33,2,vfentcons,reg.consec_reg_lote,0,0,reg.n_rfc_entidad)
             END IF
...
CALL Dispersa_comision(vfolio,reg.nss,reg.curp,vcoduni,"COM_ISS_CVT" ,reg.fecha_pago,reg.fecha_rviv,vimpt_cv_isss_tra,31,vfentcons,reg.consec_reg_lote)
          ...
          LET vinte_ext_ahr_sol_tra = 0
          LET vinte_ext_ahr_sol_dep = 0
          LET vitra_sar_isss        = 0
          LET vitra_ret_isss        = 0
          LET vitra_cv_isss_pat     = 0
          LET vitra_cv_isss_tra     = 0
          LET vitra_ext_sar_isss    = 0
          LET vitra_ext_ret_isss    = 0
          LET vitra_ext_cv_isss_pat = 0
          LET vitra_ext_cv_isss_tra = 0
          LET vitra_ahr_sol_tra     = 0
          LET vitra_ahr_sol_dep     = 0
          LET vitra_ext_ahr_sol_tra = 0
          LET vitra_ext_ahr_sol_dep = 0
...
LET tot_rech.inte_ext_ahr_sol_tra = tot_rech.inte_ext_ahr_sol_tra +
                                    vinte_ext_ahr_sol_tra 
LET tot_rech.inte_ext_ahr_sol_dep = tot_rech.inte_ext_ahr_sol_dep +
                                    vinte_ext_ahr_sol_dep

LET tot_rech.itra_sar_isss     = tot_rech.itra_sar_isss     + vitra_sar_isss
LET tot_rech.itra_ret_isss     = tot_rech.itra_ret_isss     + vitra_ret_isss
LET tot_rech.itra_cv_isss_pat  = tot_rech.itra_cv_isss_pat  + vitra_cv_isss_pat
LET tot_rech.itra_cv_isss_tra  = tot_rech.itra_cv_isss_tra  + vitra_cv_isss_tra
LET tot_rech.itra_ext_sar_isss = tot_rech.itra_ext_sar_isss + vitra_ext_sar_isss
LET tot_rech.itra_ext_ret_isss = tot_rech.itra_ext_ret_isss + vitra_ext_ret_isss

LET tot_rech.itra_ext_cv_isss_pat = tot_rech.itra_ext_cv_isss_pat +
                                    vitra_ext_cv_isss_pat
LET tot_rech.itra_ext_cv_isss_tra = tot_rech.itra_ext_cv_isss_tra +
                                    vitra_ext_cv_isss_tra

LET tot_rech.itra_ahr_sol_tra  = tot_rech.itra_ahr_sol_tra + vitra_ahr_sol_tra
LET tot_rech.itra_ahr_sol_dep  = tot_rech.itra_ahr_sol_dep + vitra_ahr_sol_dep

LET tot_rech.itra_ext_ahr_sol_tra = tot_rech.itra_ext_ahr_sol_tra +
                                    vitra_ext_ahr_sol_tra
LET tot_rech.itra_ext_ahr_sol_dep = tot_rech.itra_ext_ahr_sol_dep +
                                    vitra_ext_ahr_sol_dep
...
LET tot_acep.inte_ext_ahr_sol_tra = tot_acep.inte_ext_ahr_sol_tra +
                                    vinte_ext_ahr_sol_tra
LET tot_acep.inte_ext_ahr_sol_dep = tot_acep.inte_ext_ahr_sol_dep +
                                    vinte_ext_ahr_sol_dep

LET tot_acep.itra_sar_isss     = tot_acep.itra_sar_isss     + vitra_sar_isss
LET tot_acep.itra_ret_isss     = tot_acep.itra_ret_isss     + vitra_ret_isss
LET tot_acep.itra_cv_isss_pat  = tot_acep.itra_cv_isss_pat  + vitra_cv_isss_pat
LET tot_acep.itra_cv_isss_tra  = tot_acep.itra_cv_isss_tra  + vitra_cv_isss_tra

LET tot_acep.itra_ext_sar_isss = tot_acep.itra_ext_sar_isss + vitra_ext_sar_isss
LET tot_acep.itra_ext_ret_isss = tot_acep.itra_ext_ret_isss + vitra_ext_ret_isss

LET tot_acep.itra_ext_cv_isss_pat = tot_acep.itra_ext_cv_isss_pat +
                                    vitra_ext_cv_isss_pat
LET tot_acep.itra_ext_cv_isss_tra = tot_acep.itra_ext_cv_isss_tra +
                                    vitra_ext_cv_isss_tra

LET tot_acep.itra_ahr_sol_tra  = tot_acep.itra_ahr_sol_tra + vitra_ahr_sol_tra
LET tot_acep.itra_ahr_sol_dep  = tot_acep.itra_ahr_sol_dep + vitra_ahr_sol_dep

LET tot_acep.itra_ext_ahr_sol_tra = tot_acep.itra_ext_ahr_sol_tra +
                                    vitra_ext_ahr_sol_tra
LET tot_acep.itra_ext_ahr_sol_dep = tot_acep.itra_ext_ahr_sol_dep +
                                    vitra_ext_ahr_sol_dep
...
FUNCTION Genera_confaf(vfolio)          -- ETAPA 7 
   ...
   DEFINE
      ...
      acept_sar_isss             DECIMAL(12,2),
      acept_ret_isss             DECIMAL(12,2),
      acept_cv_isss_pat          DECIMAL(12,2),
      acept_cv_isss_tra          DECIMAL(12,2),
      acept_ext_sar_isss         DECIMAL(12,2),
      acept_ext_ret_isss         DECIMAL(12,2),
      acept_ext_cv_isss_pat      DECIMAL(12,2),
      acept_ext_cv_isss_tra      DECIMAL(12,2),
      acept_ahr_sol_tra          DECIMAL(12,2),
      acept_ahr_sol_dep          DECIMAL(12,2),
      acept_ext_ahr_sol_tra      DECIMAL(12,2),
      acept_ext_ahr_sol_dep      DECIMAL(12,2),
      acept_itra_sar_isss        DECIMAL(12,2),
      acept_itra_ret_isss        DECIMAL(12,2),
      acept_itra_cv_isss_pat     DECIMAL(12,2),
      acept_itra_cv_isss_tra     DECIMAL(12,2),
      acept_itra_ext_sar_isss    DECIMAL(12,2),
      acept_itra_ext_ret_isss    DECIMAL(12,2),
      acept_itra_ext_cv_isss_pat DECIMAL(12,2),
      acept_itra_ext_cv_isss_tra DECIMAL(12,2),
      acept_itra_ahr_sol_tra     DECIMAL(12,2),
      acept_itra_ahr_sol_dep     DECIMAL(12,2),
      acept_itra_ext_ahr_sol_tra DECIMAL(12,2),
      acept_itra_ext_ahr_sol_dep DECIMAL(12,2),

      recha_sar_isss             DECIMAL(12,2),
      recha_ret_isss             DECIMAL(12,2),
      recha_cv_isss_pat          DECIMAL(12,2), 
      recha_cv_isss_tra          DECIMAL(12,2),
      recha_ext_sar_isss         DECIMAL(12,2),
      recha_ext_ret_isss         DECIMAL(12,2),
      recha_ext_cv_isss_pat      DECIMAL(12,2),
      recha_ext_cv_isss_tra      DECIMAL(12,2),
      recha_ahr_sol_tra          DECIMAL(12,2),
      recha_ahr_sol_dep          DECIMAL(12,2),
      recha_ext_ahr_sol_tra      DECIMAL(12,2),
      recha_ext_ahr_sol_dep      DECIMAL(12,2),
      recha_itra_sar_isss        DECIMAL(12,2),
      recha_itra_ret_isss        DECIMAL(12,2),
      recha_itra_cv_isss_pat     DECIMAL(12,2),
      recha_itra_cv_isss_tra     DECIMAL(12,2),
      recha_itra_ext_sar_isss    DECIMAL(12,2),
      recha_itra_ext_ret_isss    DECIMAL(12,2),
      recha_itra_ext_cv_isss_pat DECIMAL(12,2),
      recha_itra_ext_cv_isss_tra DECIMAL(12,2),
      recha_itra_ahr_sol_tra     DECIMAL(12,2),
      recha_itra_ahr_sol_dep     DECIMAL(12,2),
      recha_itra_ext_ahr_sol_tra DECIMAL(12,2),
      recha_itra_ext_ahr_sol_dep DECIMAL(12,2)
   ...
   DEFINE g_dep RECORD LIKE dis_dep_inttran.*
   ...
   LET acept_ext_ahr_sol_tra      = tot_acep.inte_ext_ahr_sol_tra
   LET acept_ext_ahr_sol_dep      = tot_acep.inte_ext_ahr_sol_dep
   LET acept_itra_sar_isss        = tot_acep.itra_sar_isss
   LET acept_itra_ret_isss        = tot_acep.itra_ret_isss
   LET acept_itra_cv_isss_pat     = tot_acep.itra_cv_isss_pat
   LET acept_itra_cv_isss_tra     = tot_acep.itra_cv_isss_tra
   LET acept_itra_ext_sar_isss    = tot_acep.itra_ext_sar_isss
   LET acept_itra_ext_ret_isss    = tot_acep.itra_ext_ret_isss
   LET acept_itra_ext_cv_isss_pat = tot_acep.itra_ext_cv_isss_pat
   LET acept_itra_ext_cv_isss_tra = tot_acep.itra_ext_cv_isss_tra 
   LET acept_itra_ahr_sol_tra     = tot_acep.itra_ahr_sol_tra
   LET acept_itra_ahr_sol_dep     = tot_acep.itra_ahr_sol_dep
   LET acept_itra_ext_ahr_sol_tra = tot_acep.itra_ext_ahr_sol_tra
   LET acept_itra_ext_ahr_sol_dep = tot_acep.itra_ext_ahr_sol_dep
   ...
   LET recha_ext_ahr_sol_tra      = tot_rech.inte_ext_ahr_sol_tra
   LET recha_ext_ahr_sol_dep      = tot_rech.inte_ext_ahr_sol_dep
   LET recha_itra_sar_isss        = tot_rech.itra_sar_isss
   LET recha_itra_ret_isss        = tot_rech.itra_ret_isss
   LET recha_itra_cv_isss_pat     = tot_rech.itra_cv_isss_pat
   LET recha_itra_cv_isss_tra     = tot_rech.itra_cv_isss_tra
   LET recha_itra_ext_sar_isss    = tot_rech.itra_ext_sar_isss
   LET recha_itra_ext_ret_isss    = tot_rech.itra_ext_ret_isss
   LET recha_itra_ext_cv_isss_pat = tot_rech.itra_ext_cv_isss_pat
   LET recha_itra_ext_cv_isss_tra = tot_rech.itra_ext_cv_isss_tra
   LET recha_itra_ahr_sol_tra     = tot_rech.itra_ahr_sol_tra
   LET recha_itra_ahr_sol_dep     = tot_rech.itra_ahr_sol_dep
   LET recha_itra_ext_ahr_sol_tra = tot_rech.itra_ext_ahr_sol_tra
   LET recha_itra_ext_ahr_sol_dep = tot_rech.itra_ext_ahr_sol_dep
   ...
   IF vcuantos = 0 THEN                        # Archivo Completo Rechazado
      ...
      SELECT ident_pago[14,15] FROM dis_dep_inttran
      WHERE folio = vfolio
      ...
      CASE
         ...
         WHEN vsub = "47"
            LET vrechazo = recha_ahr_sol_tra      + recha_ahr_sol_dep     +
                           recha_ext_ahr_sol_tra  + recha_ext_ahr_sol_dep
         WHEN vsub = "51"
            LET vrechazo = recha_itra_ret_isss    + recha_itra_ext_ret_isss    +
                           recha_itra_cv_isss_pat + recha_itra_ext_cv_isss_pat +
                           recha_itra_cv_isss_tra + recha_itra_ext_cv_isss_tra 
         WHEN vsub = "53"
            LET vrechazo = recha_itra_sar_isss    + recha_itra_ext_sar_isss
         WHEN vsub = "57"
            LET vrechazo = recha_itra_ahr_sol_tra     + recha_itra_ahr_sol_dep +
                           recha_itra_ext_ahr_sol_tra + recha_itra_ext_ahr_sol_dep
...
--    IF vsie = 1 THEN                                         --c22-6.3
      ...
      IF vcuantos = 1 THEN                                     --c22-6.3
         ...
         IF vrechazo > 0 THEN                                  --c22-6.9
            ...
            INSERT INTO dis_dep_inttran VALUES                 --c22-6.9
              (                                                --c22-6.9
              g_dep.folio,                                     --c22-6.9
      ...
      ELSE                                                     --c22-6.3
         ...
         --   END IF                                           --c22-6.5
            ...
            UPDATE dis_dep_inttran                             --c22-6.3
            SET    importe          = importe / 100,           --c22-6.5
        ...
        --  END IF                                             --c22-119
            ...
            INSERT INTO dis_dep_inttran VALUES                 --c22-6
              (                                                --c22-6
              g_dep.folio,                                     --c22-6
...
-- AND   ident_pago       = g_dep.ident_pago
   ...
   CALL Genera_salidas(vfolio,
                       ...
                       acept_ahr_sol_tra,
                       acept_ahr_sol_dep,
                       acept_ext_ahr_sol_tra,
                       acept_ext_ahr_sol_dep,
                       acept_itra_sar_isss,
                       acept_itra_ret_isss,
                       acept_itra_cv_isss_pat,
                       acept_itra_cv_isss_tra,
                       acept_itra_ext_sar_isss,
                       acept_itra_ext_ret_isss,
                       acept_itra_ext_cv_isss_pat,
                       acept_itra_ext_cv_isss_tra,
                       acept_itra_ahr_sol_tra,
                       acept_itra_ahr_sol_dep,
                       acept_itra_ext_ahr_sol_tra,
                       acept_itra_ext_ahr_sol_dep,
                       ...
                       recha_ahr_sol_tra,
                       recha_ahr_sol_dep,
                       recha_ext_ahr_sol_tra,
                       recha_ext_ahr_sol_dep,
                       recha_itra_sar_isss,
                       recha_itra_ret_isss,
                       recha_itra_cv_isss_pat,
                       recha_itra_cv_isss_tra,
                       recha_itra_ext_sar_isss,
                       recha_itra_ext_ret_isss,
                       recha_itra_ext_cv_isss_pat,
                       recha_itra_ext_cv_isss_tra,
                       recha_itra_ahr_sol_tra,
                       recha_itra_ahr_sol_dep,
                       recha_itra_ext_ahr_sol_tra,
                       recha_itra_ext_ahr_sol_dep
                       )
...
FUNCTION Genera_salidas(vfolio,
   ...
   DEFINE 
      ...
      acept_ext_ahr_sol_tra      DECIMAL(16,2),
      acept_ext_ahr_sol_dep      DECIMAL(16,2),
      acept_itra_sar_isss        DECIMAL(16,2),
      acept_itra_ret_isss        DECIMAL(16,2),
      acept_itra_cv_isss_pat     DECIMAL(16,2),
      acept_itra_cv_isss_tra     DECIMAL(16,2),
      acept_itra_ext_sar_isss    DECIMAL(16,2),
      acept_itra_ext_ret_isss    DECIMAL(16,2),
      acept_itra_ext_cv_isss_pat DECIMAL(16,2),
      acept_itra_ext_cv_isss_tra DECIMAL(16,2),
      acept_itra_ahr_sol_tra     DECIMAL(16,2),
      acept_itra_ahr_sol_dep     DECIMAL(16,2),
      acept_itra_ext_ahr_sol_tra DECIMAL(16,2),
      acept_itra_ext_ahr_sol_dep DECIMAL(16,2),
      ...
      recha_ext_ahr_sol_tra      DECIMAL(16,2),
      recha_ext_ahr_sol_dep      DECIMAL(16,2),
      recha_itra_sar_isss        DECIMAL(16,2),
      recha_itra_ret_isss        DECIMAL(16,2),
      recha_itra_cv_isss_pat     DECIMAL(16,2),
      recha_itra_cv_isss_tra     DECIMAL(16,2),
      recha_itra_ext_sar_isss    DECIMAL(16,2),
      recha_itra_ext_ret_isss    DECIMAL(16,2),
      recha_itra_ext_cv_isss_pat DECIMAL(16,2),
      recha_itra_ext_cv_isss_tra DECIMAL(16,2),
      recha_itra_ahr_sol_tra     DECIMAL(16,2),
      recha_itra_ahr_sol_dep     DECIMAL(16,2),
      recha_itra_ext_ahr_sol_tra DECIMAL(16,2),
      recha_itra_ext_ahr_sol_dep DECIMAL(16,2)
   ...
   DEFINE reg_cza RECORD
      ...
      fecha_ini_noti1            CHAR(08),
      fecha_fin_noti1            CHAR(08),
      fecha_liq_interes          CHAR(08),
      result_operacion           CHAR(02),
   ...
   DEFINE reg_rech RECORD
      ...
      impt_sar_isss              DECIMAL(16,2),
      impt_ret_isss              DECIMAL(16,2),
      impt_cv_isss_pat           DECIMAL(16,2),
      impt_cv_isss_tra           DECIMAL(16,2),
      inte_ext_sar_isss          DECIMAL(16,2),
      inte_ext_ret_isss          DECIMAL(16,2),
      inte_ext_cv_isss_pat       DECIMAL(16,2),
      inte_ext_cv_isss_tra       DECIMAL(16,2),
      impt_ahr_sol_tra           DECIMAL(16,2),
      impt_ahr_sol_dep           DECIMAL(16,2),
      inte_ext_ahr_sol_tra       DECIMAL(16,2),
      inte_ext_ahr_sol_dep       DECIMAL(16,2),
      itra_sar_isss              DECIMAL(16,2),
      itra_ret_isss              DECIMAL(16,2),
      itra_cv_isss_pat           DECIMAL(16,2),
      itra_cv_isss_tra           DECIMAL(16,2),
      itra_ext_sar_isss          DECIMAL(16,2),
      itra_ext_ret_isss          DECIMAL(16,2),
      itra_ext_cv_isss_pat       DECIMAL(16,2),
      itra_ext_cv_isss_tra       DECIMAL(16,2),
      itra_ahr_sol_tra           DECIMAL(16,2),
      itra_ahr_sol_dep           DECIMAL(16,2),
      itra_ext_ahr_sol_tra       DECIMAL(16,2),
      itra_ext_ahr_sol_dep       DECIMAL(16,2),
      impt_total_inte            DECIMAL(16,2),
      filler                     CHAR(60),
   ...
   DEFINE reg_sum RECORD
      ...
      fech_creac_lote            CHAR(08),
      lote_del_dia               CHAR(03),
      t_impt_sar_isss            DECIMAL(18,2),
      t_impt_ret_isss            DECIMAL(18,2),
      t_impt_cv_isss_pat         DECIMAL(18,2),
      t_impt_cv_isss_tra         DECIMAL(18,2),
      t_inte_ext_sar_isss        DECIMAL(18,2),
      t_inte_ext_ret_isss        DECIMAL(18,2),
      t_inte_ext_cv_isss_pat     DECIMAL(18,2),
      t_inte_ext_cv_isss_tra     DECIMAL(18,2),
      t_impt_ahr_sol_tra         DECIMAL(18,2),
      t_impt_ahr_sol_dep         DECIMAL(18,2),
      t_inte_ext_ahr_sol_tra     DECIMAL(18,2),
      t_inte_ext_ahr_sol_dep     DECIMAL(18,2),
      t_itra_sar_isss            DECIMAL(18,2),
      t_itra_ret_isss            DECIMAL(18,2),
      t_itra_cv_isss_pat         DECIMAL(18,2),
      t_itra_cv_isss_tra         DECIMAL(18,2),
      t_itra_ext_sar_isss        DECIMAL(18,2),
      t_itra_ext_ret_isss        DECIMAL(18,2),
      t_itra_ext_cv_isss_pat     DECIMAL(18,2),
      t_itra_ext_cv_isss_tra     DECIMAL(18,2),
      t_itra_ahr_sol_tra         DECIMAL(18,2),
      t_itra_ahr_sol_dep         DECIMAL(18,2),
      t_itra_ext_ahr_sol_tra     DECIMAL(18,2),
      t_itra_ext_ahr_sol_dep     DECIMAL(18,2),
      t_impt_total_inte          DECIMAL(18,2),
      num_de_reg_aport           CHAR(9),
      num_cuentas_xpagar         CHAR(6),
      impt_total_xpagar          DECIMAL(15,2)
   END RECORD,
   ...
   vinte_tot_ext_ahr_sol_tra     DECIMAL(17,2),
   vinte_tot_ext_ahr_sol_dep     DECIMAL(17,2),
   vitra_tot_sar_isss            DECIMAL(17,2),
   vitra_tot_ret_isss            DECIMAL(17,2),
   vitra_tot_cv_isss_pat         DECIMAL(17,2),
   vitra_tot_cv_isss_tra         DECIMAL(17,2),
   vitra_tot_ext_sar_isss        DECIMAL(17,2),
   vitra_tot_ext_ret_isss        DECIMAL(17,2),
   vitra_tot_ext_cv_isss_pat     DECIMAL(17,2),
   vitra_tot_ext_cv_isss_tra     DECIMAL(17,2),
   vitra_tot_ahr_sol_tra         DECIMAL(17,2),
   vitra_tot_ahr_sol_dep         DECIMAL(17,2),
   vitra_tot_ext_ahr_sol_tra     DECIMAL(17,2),
   vitra_tot_ext_ahr_sol_dep     DECIMAL(17,2),
   ...
   SELECT
      ...
      a.impt_ahr_sol_tra,
      a.impt_ahr_sol_dep,
      a.inte_ext_ahr_sol_tra,
      a.inte_ext_ahr_sol_dep,
      a.itra_sar_isss,
      a.itra_ret_isss,
      a.itra_cv_isss_pat,
      a.itra_cv_isss_tra,
      a.itra_ext_sar_isss,
      a.itra_ext_ret_isss,
      a.itra_ext_cv_isss_pat,
      a.itra_ext_cv_isss_tra,
      a.itra_ahr_sol_tra,
      a.itra_ahr_sol_dep,
      a.itra_ext_ahr_sol_tra,
      a.itra_ext_ahr_sol_dep,
      a.impt_total_inte,
      a.filler,
      a.result_operacion,
      a.det_mot_rechazo1,
   ...
   FOREACH cur_41 INTO xident_siefore,xtipo_siefore              --c22-6.6
      ...
      IF STATUS <> NOTFOUND THEN                                 --c22-6.6
         IF vimpt_acept = 0 AND vtipo_sie = 0 THEN               --c22-6.6
            UPDATE dis_dep_inttran                               --c22-6.6
   ...
   SELECT tipo_registro,
          ...
          t_inte_ext_sar_isss,
          t_inte_ext_ret_isss,
          t_inte_ext_cv_isss_pat,
          t_inte_ext_cv_isss_tra,
          t_impt_ahr_sol_tra,
          t_impt_ahr_sol_dep,
          t_inte_ext_ahr_sol_tra,
          t_inte_ext_ahr_sol_dep,
          t_itra_sar_isss,
          t_itra_ret_isss,
          t_itra_cv_isss_pat,
          t_itra_cv_isss_tra,
          t_itra_ext_sar_isss,
          t_itra_ext_ret_isss,
          t_itra_ext_cv_isss_pat,
          t_itra_ext_cv_isss_tra,
          t_itra_ahr_sol_tra,
          t_itra_ahr_sol_dep,
          t_itra_ext_ahr_sol_tra,
          t_itra_ext_ahr_sol_dep,
          t_impt_total_inte,
          num_de_reg_aport,
          num_cuentas_xpagar,
          impt_total_xpagar
   FROM   dis_sum_inttran
   WHERE  folio = vfolio
   FOR UPDATE
   ...
   START REPORT rep_sum TO vreporte
      FOREACH cur_sum INTO reg_sum.*
         ...
         SELECT sum(impt_total_inte) 
         INTO reg_sum.t_impt_total_inte
         FROM dis_det_inttran
         WHERE folio = vfolio
         AND   result_operacion = "02"

         IF reg_sum.t_impt_total_inte IS NULL THEN
            LET reg_sum.t_impt_total_inte = 0
         END IF

         UPDATE dis_sum_inttran
         SET   t_impt_sar_isss        = recha_sar_isss     + acept_sar_isss,
               t_impt_ret_isss        = recha_ret_isss     + acept_ret_isss,
               t_impt_cv_isss_pat     = recha_cv_isss_pat  + acept_cv_isss_pat,
               t_impt_cv_isss_tra     = recha_cv_isss_tra  + acept_cv_isss_tra,
               t_inte_ext_ret_isss    = recha_ext_ret_isss + acept_ext_ret_isss,
               t_inte_ext_sar_isss    = recha_ext_sar_isss + acept_ext_sar_isss,
               t_inte_ext_cv_isss_pat = recha_ext_cv_isss_pat +
                                        acept_ext_cv_isss_pat,
               t_inte_ext_cv_isss_tra = recha_ext_cv_isss_tra +
                                        acept_ext_cv_isss_tra,
               t_impt_ahr_sol_tra     = recha_ahr_sol_tra + acept_ahr_sol_tra,
               t_impt_ahr_sol_dep     = recha_ahr_sol_dep + acept_ahr_sol_dep,
               t_inte_ext_ahr_sol_tra = recha_ext_ahr_sol_tra +
                                        acept_ext_ahr_sol_tra,
               t_inte_ext_ahr_sol_dep = recha_ext_ahr_sol_dep +
                                        acept_ext_ahr_sol_dep,
               t_itra_sar_isss      = recha_itra_sar_isss + acept_itra_sar_isss,
               t_itra_ret_isss      = recha_itra_ret_isss + acept_itra_ret_isss,
               t_itra_cv_isss_pat     = recha_itra_cv_isss_pat +
                                        acept_itra_cv_isss_pat,
               t_itra_cv_isss_tra     = recha_itra_cv_isss_tra +
                                        acept_itra_cv_isss_tra,
               t_itra_ext_sar_isss    = recha_itra_ext_sar_isss +
                                        acept_itra_ext_sar_isss,
               t_itra_ext_ret_isss    = recha_itra_ext_ret_isss +
                                        acept_itra_ext_ret_isss,
               t_itra_ext_cv_isss_pat = recha_itra_ext_cv_isss_pat +
                                        acept_itra_ext_cv_isss_pat,
               t_itra_ext_cv_isss_tra = recha_itra_ext_cv_isss_tra +
                                        acept_itra_ext_cv_isss_tra,
               t_itra_ahr_sol_tra     = recha_itra_ahr_sol_tra +
                                        acept_itra_ahr_sol_tra,
               t_itra_ahr_sol_dep     = recha_itra_ahr_sol_dep +
                                        acept_itra_ahr_sol_dep,
               t_itra_ext_ahr_sol_tra = recha_itra_ext_ahr_sol_tra +
                                        acept_itra_ext_ahr_sol_tra,
               t_itra_ext_ahr_sol_dep = recha_itra_ext_ahr_sol_dep +
                                        acept_itra_ext_ahr_sol_dep,
               t_impt_total_inte      = reg_sum.t_impt_total_inte
   ...
   FORMAT
      ON EVERY ROW
         PRINT COLUMN 1,reg_cza.tipo_registro,
                        ...
                        reg_cza.fecha_ini_noti1,
                        reg_cza.fecha_fin_noti1,
                        reg_cza.fecha_liq_interes,
...
DEFINE reg_rech RECORD
      ...
      impt_ahr_sol_tra      DECIMAL(10,2),
      impt_ahr_sol_dep      DECIMAL(10,2),
      inte_ext_ahr_sol_tra  DECIMAL(12,2),
      inte_ext_ahr_sol_dep  DECIMAL(12,2),
      itra_sar_isss         DECIMAL(12,2),
      itra_ret_isss         DECIMAL(12,2),
      itra_cv_isss_pat      DECIMAL(12,2),
      itra_cv_isss_tra      DECIMAL(12,2),
      itra_ext_sar_isss     DECIMAL(12,2),
      itra_ext_ret_isss     DECIMAL(12,2),
      itra_ext_cv_isss_pat  DECIMAL(12,2),
      itra_ext_cv_isss_tra  DECIMAL(12,2),
      itra_ahr_sol_tra      DECIMAL(12,2),
      itra_ahr_sol_dep      DECIMAL(12,2),
      itra_ext_ahr_sol_tra  DECIMAL(12,2),
      itra_ext_ahr_sol_dep  DECIMAL(12,2),
      impt_total_inte       DECIMAL(12,2),
      filler                CHAR(60),
      result_operacion      CHAR(2),
      det_mot_rechazo1      CHAR(3),
      det_mot_rechazo2      CHAR(3),
   ...
   cinte_ext_ahr_sol_tra   CHAR(13),
   cinte_ext_ahr_sol_dep   CHAR(13),
   citra_sar_isss          CHAR(13),
   citra_ret_isss          CHAR(13),
   citra_cv_isss_pat       CHAR(13),
   citra_cv_isss_tra       CHAR(13),
   citra_ext_sar_isss      CHAR(13),
   citra_ext_ret_isss      CHAR(13),
   citra_ext_cv_isss_pat   CHAR(13),
   citra_ext_cv_isss_tra   CHAR(13),
   citra_ahr_sol_tra       CHAR(13),
   citra_ahr_sol_dep       CHAR(13),
   citra_ext_ahr_sol_tra   CHAR(13),
   citra_ext_ahr_sol_dep   CHAR(13),
   cimpt_total_inte        CHAR(13),
   ...
   xinte_ext_ahr_sol_tra   CHAR(12),
   xinte_ext_ahr_sol_dep   CHAR(12),
   xitra_sar_isss          CHAR(12),
   xitra_ret_isss          CHAR(12),
   xitra_cv_isss_pat       CHAR(12),
   xitra_cv_isss_tra       CHAR(12),
   xitra_ext_sar_isss      CHAR(12),
   xitra_ext_ret_isss      CHAR(12),
   xitra_ext_cv_isss_pat   CHAR(12),
   xitra_ext_cv_isss_tra   CHAR(12),
   xitra_ahr_sol_tra       CHAR(12),
   xitra_ahr_sol_dep       CHAR(12),
   xitra_ext_ahr_sol_tra   CHAR(12),
   xitra_ext_ahr_sol_dep   CHAR(12),
   ximpt_total_inte        CHAR(12)
...
LET cinte_ext_ahr_sol_tra = reg_rech.inte_ext_ahr_sol_tra / 100 USING '&&&&&&&&&&.&&'
LET cinte_ext_ahr_sol_dep = reg_rech.inte_ext_ahr_sol_dep / 100 USING '&&&&&&&&&&.&&'
LET citra_sar_isss     = reg_rech.itra_sar_isss     / 100 USING '&&&&&&&&&&.&&'
LET citra_ret_isss     = reg_rech.itra_ret_isss     / 100 USING '&&&&&&&&&&.&&'
LET citra_cv_isss_pat  = reg_rech.itra_cv_isss_pat  / 100 USING '&&&&&&&&&&.&&'
LET citra_cv_isss_tra  = reg_rech.itra_cv_isss_tra  / 100 USING '&&&&&&&&&&.&&'
LET citra_ext_sar_isss = reg_rech.itra_ext_sar_isss / 100 USING '&&&&&&&&&&.&&'
LET citra_ext_ret_isss = reg_rech.itra_ext_ret_isss / 100 USING '&&&&&&&&&&.&&'
LET citra_ext_cv_isss_pat = reg_rech.itra_ext_cv_isss_pat / 100 USING '&&&&&&&&&&.&&'
LET citra_ext_cv_isss_tra = reg_rech.itra_ext_cv_isss_tra / 100 USING '&&&&&&&&&&.&&'
LET citra_ahr_sol_tra  = reg_rech.itra_ahr_sol_tra  / 100 USING '&&&&&&&&&&.&&'
LET citra_ahr_sol_dep  = reg_rech.itra_ahr_sol_dep  / 100 USING '&&&&&&&&&&.&&'
LET citra_ext_ahr_sol_tra = reg_rech.itra_ext_ahr_sol_tra / 100 USING '&&&&&&&&&&.&&'
LET citra_ext_ahr_sol_dep = reg_rech.itra_ext_ahr_sol_dep / 100 USING '&&&&&&&&&&.&&'
LET cimpt_total_inte   = reg_rech.impt_total_inte  /  100 USING '&&&&&&&&&&.&&'
...
LET xinte_ext_ahr_sol_tra = cinte_ext_ahr_sol_tra [1,10],cinte_ext_ahr_sol_tra [12,13]
LET xinte_ext_ahr_sol_dep = cinte_ext_ahr_sol_dep [1,10],cinte_ext_ahr_sol_dep [12,13]
LET xitra_sar_isss     = citra_sar_isss     [1,10],citra_sar_isss     [12,13]
LET xitra_ret_isss     = citra_ret_isss     [1,10],citra_ret_isss     [12,13]
LET xitra_cv_isss_pat  = citra_cv_isss_pat  [1,10],citra_cv_isss_pat  [12,13]
LET xitra_cv_isss_tra  = citra_cv_isss_tra  [1,10],citra_cv_isss_tra  [12,13]
LET xitra_ext_sar_isss = citra_ext_sar_isss [1,10],citra_ext_sar_isss [12,13]
LET xitra_ext_ret_isss = citra_ext_ret_isss [1,10],citra_ext_ret_isss [12,13]
LET xitra_ext_cv_isss_pat = citra_ext_cv_isss_pat [1,10],citra_ext_cv_isss_pat [12,13]
LET xitra_ext_cv_isss_tra = citra_ext_cv_isss_tra [1,10],citra_ext_cv_isss_tra [12,13]
LET xitra_ahr_sol_tra     = citra_ahr_sol_tra  [1,10],citra_ahr_sol_tra  [12,13]
LET xitra_ahr_sol_dep     = citra_ahr_sol_dep  [1,10],citra_ahr_sol_dep  [12,13]
LET xitra_ext_ahr_sol_tra = citra_ext_ahr_sol_tra [1,10],citra_ext_ahr_sol_tra [12,13]
LET xitra_ext_ahr_sol_dep = citra_ext_ahr_sol_dep [1,10],citra_ext_ahr_sol_dep [12,13]
LET ximpt_total_inte   = cimpt_total_inte  [1,10], cimpt_total_inte   [12,13]

         PRINT
            COLUMN 1,reg_rech.tipo_registro,
                     reg_rech.ident_servicio,
                     xconsec_reg_lote,
                     reg_rech.cve_ent_recep,
                     ...
                     ximpt_ahr_sol_tra,
                     ximpt_ahr_sol_dep,
                     xinte_ext_ahr_sol_tra,
                     xinte_ext_ahr_sol_dep,
                     xitra_sar_isss,
                     xitra_ret_isss,
                     xitra_cv_isss_pat,
                     xitra_cv_isss_tra,
                     xitra_ext_sar_isss,
                     xitra_ext_ret_isss,
                     xitra_ext_cv_isss_pat,
                     xitra_ext_cv_isss_tra,
                     xitra_ahr_sol_tra,
                     xitra_ahr_sol_dep,
                     xitra_ext_ahr_sol_tra,
                     xitra_ext_ahr_sol_dep,
                     ximpt_total_inte,
                     reg_rech.filler,
                     "00",                      --- result_operacion,
...
REPORT rep_sum(reg_sum,
   ...
   c15_t_impt_sar_isss           ,
   c15_t_impt_ret_isss           ,
   c15_t_impt_cv_isss_pat        ,
   c15_t_impt_cv_isss_tra        ,
   c15_t_inte_ext_sar_isss       ,
   c15_t_inte_ext_ret_isss       ,
   c15_t_inte_ext_cv_isss_pat    ,
   c15_t_inte_ext_cv_isss_tra    ,
   c15_t_impt_ahr_sol_tra        ,
   c15_t_impt_ahr_sol_dep        ,
   c15_t_inte_ext_ahr_sol_tra    ,
   c15_t_inte_ext_ahr_sol_dep    ,
   c15_t_itra_sar_isss           ,
   c15_t_itra_ret_isss           ,
   c15_t_itra_cv_isss_pat        ,
   c15_t_itra_cv_isss_tra        ,
   c15_t_itra_ext_sar_isss       ,
   c15_t_itra_ext_ret_isss       ,
   c15_t_itra_ext_cv_isss_pat    ,
   c15_t_itra_ext_cv_isss_tra    ,
   c15_t_itra_ahr_sol_tra        ,
   c15_t_itra_ahr_sol_dep        ,
   c15_t_itra_ext_ahr_sol_tra    ,
   c15_t_itra_ext_ahr_sol_dep    CHAR(15),

   c16_t_impt_sar_isss           ,
   c16_t_impt_ret_isss           ,
   c16_t_impt_cv_isss_pat        ,
   c16_t_impt_cv_isss_tra        ,
   c16_t_inte_ext_sar_isss       ,
   c16_t_inte_ext_ret_isss       ,
   c16_t_inte_ext_cv_isss_pat    ,
   c16_t_inte_ext_cv_isss_tra    ,
   c16_t_impt_ahr_sol_tra        ,
   c16_t_impt_ahr_sol_dep        ,
   c16_t_inte_ext_ahr_sol_tra    ,
   c16_t_inte_ext_ahr_sol_dep    ,
   c16_t_itra_sar_isss           ,
   c16_t_itra_ret_isss           ,
   c16_t_itra_cv_isss_pat        ,
   c16_t_itra_cv_isss_tra        ,
   c16_t_itra_ext_sar_isss       ,
   c16_t_itra_ext_ret_isss       ,
   c16_t_itra_ext_cv_isss_pat    ,
   c16_t_itra_ext_cv_isss_tra    ,
   c16_t_itra_ahr_sol_tra        ,
   c16_t_itra_ahr_sol_dep        ,
   c16_t_itra_ext_ahr_sol_tra    ,
   c16_t_itra_ext_ahr_sol_dep    CHAR(16),
   ...
   d15_impt_sar_isss             ,
   d15_impt_ret_isss             ,
   d15_impt_cv_isss_pat          ,
   d15_impt_cv_isss_tra          ,
   d15_inte_ext_sar_isss         ,
   d15_inte_ext_ret_isss         ,
   d15_inte_ext_cv_isss_pat      ,
   d15_inte_ext_cv_isss_tra      ,
   d15_impt_ahr_sol_tra          ,
   d15_impt_ahr_sol_dep          ,
   d15_inte_ext_ahr_sol_tra      ,
   d15_inte_ext_ahr_sol_dep      ,
   d15_itra_sar_isss             ,
   d15_itra_ret_isss             ,
   d15_itra_cv_isss_pat          ,
   d15_itra_cv_isss_tra          ,
   d15_itra_ext_sar_isss         ,
   d15_itra_ext_ret_isss         ,
   d15_itra_ext_cv_isss_pat      ,
   d15_itra_ext_cv_isss_tra      ,
   d15_itra_ahr_sol_tra          ,
   d15_itra_ahr_sol_dep          ,
   d15_itra_ext_ahr_sol_tra      ,
   d15_itra_ext_ahr_sol_dep      DECIMAL(15,2),
   ...
   FORMAT
      ON EVERY ROW
         ...
         LET reg_sum.t_impt_sar_isss        = recha_sar_isss             * 100
         LET reg_sum.t_impt_ret_isss        = recha_ret_isss             * 100
         LET reg_sum.t_impt_cv_isss_pat     = recha_cv_isss_pat          * 100
         LET reg_sum.t_impt_cv_isss_tra     = recha_cv_isss_tra          * 100
         LET reg_sum.t_inte_ext_sar_isss    = recha_ext_sar_isss         * 100
         LET reg_sum.t_inte_ext_ret_isss    = recha_ext_ret_isss         * 100
         LET reg_sum.t_inte_ext_cv_isss_pat = recha_ext_cv_isss_pat      * 100
         LET reg_sum.t_inte_ext_cv_isss_tra = recha_ext_cv_isss_tra      * 100
         LET reg_sum.t_impt_ahr_sol_tra     = recha_ahr_sol_tra          * 100 
         LET reg_sum.t_impt_ahr_sol_dep     = recha_ahr_sol_dep          * 100 
         LET reg_sum.t_inte_ext_ahr_sol_tra = recha_ext_ahr_sol_tra      * 100 
         LET reg_sum.t_inte_ext_ahr_sol_dep = recha_ext_ahr_sol_dep      * 100 
         LET reg_sum.t_itra_sar_isss        = recha_itra_sar_isss        * 100
         LET reg_sum.t_itra_ret_isss        = recha_itra_ret_isss        * 100
         LET reg_sum.t_itra_cv_isss_pat     = recha_itra_cv_isss_pat     * 100
         LET reg_sum.t_itra_cv_isss_tra     = recha_itra_cv_isss_tra     * 100
         LET reg_sum.t_itra_ext_sar_isss    = recha_itra_ext_sar_isss    * 100
         LET reg_sum.t_itra_ext_ret_isss    = recha_itra_ext_ret_isss    * 100
         LET reg_sum.t_itra_ext_cv_isss_pat = recha_itra_ext_cv_isss_pat * 100
         LET reg_sum.t_itra_ext_cv_isss_tra = recha_itra_ext_cv_isss_tra * 100
         LET reg_sum.t_itra_ahr_sol_tra     = recha_itra_ahr_sol_tra     * 100 
         LET reg_sum.t_itra_ahr_sol_dep     = recha_itra_ahr_sol_dep     * 100 
         LET reg_sum.t_itra_ext_ahr_sol_tra = recha_itra_ext_ahr_sol_tra * 100 
         LET reg_sum.t_itra_ext_ahr_sol_dep = recha_itra_ext_ahr_sol_dep * 100 
 
         LET d15_impt_total_xpagar =
         ## Pens.      acept_sar_isss             + acept_ret_isss             +
         ## Pens.      acept_cv_isss_pat          + acept_cv_isss_tra          +
         ## Pens.      acept_ext_sar_isss         + acept_ext_ret_isss         +
         ## Pens.      acept_ext_cv_isss_pat      + acept_ext_cv_isss_tra      +
         ## Pens.      acept_ahr_sol_tra          + acept_ahr_sol_dep          +
         ## Pens.      acept_ext_ahr_sol_tra      + acept_ext_ahr_sol_dep      +
                       acept_itra_sar_isss        + acept_itra_ret_isss        +
                       acept_itra_cv_isss_pat     + acept_itra_cv_isss_tra     +
                       acept_itra_ext_sar_isss    + acept_itra_ext_ret_isss    +
                       acept_itra_ext_cv_isss_pat + acept_itra_ext_cv_isss_tra +
                       acept_itra_ahr_sol_tra     + acept_itra_ahr_sol_dep     +
                       acept_itra_ext_ahr_sol_tra + acept_itra_ext_ahr_sol_dep
         ...
         PRINT COLUMN 1,
                     ...
                     reg_sum.t_impt_sar_isss        USING '&&&&&&&&&&&&&&&',
                     reg_sum.t_impt_ret_isss        USING '&&&&&&&&&&&&',
                     reg_sum.t_impt_cv_isss_pat     USING '&&&&&&&&&&&&&&&',
                     reg_sum.t_impt_cv_isss_tra     USING '&&&&&&&&&&&&&&&',
                     reg_sum.t_inte_ext_sar_isss    USING '&&&&&&&&&&&&',
                     reg_sum.t_inte_ext_ret_isss    USING '&&&&&&&&&&&&&&&',
                     reg_sum.t_inte_ext_cv_isss_pat USING '&&&&&&&&&&&&&&&',
                     reg_sum.t_inte_ext_cv_isss_tra USING '&&&&&&&&&&&&&&&',
                     reg_sum.t_impt_ahr_sol_tra     USING '&&&&&&&&&&&&&&&',
                     reg_sum.t_impt_ahr_sol_dep     USING '&&&&&&&&&&&&&&&',
                     reg_sum.t_inte_ext_ahr_sol_tra USING '&&&&&&&&&&&&&&&',
                     reg_sum.t_inte_ext_ahr_sol_dep USING '&&&&&&&&&&&&&&&',
                     reg_sum.t_itra_sar_isss        USING '&&&&&&&&&&&&&&&',
                     reg_sum.t_itra_ret_isss        USING '&&&&&&&&&&&&&&&',
                     reg_sum.t_itra_cv_isss_pat     USING '&&&&&&&&&&&&&&&',
                     reg_sum.t_itra_cv_isss_tra     USING '&&&&&&&&&&&&&&&',
                     reg_sum.t_itra_ext_sar_isss    USING '&&&&&&&&&&&&&&&',
                     reg_sum.t_itra_ext_ret_isss    USING '&&&&&&&&&&&&&&&',
                     reg_sum.t_itra_ext_cv_isss_pat USING '&&&&&&&&&&&&&&&',
                     reg_sum.t_itra_ext_cv_isss_tra USING '&&&&&&&&&&&&&&&',
                     reg_sum.t_itra_ahr_sol_tra     USING '&&&&&&&&&&&&&&&',
                     reg_sum.t_itra_ahr_sol_dep     USING '&&&&&&&&&&&&&&&',
                     reg_sum.t_itra_ext_ahr_sol_tra USING '&&&&&&&&&&&&&&&',
                     reg_sum.t_itra_ext_ahr_sol_dep USING '&&&&&&&&&&&&&&&',
                     reg_sum.t_impt_total_inte      USING '&&&&&&&&&&&&&&&',
                     vnum_reg                       USING '&&&&&&&&&',
...
DEFINE
   ...
   IF conta_afi = 1 THEN
      ...
      FROM  cta_act_marca
      WHERE nss = nssa
      AND   marca_cod IN (120,130,150)                        ## MLM-2602
      GROUP BY 1
      ...
      ELSE
	    ...
	    LET i = i + 1
	       ...
	       IF tipo_sol = 8 OR tipo_sol = 12  THEN     #### TRABAJADOR ISSSTE
	          ...
	          IF STATUS = NOTFOUND THEN
                     ERROR " Inconsistencia en Datos, NSS issste sin NTI ",curpa
	             ...
	             FOREACH cur_ccta2 INTO tipo_adm
                        EXIT FOREACH
	             END FOREACH
	             RETURN curpa, nssa, tipo_adm, 0          ## 0 Aceptado
                  END IF
