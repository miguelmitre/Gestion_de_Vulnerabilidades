...
#Sistema           => DIS   					              #
#Programa          => DISB009                                                 #
#Descripcion       => INDIVIDUALIZACION INTERESES VIVIENDA                    #
...
LET nom_spl="EXECUTE PROCEDURE dispersa_interes(",g_reg.tasa_oper,",",
                                                "'",g_reg.fecha_aplica,"'",",",
                                                "'",vfecha_inicio,"'",",",
                                                "'",vfecha_final,"'",",",
                                                "'",usuario,"'",
...
FUNCTION Inicializa_tabla()
   ...
   WHENEVER ERROR CONTINUE
      ...
      CREATE TABLE cta_valida_int
         (estado_int smallint,
          fecha_int  date)
      
      INSERT INTO cta_valida_int VALUES (1,g_reg.fecha_aplica)
