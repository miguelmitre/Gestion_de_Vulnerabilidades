...
#Owner             => E.F.P.                                                   #
#Programa DISB007I => LIQUIDACION DE INTERESES EN TRANSITO ISSSTE.             #
#Por               => DMR                                                      #
#Fecha creacion    => 10 DE NOVIEMBRE DEL 2009                                 #
#Sistema           => DIS                                                      #
#Modificacion      => DMR                                                      #
#Fecha             => 11 NOV 2009   (Nuevo Layout RCV ISSSTE, AHORRO RET 2009.)#
...
MAIN
   ...
   CALL STARTLOG(FGL_GETENV("USER")||".DISB007I.log")     #CPL-1645
...
FUNCTION Proceso_principal(vfolio)
   ...
   LET nom_spl = "EXECUTE PROCEDURE liq_inttran ( ",
                 "'",fecha2,"'",",",
                 "'",vfecha_pro,"'",",",
                     vfolio, ",",
                     vfolio_nuevo, ",",
   ...
   LET ejecuta = "nohup fglgo DISB028I.4gi ",vfolio CLIPPED," &"
   RUN ejecuta
...
FUNCTION Actualiza_estados()
   ...
   FROM  dis_cuenta
   WHERE folio           = vfolio
   AND   subcuenta       IN (13,30,31,34,33)
