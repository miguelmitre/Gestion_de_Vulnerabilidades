...
#MODULO      : SEP
#PROGRAMA    : SEPF015
#DESCRIPCION : LISTA PAREJAS DE SEPARACION EN ESPERA DE EFECTUAR UNA
#              SEPARACION PRELIMINAR ANTES DE SER PROVISIONADAS Y EJECUTA
#              EL PROGRAMA DE SEPARACION PRELIMINAR SEPB015
...
MAIN
 ...
 LET hoy = TODAY
    ...
    DISPLAY " SEPF015  PAREJAS DE SEPARACION EN ESPERA DE SEPARACION PRELIMINAR             " AT 3,1 ATTRIBUTE(REVERSE)
   ...
   IF NOT int_flag THEN 
          ...
          " WHERE   ",cad_construct CLIPPED ,
           ...
           -- " AND    a.correlativo = c.idSolicitudSeparacion ",
            ...
            " AND    a.estado = 53 ", -- en espera de verificacion
         ...
         WHILE TRUE
           ...
           IF cont_1 = 1 THEN
              ERROR ""
              CLEAR FORM
              PROMPT " No Existen Registros para Preliminar.<ENTER> para Salir "
              ATTRIBUTE(REVERSE)
              FOR CHAR g_enter
