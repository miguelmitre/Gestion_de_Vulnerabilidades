...
FUNCTION f_actualiza_liquidacion(pi_folio, pdt_fecha_liquida)
    ...
    DEFINE lr_pagar             RECORD
                                ...
                                pago_mensual    LIKE pen_solicitud_iss.pago_mensual     ,
