#################################################################################
#Owner             => E.F.P.                                                    #
#Programa PENL100  => REPORTE DE LIQUIDACION DE PMG (PESOS)                     #
...
GLOBALS
    ...
    DEFINE gr_disp RECORD
        ...
        regimen                 CHAR(2)         ,
        nombre                  CHAR(30)        ,
        pesos_tot_liquidado     DECIMAL(22,6)   ,
...
FUNCTION f_captura_datos()
    ...
    OPEN WINDOW penl1001 AT 4,4 WITH FORM "PENL1001" ATTRIBUTE (BORDER)
    DISPLAY " <ESC> - Ejecutar                                     <Ctrl-C> - Cancelar      " AT 1,1 ATTRIBUTE(REVERSE)
    DISPLAY " PENL100     REPORTE DE LIQUIDACION DE RECURSOS PMG - PESOS                    " AT 3,1 ATTRIBUTE (REVERSE)
...
FUNCTION f_genera_reporte(pr_captura)
    ...
    FOREACH cur_liq INTO gr_disp.nss            ,
        ...
        LET gr_disp.pesos_tot_liquidado = 0
        ...
        -- Total Liquidado
        LET gr_disp.pesos_tot_liquidado = gr_disp.pesos_ret97   +
                                          gr_disp.pesos_cv      +
                                          gr_disp.pesos_est     +
                                          gr_disp.pesos_esp     +
                                          gr_disp.pesos_cs      +
...
REPORT rpt_liquida(pr_rpt)
    ...
    FORMAT
        ...
        FOR li_cont = 1 TO 1
            ...
            FOR li_siefore = 1 TO 5
                ...
                LET lar_total_retiro[li_cont].lar_total_siefore[li_siefore].pesos_tot_liquidado = 0
            ...
            LET lar_gran_total_siefore[li_cont].pesos_tot_liquidado = 0
        ...
        LET lr_total_gral.pesos_tot_liquidado   = 0
        ...
        PRINT COLUMN 001, "PROGRAMA            : PENL100",
    ...
    BEFORE GROUP OF pr_rpt.tipo_retiro
        ...
        PRINT COLUMN 001,"|",
              ...
              COLUMN 063,"\302", L10,L2,L2, -- pesos_tot_liquidado
        ...
        PRINT COLUMN 001,"\300",L10,L1,         -- nss
                         ...
                         "\301", L2,            -- siefore
                         "\301", L4,            -- mensualidad
                         "\301",L10,L2,L2,      -- pesos_tot_liquidado
    ...
    ON EVERY ROW
        PRINT COLUMN 002, pr_rpt.nss                             ,
              ...
              COLUMN 063, pr_rpt.pesos_tot_liquidado    USING "###########&.&&",
        ...
        LET lar_total_retiro[li_cont].lar_total_siefore[li_siefore].pesos_tot_liquidado = lar_total_retiro[li_cont].lar_total_siefore[li_siefore].pesos_tot_liquidado + pr_rpt.pesos_tot_liquidado
        ...
        FOR li_siefore = 1 TO 5
            IF lar_total_retiro[li_cont].lar_total_siefore[li_siefore].nss_tot > 0 THEN
                ...
                PRINT COLUMN 001, "\332",L10,L1,                    -- nss
                                  ...
                                  "\302",L2,                        -- siefore
                                  "\302",L4,                        -- mensualidad
                                  "\302",L10,L2,L2,                 -- pesos_tot_liquidado
                                  "\302",L10,L5,L1,                 -- pesos_ret97
                                  "\302",L10,L5,L1,                 -- pesos_cv
                ...
                PRINT COLUMN 001, "|", lar_total_retiro[li_cont].lar_total_siefore[li_siefore].nss_tot  USING "###########&",
                      ...
                      COLUMN 058, "|",
                      COLUMN 063, "|", lar_total_retiro[li_cont].lar_total_siefore[li_siefore].pesos_tot_liquidado  USING "##########&.&&",
        ...
        FOR li_cont = 1 TO 1 -- Tipo de retiro
            ...
            FOR li_siefore = 1 TO 5
                IF lar_total_retiro[li_cont].lar_total_siefore[li_siefore].nss_tot > 0 THEN
                    ...
                    LET lar_gran_total_siefore[li_siefore].pesos_tot_liquidado = lar_gran_total_siefore[li_siefore].pesos_tot_liquidado  + lar_total_retiro[li_cont].lar_total_siefore[li_siefore].pesos_tot_liquidado
        ...
        FOR li_siefore = 1 TO 5
            IF lar_gran_total_siefore[li_siefore].nss_tot > 0 THEN
                ...
                PRINT COLUMN 001, "|", lar_gran_total_siefore[li_siefore].nss_tot  USING "##########&",
                      ...
                      COLUMN 055, "|S", li_siefore USING "&",
                      COLUMN 058, "|",
                      COLUMN 063, "|", lar_gran_total_siefore[li_siefore].pesos_tot_liquidado USING "##########&.&&",
                ...
                LET lr_total_gral.pesos_tot_liquidado = lr_total_gral.pesos_tot_liquidado  + lar_gran_total_siefore[li_siefore].pesos_tot_liquidado
