##############################################################################
#Owner             => E.F.P.                                                  
#Programa TRAL008  => PANTALLA DE PROVISION DE ICEFA - IMSS   
...
DISPLAY FORM f_TRAL0081 
    ...
    DISPLAY " TRAL008      RESUMEN PROVISION DE TRASPASO ICEFA-AFORE IMSS                   " AT 3,1 ATTRIBUTE(REVERSE)
...
#ag-----------------------
   ...
   WHERE  a.folio       =        reg_fol.folio
    ...
    LET    g_tipo_desc1    = 'TRASPASO ICEFA IMSS POR TIPO MOVIMIENTO'
    LET    g_tipo_desc2    = 'TRASPASO ICEFA IMSS POR SUBCUENTA'
    LET    g_nombre_programa = "TRAL008"
    LET    g_tip_rep       ='IMSS'
