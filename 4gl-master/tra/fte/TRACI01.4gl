...
LET nn_no_act = 0
   ...
   DISPLAY " TRACI01 CARGA ARCHIVO ENVIADO POR PROCESAR TRA-ICE-AFO ISSSTE                 " AT 3,1 ATTRIBUTE(REVERSE)
...
#am-------------------------------
    ...
    LET reg_4.lote_genera  = reg_3.ident_lote_solic[14,16]
        ...
        INTO   s_nro_icefa
        FROM   tra_mae_icefa_issste
        WHERE  tra_mae_icefa_issste.n_seguro     = reg_3.n_seguro
	     AND    tra_mae_icefa_issste.nss          = reg_3.nss
        AND    tra_mae_icefa_issste.rfc          = reg_3.rfc
        AND    tra_mae_icefa_issste.icefa_cod    = reg_3.icefa_cod 
        AND    tra_mae_icefa_issste.nro_int_cta  = reg_3.nro_int_cta
        ...
        SET    tra_det_aut_issste.estado      = reg_3.estado_nuevo ,
               tra_det_aut_issste.fecha_edo   = TODAY     
        WHERE  tra_det_aut_issste.n_seguro    = reg_3.n_seguro         
        AND  tra_det_aut_issste.n_seguro_ent  = reg_3.nss
        AND  tra_det_aut_issste.rfc_ent       = reg_3.rfc
        AND  tra_det_aut_issste.cve_ced_cuenta = reg_3.icefa_cod
        AND  tra_det_aut_issste.nro_ctrl_icefa= reg_3.nro_int_cta
        AND  tra_det_aut_issste.estado       = reg_3.estado_actual # ENVIADA     
