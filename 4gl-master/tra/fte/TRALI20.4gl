##############################################################################
#Owner             => E.F.P.
#Programa TRALI20  => PANTALLA DE CONSULTA PENDIENTE DE ENVIAR   
#Fecha creacion    => 11 FEB 2003            
...
MAIN
 ...
 CALL ini()
    ...
    DISPLAY " TRALI20  CONSULTA DE CAPTURA SOLIC. ICEFA-AFORE ISSSTE POR ENVIAR             " AT 3,1 ATTRIBUTE(REVERSE,BOLD) 
...
#d----------------
    ...
    DISPLAY " TRALI20      DETALLE DE CAPTURA PENDIENTE DE ENVIAR POR STATUS                       " AT 3,1 ATTRIBUTE(REVERSE,BOLD) 
    DISPLAY HOY USING "dd-mm-yyyy" AT 3,68 ATTRIBUTE(REVERSE)
...
CASE tipo 
WHEN 1
DISPLAY " TRALI20    DETALLE DE SOL.CONFIRMADAS PENDIENTES DE ENVIAR                    " AT 3,1 ATTRIBUTE(REVERSE)                                          
EXIT CASE
WHEN 21
DISPLAY " TRALI20    DETALLE DE SOL.RECICLADAS RECHAZADAS POR CONV.                     " AT 3,1 ATTRIBUTE(REVERSE)                                          
EXIT CASE
WHEN 30
DISPLAY " TRALI20    DETALLE DE SOL.PENDIENTES EN ESPERA DE CERTIF.                     " AT 3,1 ATTRIBUTE(REVERSE)                                          
EXIT CASE
OTHERWISE
 EXIT CASE
END CASE
