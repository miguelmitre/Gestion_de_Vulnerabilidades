##############################################################################
#Owner             => E.F.P.
#Programa TRAC001  => RECEPCIONA ARCHIVOS DE TRASPASOS ENVIADOS POR PROCESAR
...
DEFINE v_correlativo LIKE tra_mae_icefa.correlativo
    ...
    DEFINE reg_sum_trasp RECORD #glo #reg_sum_trasp
        tipo_registro         CHAR(02)      ,
        cant_reg_det          INTEGER       ,
        tot_sal_ret_97        DECIMAL(15,2) ,
        tot_sal_ces_vej       DECIMAL(15,2) ,
        tot_sal_aport_vol     DECIMAL(15,2) ,
        tot_sal_viv_97        DECIMAL(15,2) ,
        tot_sal_cuo_soc       DECIMAL(15,2) ,
        tot_sal_aport_est     DECIMAL(15,2) ,
        tot_sal_cuo_esp       DECIMAL(15,2) ,
        tot_sal_sar_92        DECIMAL(15,2) ,
        tot_sal_viv_92        DECIMAL(15,2) ,
        int_viv_97            DECIMAL(15,2) ,
        int_viv_92            DECIMAL(15,2) ,
        int_ret_97            DECIMAL(15,2) ,
        int_ces_vej           DECIMAL(15,2) ,
        ...
        int_cuo_esp           DECIMAL(15,2) ,
        int_sar_92            DECIMAL(15,2) ,
        tot_aport_ret_97      DECIMAL(15,2) ,
        tot_aport_ces_vej     DECIMAL(15,2) ,
        tot_aport_vol         DECIMAL(15,2) ,
        tot_aport_viv_97      DECIMAL(15,2) ,
        tot_aport_cuo_soc     DECIMAL(15,2) ,
        tot_aport_est         DECIMAL(15,2) ,
        tot_aport_cuo_esp     DECIMAL(15,2)
    END RECORD
    ...
    DEFINE reg_det_sol_rech RECORD #reg_det_sol_rech
        ...
        cont_servicio         DECIMAL(10,0) ,
        tipo_recep_cuenta     CHAR(002)     ,
        cve_recep_cuenta      SMALLINT      ,#TRAIA CHAR DE (003)
        tipo_ced_cuenta       CHAR(002)     ,
        cve_ced_cuenta        char(3)       ,#TRAIA SMALLINT
        orig_tipo_trasp       CHAR(002)     ,
        fech_presentacion     DATE          ,
        n_unico               CHAR(018)     ,
        n_seguro              CHAR(011)     ,
...
MAIN
   ...
   OPEN WINDOW trac0011 AT 4,4 WITH FORM "TRAC0011" ATTRIBUTE(BORDER)

   DISPLAY " TRAC001  CARGA ARCHIVO ENVIADO POR PROCESAR TRA-ICE-AFO IMSS                  " AT 3,1 ATTRIBUTE(REVERSE)
...
#ds------------------------------
    ...
    FOREACH cur_2 INTO carga_reg
        CASE carga_reg[1,2]
            ...
            LET reg_det_devol.n_seguro           = carga_reg[059,069]
            ...
            LET reg_det_devol.n_seguro_ent       = carga_reg[271,281]
    ...
    LET a_fecha_genera = reg_det_devol.ident_lote_solic[10,11],"/",
	   ...
	   WHERE correlativo = v_correlativo
         ...
         CALL f_desmarca_cuenta_ic(reg_det_devol.n_seguro,250,v_correlativo,91) 
...
#tc------------------------
    ...
    FOREACH cur_3 INTO carga_reg
        CASE carga_reg[1,2]
            ...
            LET reg_cza_trasp.cod_result_operac = carga_reg[033,034]
            LET reg_cza_trasp.rechazo           = carga_reg[035,043]
	    ...
	    IF STATUS = NOTFOUND THEN
                INSERT INTO tra_cza_traspaso VALUES(ultimo_folio         ,
                                             reg_cza_trasp.*      ,
       ...
       WHEN "02"   #---DETALLE TRASPASO DE dis_cuenta (SALDOS)---#
            ...
            LET reg_det_trasp_sal.cve_ced_cuenta     = carga_reg[020,022]
            ...
            LET reg_det_trasp_sal.saldo_ret_97       = carga_reg[445,459]
            LET reg_det_trasp_sal.saldo_ces_vej      = carga_reg[460,474]
            LET reg_det_trasp_sal.saldo_aport_vol    = carga_reg[475,489]
            LET reg_det_trasp_sal.saldo_viv_97       = carga_reg[490,504]
            LET reg_det_trasp_sal.saldo_cuo_soc      = carga_reg[505,519]

            LET c16_saldo_parti                      = carga_reg[520,528],".",
						       carga_reg[529,534]
            LET reg_det_trasp_sal.saldo_parti        = c16_saldo_parti        

            LET reg_det_trasp_sal.saldo_cuo_esp      = carga_reg[535,549]
            ...
            LET reg_det_trasp_sal.cod_result_operac  = carga_reg[583,584]
            LET reg_det_trasp_sal.diag_proceso       = carga_reg[585,599]
            LET reg_det_trasp_sal.nombre_imss        = carga_reg[600,649]

            INSERT INTO tra_det_trasp_sal VALUES(ultimo_folio                  ,
                                                 reg_det_trasp_sal.*           ,
                                                 reg_cza_trasp.consec_lote_dia ,
    ...
    LET a_fecha_genera = reg_det_trasp_sal.ident_lote_solic[10,11],"/",
	    ...
	    INTO   v_correlativo
	    FROM   tra_mae_icefa A 
	    WHERE  A.n_seguro        = reg_det_trasp_sal.n_seguro
	    AND    A.nss             = reg_det_trasp_sal.n_seguro_ent
	    AND    A.rfc             = reg_det_trasp_sal.rfc_ent
	    AND    A.icefa_cod       = reg_det_trasp_sal.cve_ced_cuenta
	    AND    A.nro_int_cta     = reg_det_trasp_sal.nro_ctrl_icefa
	    AND    A.status          = reg_4.enviada
	    AND    A.fecha_genera    = a_fecha_genera
            ...
            CALL actualiza_maeicefa(reg_det_trasp_sal.n_seguro         ,
                                    reg_det_trasp_sal.n_seguro_ent     ,
                                    reg_det_trasp_sal.rfc_ent          ,
                                    reg_det_trasp_sal.cve_ced_cuenta   ,
                                    reg_det_trasp_sal.nro_ctrl_icefa   ,
...
EXIT CASE
            ...
            LET reg_det_trasp_int.cve_ced_cuenta       = carga_reg[020,022]
            ...
            LET reg_det_trasp_int.int_ret_97           = carga_reg[445,459]
            LET reg_det_trasp_int.int_ces_vej          = carga_reg[460,474]
            LET reg_det_trasp_int.int_aport_vol        = carga_reg[475,489]
            LET reg_det_trasp_int.int_viv_97           = carga_reg[490,504]
            LET reg_det_trasp_int.int_cuo_soc          = carga_reg[505,519]
            LET reg_det_trasp_int.int_aport_est        = carga_reg[520,534]
            LET reg_det_trasp_int.int_cuo_esp          = carga_reg[535,549]

            LET c16_int_sar_92                         = carga_reg[550,562],".",
                                                         carga_reg[563,564]
            LET reg_det_trasp_int.int_sar_92           = c16_int_sar_92 

            LET c16_int_viv_92                         = carga_reg[565,577],".",
                                                         carga_reg[578,579]
            LET reg_det_trasp_int.int_viv_92           = c16_int_viv_92

            LET reg_det_trasp_int.nombre_imss          = carga_reg[600,649]

            INSERT INTO tra_det_trasp_int VALUES(ultimo_folio                  ,
                                                 reg_det_trasp_int.*           ,
                                                 reg_cza_trasp.consec_lote_dia ,
                                                 reg_4.aceptada_icefa          ,
                                                 "N"
	    ...
	    AND    nss             = reg_det_trasp_sal.n_seguro_ent
	    AND    rfc             = reg_det_trasp_sal.rfc_ent
	    AND    icefa_cod       = reg_det_trasp_sal.cve_ced_cuenta
	    AND    nro_int_cta     = reg_det_trasp_sal.nro_ctrl_icefa
	   ...
	   WHERE correlativo = v_correlativo
            ...
            LET reg_sum_trasp.tot_sal_ret_97    = carga_reg[012,026]
            LET reg_sum_trasp.tot_sal_ces_vej   = carga_reg[027,041]
            LET reg_sum_trasp.tot_sal_aport_vol = carga_reg[042,056]
            LET reg_sum_trasp.tot_sal_viv_97    = carga_reg[057,071]
            LET reg_sum_trasp.tot_sal_cuo_soc   = carga_reg[072,086]
            LET reg_sum_trasp.tot_sal_aport_est = carga_reg[087,101]
            LET reg_sum_trasp.tot_sal_cuo_esp   = carga_reg[102,116]
            LET reg_sum_trasp.tot_sal_sar_92    = carga_reg[117,131]
            LET reg_sum_trasp.tot_sal_viv_92    = carga_reg[132,146]
            LET reg_sum_trasp.int_viv_97        = carga_reg[147,161]
            LET reg_sum_trasp.int_viv_92        = carga_reg[162,176]
            LET reg_sum_trasp.int_ret_97        = carga_reg[177,191]
            LET reg_sum_trasp.int_ces_vej       = carga_reg[192,206]
            LET reg_sum_trasp.int_aport_vol     = carga_reg[207,221]
            LET reg_sum_trasp.int_cuo_soc       = carga_reg[222,236]
            LET reg_sum_trasp.int_aport_est     = carga_reg[237,251]
            LET reg_sum_trasp.int_cuo_esp       = carga_reg[252,266]
            LET reg_sum_trasp.int_sar_92        = carga_reg[267,281]
            LET reg_sum_trasp.tot_aport_ret_97  = carga_reg[282,296]
            LET reg_sum_trasp.tot_aport_ces_vej = carga_reg[297,311]
            LET reg_sum_trasp.tot_aport_vol     = carga_reg[312,326]
            LET reg_sum_trasp.tot_aport_viv_97  = carga_reg[327,341]
            LET reg_sum_trasp.tot_aport_cuo_soc = carga_reg[342,356]
            LET reg_sum_trasp.tot_aport_est     = carga_reg[357,371]
            LET reg_sum_trasp.tot_aport_cuo_esp = carga_reg[372,386]

            INSERT INTO tra_sum_traspaso VALUES(ultimo_folio    ,
                                                reg_sum_trasp.* ,
                                                "N"
                                                )
...
#tcp---------------------------
    ...
    FOREACH cur_4 INTO carga_reg
        CASE carga_reg[1,2]
            ...
            LET reg_det_trasp_sal.nro_ctrl_icefa     = carga_reg[295,324]
            LET reg_det_trasp_sal.nombre_ent         = carga_reg[325,444]
            LET reg_det_trasp_sal.saldo_ret_97       = carga_reg[345,459]
            LET reg_det_trasp_sal.saldo_ces_vej      = carga_reg[460,474]
            LET reg_det_trasp_sal.saldo_aport_vol    = carga_reg[475,489]
            LET reg_det_trasp_sal.saldo_viv_97       = carga_reg[490,504]
            LET reg_det_trasp_sal.saldo_cuo_soc      = carga_reg[505,519]
	       ...
	       PROMPT "ARCHIVO DIFIERE CON OPERACION SELECCIONADA...<ENTER> ",
            ...
            WHEN "09"   #---SUMARIO DE TRASPASO COMPLEMENTARIOS---#
                LET reg_sum_trasp.tipo_registro     = carga_reg[001,002]
                LET reg_sum_trasp.cant_reg_det      = carga_reg[003,011]
                LET reg_sum_trasp.tot_sal_ret_97    = carga_reg[012,026]
                LET reg_sum_trasp.tot_sal_ces_vej   = carga_reg[027,041]
...
#sna-------------------------
    ...
    FOREACH cur_5 INTO carga_reg
        CASE carga_reg[1,2]
            ...
            LET reg_det_sol_no_ate.cve_ced_cuenta     = carga_reg[020,022]
       ...
       CALL f_desmarca_cuenta_ic(reg_det_sol_no_ate.n_seguro,250,v_correlativo,92)
...
#sr------------------------
        ...
        CASE carga_reg[1,2]
	       ...
	       PROMPT "ARCHIVO DIFIERE CON OPERACION SELECCIONADA...<ENTER> ",
            ...
            WHEN "02"   #---DETALLE DE SOLICITUDES RECHAZADAS---#
                ...
                LET reg_det_sol_rech.cve_ced_cuenta       = carga_reg[020,022]
                ...
                LET reg_det_sol_rech.afore_receptora      = carga_reg[710,712]

                INSERT INTO tra_det_rechazo VALUES(ultimo_folio       ,
                                                   reg_det_sol_rech.* ,
                                                   reg_4.rechazada
                                                   )
    ...
    LET a_fecha_genera = reg_det_sol_rech.ident_lote_solic[10,11],"/",
	    ...
	    INTO   v_correlativo
	    FROM   tra_mae_icefa A
	    WHERE  A.n_seguro        = reg_det_sol_rech.n_seguro
	    AND    A.nss             = reg_det_sol_rech.n_seguro_ent
	    AND    A.rfc             = reg_det_sol_rech.rfc_ent
	    AND    A.icefa_cod       = reg_det_sol_rech.cve_ced_cuenta
	    AND    A.nro_int_cta     = reg_det_sol_rech.nro_ctrl_icefa
	    AND    A.status          = reg_4.enviada
	    AND    A.fecha_genera    = a_fecha_genera

            CALL actualiza_maeicefa_rechazada(reg_det_sol_rech.n_seguro        ,
                                              reg_det_sol_rech.n_seguro_ent    ,
                                              reg_det_sol_rech.rfc_ent         ,
                                              reg_det_sol_rech.cve_ced_cuenta  ,
                                              reg_det_sol_rech.nro_ctrl_icefa  ,
	   ...
	   WHERE correlativo = v_correlativo
         ...
         CALL f_desmarca_cuenta_ic(reg_det_sol_rech.n_seguro,250,v_correlativo,90)
...
display "reg_3.n_seguro:    ",reg_3.n_seguro
sleep 2
display "reg_3.nss:       ",reg_3.nss
sleep 2
display "reg_3.rfc:       ",reg_3.rfc
sleep 2
display "reg_3.icefa_cod:    ",reg_3.icefa_cod
sleep 2
display "reg_3.nro_int_cta:    ",reg_3.nro_int_cta
sleep 2
display "reg_4.fecha_genera:      ",reg_4.fecha_genera
sleep 2
display "reg_3.estado_actual:     ",reg_3.estado_actual
sleep 2
        SELECT COUNT(*)
        INTO   s_nro_icefa
        FROM   tra_mae_icefa
	...
	AND    tra_mae_icefa.nss          = reg_3.nss
        ...
        AND    tra_mae_icefa.status       = reg_3.estado_actual
         ...
         --           AND    tra_mae_icefa.lote_genera  = reg_4.lote_genera
                    ...
                    RETURN
                ELSE
                    INSERT INTO tra_no_actualiza VALUES(ultimo_folio      ,
                                                   reg_3.estado_nuevo     ,
                                                   reg_3.n_seguro         ,
                                                   reg_3.nss              ,
                                                   reg_3.rfc              ,
