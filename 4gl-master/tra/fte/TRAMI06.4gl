##############################################################################
#Owner             => E.F.P.
#Programa TRAMI06  => CONSULTA A SOLICITUDES RECHAZADAS DE TRASPASOS ICEFA-AFORE
...
MAIN
    ...
    DISPLAY " TRAMI06     CONSULTA RECHAZOS DE TRASPASO ICEFA-AFORE ISSSTE                  " AT 3,1 ATTRIBUTE(REVERSE)
    ...
    DISPLAY " TRAMI06     CONSULTA DEVOLUCIONES DE TRASPASO ICEFA-AFORE ISSSTE              " AT 3,1 ATTRIBUTE(REVERSE)
    DISPLAY HOY USING "DD-MM-YYYY" AT 3,68 ATTRIBUTE(REVERSE)
	    CALL Inicializa()
	    CALL devoluciones() #d

        COMMAND "No_atendidas" "Consulta de icefas no atendidas"
    DISPLAY " TRAMI06     CONSULTA NO ATENDIDAS DE TRASPASO ICEFA_AFORE ISSSTE              " AT 3,1 ATTRIBUTE(REVERSE)
...
#d---------------------
    ...
    DISPLAY " TRAMI06     CONSULTA DEVOLUCIONES TRASPASO ICEFA-AFORE ISSSTE                 " AT 3,1 ATTRIBUTE(REVERSE)
    DISPLAY HOY USING "DD-MM-YYYY" AT 3,68 ATTRIBUTE(REVERSE)
...
#r-----------------
    ...
    DISPLAY " TRAMI06     CONSULTA NO ATENDIDAS TRASPASO ICEFA-AFORE ISSSTE                 " AT 3,1 ATTRIBUTE(REVERSE)
    DISPLAY HOY USING "DD-MM-YYYY" AT 3,68 ATTRIBUTE(REVERSE)
