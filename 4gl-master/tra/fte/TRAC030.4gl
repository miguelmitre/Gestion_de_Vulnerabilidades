...
DISPLAY " TRAC030           GENERA REPORTE DE STATUS ICEFA-AFORE IMSS                   " AT 3,1 ATTRIBUTE(REVERSE)                                          
      ...
      PROMPT "DESEA IMPRIMIR REPORTE S/N? " ATTRIBUTE (REVERSE) FOR CHAR enter 
        IF enter MATCHES "[sSnN]" THEN                                       
            IF enter MATCHES "[sS]" THEN                                     
                RUN comando 
                DISPLAY "ARCHIVO GENERADO EN: ",g_lista CLIPPED AT 19,2
...
FORMAT 
	PAGE HEADER
        ...
        PRINT COLUMN 010,g_glob.codigo_afore USING "###","  ",g_glob.razon_social CLIPPED

	PRINT 
	PRINT
            COLUMN 10,  "          REPORTE DE STATUS DE ICEFAS              "
