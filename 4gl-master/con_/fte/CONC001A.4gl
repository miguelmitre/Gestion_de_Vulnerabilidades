...
#pp-------------------------
    ...
    OPEN WINDOW ventana_1 AT 2,2 WITH FORM "CONC0011" ATTRIBUTE(BORDER)
...
#in---------------
  ...
  LET  vfecha       = ""
  LET  vpregunta    = ""
  INPUT BY NAME vproceso,vdescripcion,vfolio,vfecha,vpregunta WITHOUT DEFAULTS
     ...
     FOREACH con_1 INTO vtransaccion,subcta,subcta1,subcta2
         ...
         IF (subcta = 4 OR
             subcta = 8) THEN
              ...
              FOREACH viv_2 INTO total_pesos,f_conversion --,f_proceso
              END FOREACH
		  ...
		  WHERE  folio = g_reg.folio
                  ...
                  LET g_reg.fecha_valor   = f_conversion
              END IF
              IF g_reg.proceso_cod = "00003" THEN
...
#arc modificar el sum(acciones)
              ...
              FOREACH rcv_1 INTO total_acciones,total_pesos,precio,f_conversion
              END FOREACH
...
#cg------------------------
    ...
    LET g_reg.estado          = 20
	 ...
	 GROUP BY 1
         ...
         FOREACH cg_viv INTO total_pesos,f_conversion
         END FOREACH
...
#as------------------------------
    ...
    LET g_reg.estado          = 20
	 ...
	 GROUP BY 1
         ...
         FOREACH as_viv INTO total_pesos
         END FOREACH
...
#co----------------------
    ...
    OPEN WINDOW ventana_3 AT 5,2 WITH FORM "CONC0014" ATTRIBUTE(BORDER)
