...
#Owner             => E.F.P 
#Programa          => Listado de Validacion de Recaudacion
#Fecha             => 28 Enero 1998
...
############################################################################
    ...
    ATTRIBUTE (BORDER)
    DISPLAY " CONTL001          REPORTE PARA VALIDACION DE RECAUDACION       " AT 3,1 ATTRIBUTE(REVERSE)
...
###########################################################################    
       DEFINE vtransa     CHAR(1)
	     ...
	     --START REPORT listado TO "/u/FTE/CENVIO/reporte.out"
	     START REPORT listado TO "/LISTADOS/reporte.out"
	 ...
	 ORDER BY 1
	    ...
	    RUN G_LISTA
	    LET G_LISTA =  "/LISTADOS/reporte.out"
