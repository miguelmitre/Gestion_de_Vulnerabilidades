...
#Propietario       => E.F.P.                                                #
#Programa CONB003  => REVALORIZACION DIARIA BONO PENSION                    #
#Sistema           => CON                                                   #
...
#pp-------------------------
    ...
    DISPLAY " CONB003  REVALORIZACION DIARIA BONO PENSION (CEDIDOS-REDIMIDOS)               " AT 3,1 ATTRIBUTE(REVERSE)
...
{    sql
    ...
    INTO   HAY_REGISTROS 
    FROM   cta_his_bono
    WHERE  fecha_baja = g_reg.fecha_genera
        ...
        DISPLAY "BONOS A PROCESAR ", vsoli_env AT 11,9
{
        ...
        LET G_LISTA = g_seg_modulo.ruta_listados CLIPPED,
                      "/",g_usuario CLIPPED, "LISTADO_ACT_BONO_CED_RED."
...
#{comentado
            SELECT @saldo_ini_udis, 
                   ...
                   @importe_bono
            INTO   saldo_ini_udis, saldo_ini_pesos, saldo_ini_pesos_udis,importe_bono
            FROM   sdo_ini_bono
            WHERE  @nss             = w_aux.nss
            AND    @curp            = w_aux.curp
            --AND    @folio           = w_aux.folio
    ...
    PAGE HEADER
       ...
       -- PRINT '\033e\033(10U\033&l1O\033&k2S\033&l12d'
        ...
        PRINT
            ...
            COLUMN 35,"LISTADO REGISTROS DE BONO DE PENSION CEDIDO-RED " ,
