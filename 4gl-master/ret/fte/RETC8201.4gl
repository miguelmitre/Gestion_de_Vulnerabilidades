...
#Propietario       => E.F.P.                                                   #
#Programa RETC8201 => REVERSO INCORPORA PAGO DE RCV Y VIV, POR PLAN PRIVADO    #
...
MAIN
    ...
    CALL init() #i
    OPEN WINDOW retc82011 AT 4,4 WITH FORM "RETC82011" ATTRIBUTE(BORDER)
    DISPLAY " <Ctrl-C> Salir                                              TIPO RETIRO F     " AT 1,1 ATTRIBUTE(REVERSE)
    DISPLAY " RETC8201      REVERSO INCORPORA PAGO DISPOSICION DE RECURSOS                  " AT 3,1 ATTRIBUTE(REVERSE)
        ...
        AFTER FIELD vfolio_oper05
           ...
           GROUP BY 1
            ...
            FOREACH cur_1 INTO vtipo_movimiento
                ...
                IF vtipo_movimiento = 840
                OR vtipo_movimiento = 10 THEN
                    # EL FOLIO ES UNICO PARA RETIRO F
                ELSE
                    ERROR "    ERROR...FOLIO NO UNICO PARA TIPO RETIRO F "
                    ATTRIBUTE(NORMAL)
                    NEXT FIELD vfolio_oper05
                END IF
            END FOREACH
