...
#Programa:    => RETL744 - REPORTE DE LIQUIDACION DE REINVERSION EN PESOS      #
...
Clave: 
Nombre: 
Fecha creacion: Noviembre 15, 2011
Autor: Daniel Buendia, UPGENIA
Narrativa del proceso que realiza:
Funcion principal del Reporte de Liquidacion de Reinversion en Pesos, se
...
DEFINE
 ...
 OPEN WINDOW w_RETL7441 AT 4,4 WITH FORM "RETL7441" ATTRIBUTES (BORDER)
 DISPLAY "                < Ctrl-C > Salir                (ESC) Ejecutar                 " AT 1,1 ATTRIBUTE(REVERSE)
 DISPLAY " RETL744     REPORTE DE LIQUIDACIÓN DE REINVERSIÓN EN PESOS                    " AT 3,1 ATTRIBUTE (REVERSE)
...
DEFINE
 ...
 LET mc_archivo = lc_ruta_listados CLIPPED, "/",md_hoy USING"YYYYMMDD",".744"
END FUNCTION
...
DEFINE
 ...
 lr_rpt_liq_reinv            RECORD
   ...
   regimen          CHAR(2),
   nombre           VARCHAR(100),
   pesos_retencion  DECIMAL(22,6),
   pesos_r97        DECIMAL(22,6),
   pesos_cv         DECIMAL(22,6),
   pesos_cs         DECIMAL(22,6),
   pesos_sar_92     DECIMAL(22,6),
   pesos_viv97      DECIMAL(22,6),
   pesos_viv92      DECIMAL(22,6),
 ...
 -- se inciializan los pesos
 LET lr_rpt_liq_reinv.pesos_retencion  = 0
 LET lr_rpt_liq_reinv.pesos_r97      = 0
 LET lr_rpt_liq_reinv.pesos_cv      = 0
 LET lr_rpt_liq_reinv.pesos_cs   = 0
 LET lr_rpt_liq_reinv.pesos_sar_92     = 0
 LET lr_rpt_liq_reinv.pesos_viv97      = 0
 LET lr_rpt_liq_reinv.pesos_viv92      = 0
 LET lr_rpt_liq_reinv.pesos_rcv        = 0
 ...
 FOREACH cur_montos INTO lr_montos.folio, lr_montos.nss, lr_montos.consecutivo_lote, lr_montos.siefore
   ...
   -- se invoca la funcion que obtiene el monto en pesos de la subcuenta R97 (1)
   LET lr_rpt_liq_reinv.pesos_r97 = f_obt_montopesos_r97(lr_rpt_liq_reinv.nss, lr_rpt_liq_reinv.consecutivo, lr_rpt_liq_reinv.siefore)
   
   -- se invoca la funcion que obtiene el monto en pesos de la subcuenta CV (2,6,9)
   LET lr_rpt_liq_reinv.pesos_cv = f_obt_montopesos_cv(lr_rpt_liq_reinv.nss, lr_rpt_liq_reinv.consecutivo, lr_rpt_liq_reinv.siefore)
   
   -- se invoca la funcion que obtiene el monto en pesos de la subcuenta VIV97 (4)
   LET lr_rpt_liq_reinv.pesos_viv97 = f_obt_montopesos_viv97(lr_rpt_liq_reinv.nss, lr_rpt_liq_reinv.consecutivo, lr_rpt_liq_reinv.siefore)
   
   -- se invoca la funcion que obtiene el monto en pesos de la subcuenta VIV92 (8)
   LET lr_rpt_liq_reinv.pesos_viv92 = f_obt_montopesos_viv92(lr_rpt_liq_reinv.nss, lr_rpt_liq_reinv.consecutivo, lr_rpt_liq_reinv.siefore)
   
   -- se invoca la funcion que obtiene el monto en pesos de la subcuenta CS (5)
   LET lr_rpt_liq_reinv.pesos_cs = f_obt_montopesos_cs(lr_rpt_liq_reinv.nss, lr_rpt_liq_reinv.consecutivo, lr_rpt_liq_reinv.siefore)
   
   -- se invoca la funcion que obtiene el monto en pesos de la subcuenta R92 (7)
   LET lr_rpt_liq_reinv.pesos_sar_92 = f_obt_montopesos_r92(lr_rpt_liq_reinv.nss, lr_rpt_liq_reinv.consecutivo, lr_rpt_liq_reinv.siefore)
   
   --  se invoca la funcion que obtiene el monto en pesos de la retencion
   LET lr_rpt_liq_reinv.pesos_retencion = f_obt_montopesos_retenc(lr_rpt_liq_reinv.nss, lr_rpt_liq_reinv.consecutivo, lr_rpt_liq_reinv.siefore)
   
   #RCV
   LET lr_rpt_liq_reinv.pesos_rcv = lr_rpt_liq_reinv.pesos_r97 + lr_rpt_liq_reinv.pesos_cv + lr_rpt_liq_reinv.pesos_cs
...
Fecha creacion: Noviembre 16, 2011
Autor: Daniel Buendia, UPGENIA
Narrativa del proceso que realiza:
...
DEFINE
 lr_rpt RECORD
   ...
   pesos_rcv        DECIMAL(22,6)
 END RECORD,
 ld_pesos_viv97     DECIMAL(22,6),
 ld_pesos_viv92     DECIMAL(22,6),
 encabezado         CHAR(60),
 L1                 CHAR(01),
 L2                 CHAR(02),
 L3                 CHAR(03),
 ...
 FIRST PAGE HEADER
   ...
   PRINT COLUMN 74,"REPORTE DE LIQUIDACIÓN DE REINVERSIÓN EN PESOS", '\033015'
   SKIP 2 LINES
   
   PRINT COLUMN 001, "AFORE               : ", mc_razon_social CLIPPED,
         COLUMN 147, "PAGINA              : ", lv_pagina, '\033015'
   
   PRINT COLUMN 001, "PROGRAMA            : RETL744",
 ...
 BEFORE GROUP OF lr_rpt.siefore
   ...
   PRINT COLUMN 001,"|",
         ...
         COLUMN 055,"|",      --regimen
         COLUMN 096,"MONTOS LIQUIDADOS DE LA CUENTA INDIVIDUAL (PESOS)",
         COLUMN 192,"|", '\033015'
   ...
   PRINT COLUMN 001,"|",
         ...
         COLUMN 058,"\302",            --siefore
                    ...
                    "\302", L10,L5,L1, --
                    "\302", L10,L5,L1, --sar92
                    "\302", L10,L5,L1, --pesos_viv97
                    "\302", L10,L5,L1, --pesos_viv92
                    "\302", L10,L5,L1, --rcv
                    "\302", L10,L5,L1, --rcv
                    "\277",
                    '\033015'
   ...
   PRINT COLUMN 001,"\300",L10,L1,            --nss
                    ...
                    "\301",L10,L5,L1,         --
                    "\301",L10,L5,L1,         --sar92
                    "\301",L10,L5,L1,         --pesos_viv97
                    "\301",L10,L5,L1,         --pesos_viv92
                    "\301",L10,L5,L1,         --
                    "\301",L10,L5,L1,         --
                    "\301",L10,L5,L1,         --rcv
                    "\331",
 ...
 ON EVERY ROW
   ...
   IF lr_rpt.pesos_viv97 = 0 THEN
     LET ld_pesos_viv97 = NULL
   END IF
   -- en caso de ser cero no se mostara ningun monto
   IF lr_rpt.pesos_viv92 = 0 THEN
     LET ld_pesos_viv92 = NULL
   END IF
   ...
   PRINT COLUMN 002, lr_rpt.nss,
         ...
         COLUMN 074, lr_rpt.pesos_r97        USING "############&.&&",
         COLUMN 091, lr_rpt.pesos_cv         USING "############&.&&",
         COLUMN 108, lr_rpt.pesos_cs         USING "############&.&&",
         COLUMN 125, lr_rpt.pesos_sar_92     USING "############&.&&",
         COLUMN 142, ld_pesos_viv97          USING "############&.&&",
         COLUMN 159, ld_pesos_viv92          USING "############&.&&",
 ...
 AFTER GROUP OF lr_rpt.siefore
   ...
   PRINT COLUMN 001,"|",
         ...
         COLUMN 058,"|",GROUP SUM(lr_rpt.pesos_retencion)  USING "##########&.&&",
         COLUMN 073,"|",GROUP SUM(lr_rpt.pesos_r97)        USING "############&.&&",
         COLUMN 090,"|",GROUP SUM(lr_rpt.pesos_cv)         USING "############&.&&",
         COLUMN 107,"|",GROUP SUM(lr_rpt.pesos_cs)         USING "############&.&&",
         COLUMN 124,"|",GROUP SUM(lr_rpt.pesos_sar_92)     USING "############&.&&",
         COLUMN 141,"|",GROUP SUM(lr_rpt.pesos_viv97)      USING "############&.&&",
         COLUMN 158,"|",GROUP SUM(lr_rpt.pesos_viv92)      USING "############&.&&",
         COLUMN 175,"|",GROUP SUM(lr_rpt.pesos_rcv)        USING "############&.&&",
         COLUMN 192,"|"
 ...
 ON LAST ROW
   ...
   #BLOQUE 2 TOTALES POR SIEFORE
   PRINT COLUMN 001,"|",
         COLUMN 022,"TOTALES GLOBALES",
         COLUMN 058,"|",SUM(lr_rpt.pesos_retencion)  USING "##########&.&&",
         COLUMN 073,"|",SUM(lr_rpt.pesos_r97)        USING "############&.&&",
         COLUMN 090,"|",SUM(lr_rpt.pesos_cv)         USING "############&.&&",
         COLUMN 107,"|",SUM(lr_rpt.pesos_cs)         USING "############&.&&",
         COLUMN 124,"|",SUM(lr_rpt.pesos_sar_92)     USING "############&.&&",
         COLUMN 141,"|",SUM(lr_rpt.pesos_viv97)      USING "############&.&&",
         COLUMN 158,"|",SUM(lr_rpt.pesos_viv92)      USING "############&.&&",
         COLUMN 175,"|",SUM(lr_rpt.pesos_rcv)        USING "############&.&&",
         COLUMN 192,"|"
...
{ ==========================================================================
Clave: 
Nombre: f_obt_montopesos_r97
Fecha creacion: Noviembre 17, 2011
Autor: Daniel Buendia, UPGENIA
Narrativa del proceso que realiza:
Funcion que consulta el monto en pesos de la subcuenta R97, para el nss,
...
FUNCTION f_obt_montopesos_r97(lc_nss, li_consecutivo_lote, li_siefore)
DEFINE
 ...
 ld_monto_pesos_r97  DECIMAL(22,6), -- monto en pesos total obtenido
 lv_qryTxt           CHAR(500) -- guarda una sentencia sql a ejecutar
 
 -- verifica si se ingreso folio y periodo
 IF mi_query_ctl = 1 THEN
   -- se crea la sentencia sql que obtiene el monto en pesos para R97 para el folio y la fecha dada
   LET lv_qryTxt = " SELECT SUM(monto_en_pesos)\n",
                   " FROM dis_cuenta\n",
                   " WHERE nss = '",lc_nss,"'\n",
 ...
 ELSE
   -- verifica si se ingreso folio
   IF mi_query_ctl = 2 THEN
     -- se crea la sentencia sql que obtiene el monto en pesos para R97 para el folio dado
     LET lv_qryTxt = " SELECT SUM(monto_en_pesos)\n",
                     " FROM dis_cuenta\n",
                     " WHERE nss = '",lc_nss,"'\n",
                     " AND consecutivo_lote = ",li_consecutivo_lote,"\n",
                     ...
                     " AND subcuenta = 1"
   ELSE
     -- se crea la sentencia sql que obtiene el monto en pesos para R97 para la fecha dada
     LET lv_qryTxt = " SELECT SUM(monto_en_pesos)\n",
                     " FROM dis_cuenta\n",
                     " WHERE nss = '",lc_nss,"'\n",
                     " AND consecutivo_lote = ",li_consecutivo_lote,"\n",
 ...
 PREPARE prp_sumMonPesos_r97 FROM lv_qryTxt
 EXECUTE prp_sumMonPesos_r97 INTO ld_monto_pesos_r97
 
 -- si el monto obtenido es nulo se asigna cero
 IF ld_monto_pesos_r97 IS NULL THEN
   LET ld_monto_pesos_r97 = 0
 END IF
 
 RETURN ld_monto_pesos_r97
 
END FUNCTION

{ ==========================================================================
Clave: 
Nombre: f_obt_montopesos_cv
Fecha creacion: Noviembre 17, 2011
Autor: Daniel Buendia, UPGENIA
Narrativa del proceso que realiza:
Funcion que consulta el monto en pesos de la subcuenta CV, para el nss,
consecutivo y siefore que entran como parametro, igualmente considera los
datos ingresados por el usuario
...
FUNCTION f_obt_montopesos_cv(lc_nss, li_consecutivo_lote, li_siefore)
DEFINE
 lc_nss              LIKE dis_cuenta.nss, -- numero de seguridad social
 li_consecutivo_lote LIKE dis_cuenta.consecutivo_lote, -- consecutivo lote
 li_siefore          LIKE dis_cuenta.siefore, -- numero siefore
 ld_monto_pesos_cv   DECIMAL(22,6), -- monto en pesos total obtenido
 lv_qryTxt           CHAR(500) -- guarda una sentencia sql a ejecutar
 
 -- verifica si se ingreso folio y periodo
 IF mi_query_ctl = 1 THEN
   -- se crea la sentencia sql que obtiene el monto en pesos para CV para el folio y la fecha dada
   LET lv_qryTxt = " SELECT SUM(monto_en_pesos)\n",
                   " FROM dis_cuenta\n",
                   " WHERE nss = '",lc_nss,"'\n",
                   " AND consecutivo_lote = ",li_consecutivo_lote,"\n",
 ...
 ELSE
   -- verifica si se ingreso folio
   IF mi_query_ctl = 2 THEN
     -- se crea la sentencia sql que obtiene el monto en pesos para CV para el folio dado
     LET lv_qryTxt = " SELECT SUM(monto_en_pesos)\n",
                     " FROM dis_cuenta\n",
                     " WHERE nss = '",lc_nss,"'\n",
                     " AND consecutivo_lote = ",li_consecutivo_lote,"\n",
                     ...
                     " AND subcuenta IN (2,6,9)"
   ELSE
     -- se crea la sentencia sql que obtiene el monto en pesos para CV para la fecha dada
     LET lv_qryTxt = " SELECT SUM(monto_en_pesos)\n",
                     " FROM dis_cuenta\n",
                     " WHERE nss = '",lc_nss,"'\n",
                     " AND consecutivo_lote = ",li_consecutivo_lote,"\n",
 ...
 PREPARE prp_sumMonPesos_cv FROM lv_qryTxt
 EXECUTE prp_sumMonPesos_cv INTO ld_monto_pesos_cv
 
 -- si el monto obtenido es nulo se asigna cero
 IF ld_monto_pesos_cv IS NULL THEN
   LET ld_monto_pesos_cv = 0
 END IF
 
 RETURN ld_monto_pesos_cv
 
END FUNCTION

{ ==========================================================================
Clave: 
Nombre: f_obt_montopesos_viv97
Fecha creacion: Noviembre 17, 2011
Autor: Daniel Buendia, UPGENIA
Narrativa del proceso que realiza:
Funcion que consulta el monto en pesos de la subcuenta VIV97, para el nss,
consecutivo y siefore que entran como parametro, igualmente considera los
datos ingresados por el usuario
...
FUNCTION f_obt_montopesos_viv97(lc_nss, li_consecutivo_lote, li_siefore)
DEFINE
 lc_nss               LIKE dis_cuenta.nss, -- numero de seguridad social
 li_consecutivo_lote  LIKE dis_cuenta.consecutivo_lote, -- consecutivo lote
 li_siefore           LIKE dis_cuenta.siefore, -- numero siefore
 ld_monto_pesos_viv97 DECIMAL(22,6), -- monto en pesos total obtenido
 lv_qryTxt            CHAR(500) -- guarda una sentencia sql a ejecutar
 
 -- verifica si se ingreso folio y periodo
 IF mi_query_ctl = 1 THEN
   -- se crea la sentencia sql que obtiene el monto en pesos para VIV97 para el folio y la fecha dada
   LET lv_qryTxt = " SELECT SUM(monto_en_pesos)\n",
                   " FROM dis_cuenta\n",
                   " WHERE nss = '",lc_nss,"'\n",
                   " AND consecutivo_lote = ",li_consecutivo_lote,"\n",
 ...
 ELSE
   -- verifica si se ingreso folio
   IF mi_query_ctl = 2 THEN
     -- se crea la sentencia sql que obtiene el monto en pesos para VIV97 para el folio dado
     LET lv_qryTxt = " SELECT SUM(monto_en_pesos)\n",
                     " FROM dis_cuenta\n",
                     " WHERE nss = '",lc_nss,"'\n",
                     " AND consecutivo_lote = ",li_consecutivo_lote,"\n",
                     ...
                     " AND subcuenta = 4"
   ELSE
     -- se crea la sentencia sql que obtiene el monto en pesos para VIV97 para la fecha dada
     LET lv_qryTxt = " SELECT SUM(monto_en_pesos)\n",
                     " FROM dis_cuenta\n",
                     " WHERE nss = '",lc_nss,"'\n",
                     " AND consecutivo_lote = ",li_consecutivo_lote,"\n",
 ...
 PREPARE prp_sumMonPesos_viv97 FROM lv_qryTxt
 EXECUTE prp_sumMonPesos_viv97 INTO ld_monto_pesos_viv97
 
 -- si el monto obtenido es nulo se asigna cero
 IF ld_monto_pesos_viv97 IS NULL THEN
   LET ld_monto_pesos_viv97 = 0
 END IF
 
 RETURN ld_monto_pesos_viv97
 
END FUNCTION

{ ==========================================================================
Clave: 
Nombre: f_obt_montopesos_viv92
Fecha creacion: Noviembre 17, 2011
Autor: Daniel Buendia, UPGENIA
Narrativa del proceso que realiza:
Funcion que consulta el monto en pesos de la subcuenta VIV92, para el nss,
consecutivo y siefore que entran como parametro, igualmente considera los
datos ingresados por el usuario
...
FUNCTION f_obt_montopesos_viv92(lc_nss, li_consecutivo_lote, li_siefore)
DEFINE
 lc_nss               LIKE dis_cuenta.nss, -- numero de seguridad social
 li_consecutivo_lote  LIKE dis_cuenta.consecutivo_lote, -- consecutivo lote
 li_siefore           LIKE dis_cuenta.siefore, -- numero siefore
 ld_monto_pesos_viv92 DECIMAL(22,6), -- monto en pesos total obtenido
 lv_qryTxt            CHAR(500) -- guarda una sentencia sql a ejecutar
 
 -- verifica si se ingreso folio y periodo
 IF mi_query_ctl = 1 THEN
   -- se crea la sentencia sql que obtiene el monto en pesos para VIV92 para el folio y la fecha dada
   LET lv_qryTxt = " SELECT SUM(monto_en_pesos)\n",
                   " FROM dis_cuenta\n",
                   " WHERE nss = '",lc_nss,"'\n",
                   " AND consecutivo_lote = ",li_consecutivo_lote,"\n",
 ...
 ELSE
   -- verifica si se ingreso folio
   IF mi_query_ctl = 2 THEN
     -- se crea la sentencia sql que obtiene el monto en pesos para VIV92 para el folio dado
     LET lv_qryTxt = " SELECT SUM(monto_en_pesos)\n",
                     " FROM dis_cuenta\n",
                     " WHERE nss = '",lc_nss,"'\n",
                     " AND consecutivo_lote = ",li_consecutivo_lote,"\n",
                     ...
                     " AND subcuenta = 8"
   ELSE
     -- se crea la sentencia sql que obtiene el monto en pesos para VIV92 para la fecha dada
     LET lv_qryTxt = " SELECT SUM(monto_en_pesos)\n",
                     " FROM dis_cuenta\n",
                     " WHERE nss = '",lc_nss,"'\n",
                     " AND consecutivo_lote = ",li_consecutivo_lote,"\n",
 ...
 PREPARE prp_sumMonPesos_viv92 FROM lv_qryTxt
 EXECUTE prp_sumMonPesos_viv92 INTO ld_monto_pesos_viv92
 
 -- si el monto obtenido es nulo se asigna cero
 IF ld_monto_pesos_viv92 IS NULL THEN
   LET ld_monto_pesos_viv92 = 0
 END IF
 
 RETURN ld_monto_pesos_viv92
 
END FUNCTION

{ ==========================================================================
Clave: 
Nombre: f_obt_montopesos_cs
Fecha creacion: Noviembre 17, 2011
Autor: Daniel Buendia, UPGENIA
Narrativa del proceso que realiza:
Funcion que consulta el monto en pesos de la subcuenta CS, para el nss,
consecutivo y siefore que entran como parametro, igualmente considera los
datos ingresados por el usuario
...
FUNCTION f_obt_montopesos_cs(lc_nss, li_consecutivo_lote, li_siefore)
DEFINE
 lc_nss               LIKE dis_cuenta.nss, -- numero de seguridad social
 li_consecutivo_lote  LIKE dis_cuenta.consecutivo_lote, -- consecutivo lote
 li_siefore           LIKE dis_cuenta.siefore, -- numero siefore
 ld_monto_pesos_cs    DECIMAL(22,6), -- monto en pesos total obtenido
 lv_qryTxt            CHAR(500) -- guarda una sentencia sql a ejecutar
 
 -- verifica si se ingreso folio y periodo
 IF mi_query_ctl = 1 THEN
   -- se crea la sentencia sql que obtiene el monto en pesos para CS para el folio y la fecha dada
   LET lv_qryTxt = " SELECT SUM(monto_en_pesos)\n",
                   " FROM dis_cuenta\n",
                   " WHERE nss = '",lc_nss,"'\n",
                   " AND consecutivo_lote = ",li_consecutivo_lote,"\n",
 ...
 ELSE
   -- verifica si se ingreso folio
   IF mi_query_ctl = 2 THEN
     -- se crea la sentencia sql que obtiene el monto en pesos para CS para el folio dado
     LET lv_qryTxt = " SELECT SUM(monto_en_pesos)\n",
                     " FROM dis_cuenta\n",
                     " WHERE nss = '",lc_nss,"'\n",
                     " AND consecutivo_lote = ",li_consecutivo_lote,"\n",
                     ...
                     " AND subcuenta = 5"
   ELSE
     -- se crea la sentencia sql que obtiene el monto en pesos para CS para la fecha dada
     LET lv_qryTxt = " SELECT SUM(monto_en_pesos)\n",
                     " FROM dis_cuenta\n",
                     " WHERE nss = '",lc_nss,"'\n",
                     " AND consecutivo_lote = ",li_consecutivo_lote,"\n",
 ...
 PREPARE prp_sumMonPesos_cs FROM lv_qryTxt
 EXECUTE prp_sumMonPesos_cs INTO ld_monto_pesos_cs
 
 -- si el monto obtenido es nulo se asigna cero
 IF ld_monto_pesos_cs IS NULL THEN
   LET ld_monto_pesos_cs = 0
 END IF
 
 RETURN ld_monto_pesos_cs
 
END FUNCTION

{ ==========================================================================
Clave: 
Nombre: f_obt_montopesos_r92
Fecha creacion: Noviembre 17, 2011
Autor: Daniel Buendia, UPGENIA
Narrativa del proceso que realiza:
Funcion que consulta el monto en pesos de la subcuenta R92, para el nss,
consecutivo y siefore que entran como parametro, igualmente considera los
datos ingresados por el usuario
...
FUNCTION f_obt_montopesos_r92(lc_nss, li_consecutivo_lote, li_siefore)
DEFINE
 lc_nss               LIKE dis_cuenta.nss, -- numero de seguridad social
 li_consecutivo_lote  LIKE dis_cuenta.consecutivo_lote, -- consecutivo lote
 li_siefore           LIKE dis_cuenta.siefore, -- numero siefore
 ld_monto_pesos_r92   DECIMAL(22,6), -- monto en pesos total obtenido
 lv_qryTxt            CHAR(500) -- guarda una sentencia sql a ejecutar
 
 -- verifica si se ingreso folio y periodo
 IF mi_query_ctl = 1 THEN
   -- se crea la sentencia sql que obtiene el monto en pesos para R92 para el folio y la fecha dada
   LET lv_qryTxt = " SELECT SUM(monto_en_pesos)\n",
                   " FROM dis_cuenta\n",
                   " WHERE nss = '",lc_nss,"'\n",
                   " AND consecutivo_lote = ",li_consecutivo_lote,"\n",
 ...
 ELSE
   -- verifica si se ingreso folio
   IF mi_query_ctl = 2 THEN
     -- se crea la sentencia sql que obtiene el monto en pesos para R92 para el folio dado
     LET lv_qryTxt = " SELECT SUM(monto_en_pesos)\n",
                     " FROM dis_cuenta\n",
                     " WHERE nss = '",lc_nss,"'\n",
                     " AND consecutivo_lote = ",li_consecutivo_lote,"\n",
                     ...
                     " AND subcuenta = 7"
   ELSE
     -- se crea la sentencia sql que obtiene el monto en pesos para R92 para la fecha dada
     LET lv_qryTxt = " SELECT SUM(monto_en_pesos)\n",
                     " FROM dis_cuenta\n",
                     " WHERE nss = '",lc_nss,"'\n",
                     " AND consecutivo_lote = ",li_consecutivo_lote,"\n",
 ...
 PREPARE prp_sumMonPesos_r92 FROM lv_qryTxt
 EXECUTE prp_sumMonPesos_r92 INTO ld_monto_pesos_r92
 
 -- si el monto obtenido es nulo se asigna cero
 IF ld_monto_pesos_r92 IS NULL THEN
   LET ld_monto_pesos_r92 = 0
 END IF
 
 RETURN ld_monto_pesos_r92
 
END FUNCTION

{ ==========================================================================
Clave: 
Nombre: f_obt_montopesos_retenc
Fecha creacion: Noviembre 17, 2011
Autor: Daniel Buendia, UPGENIA
Narrativa del proceso que realiza:
Funcion que consulta el monto en pesos de la retencion, para el nss,
consecutivo y siefore que entran como parametro, igualmente considera los
datos ingresados por el usuario
...
FUNCTION f_obt_montopesos_retenc(lc_nss, li_consecutivo_lote, li_siefore)
DEFINE
 lc_nss               LIKE dis_cuenta.nss, -- numero de seguridad social
 li_consecutivo_lote  LIKE dis_cuenta.consecutivo_lote, -- consecutivo lote
 li_siefore           LIKE dis_cuenta.siefore, -- numero siefore
 ld_monto_pesos_reten DECIMAL(22,6), -- monto en pesos total obtenido
 lv_qryTxt            CHAR(500) -- guarda una sentencia sql a ejecutar
 
 -- verifica si se ingreso folio y periodo
 IF mi_query_ctl = 1 THEN
   -- se crea la sentencia sql que obtiene el monto en pesos para retencion para el folio y la fecha dada
   LET lv_qryTxt = " SELECT SUM(monto_en_pesos)\n",
                   " FROM dis_cuenta\n",
                   " WHERE nss = '",lc_nss,"'\n",
                   " AND consecutivo_lote = ",li_consecutivo_lote,"\n",
 ...
 ELSE
   -- verifica si se ingreso folio
   IF mi_query_ctl = 2 THEN
     -- se crea la sentencia sql que obtiene el monto en pesos para retencion para el folio dado
     LET lv_qryTxt = " SELECT SUM(monto_en_pesos)\n",
                     " FROM dis_cuenta\n",
                     " WHERE nss = '",lc_nss,"'\n",
                     " AND consecutivo_lote = ",li_consecutivo_lote,"\n",
                     ...
                     " AND subcuenta IN (1,2,4,5,6,7,8,9)"
   ELSE
     -- se crea la sentencia sql que obtiene el monto en pesos para retencion para la fecha dada
     LET lv_qryTxt = " SELECT SUM(monto_en_pesos)\n",
                     " FROM dis_cuenta\n",
                     " WHERE nss = '",lc_nss,"'\n",
                     " AND consecutivo_lote = ",li_consecutivo_lote,"\n",
 ...
 EXECUTE prp_obt_retencion INTO ld_monto_pesos_reten
 
 IF ld_monto_pesos_reten IS NULL THEN
   LET ld_monto_pesos_reten = 0
 END IF
 
 RETURN ld_monto_pesos_reten
