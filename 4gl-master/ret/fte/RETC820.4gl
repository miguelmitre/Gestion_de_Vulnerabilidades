...
#Owner             => E.F.P.                                                    #
#Programa RETC811  => INCORPORA PAGO DE DISPOSICION DE RECURSOS TIPO RET. "F"   #
#Fecha creacion    => 27 ENERO DEL 2004                                         #
#By                => FRANCO ULLOA VIDELA                                       #
#Fecha actualiza   => 15 DE FEBRERO DEL 2008                                    #
#By                =>                                                           #
...
MAIN
    ...
    CALL STARTLOG("RETC820.log")
   
    LET gr_datos.nom_prog   = ARG_VAL(0)
    LET gr_datos.tipo_ret   = "F"
    LET HOY                 = TODAY
