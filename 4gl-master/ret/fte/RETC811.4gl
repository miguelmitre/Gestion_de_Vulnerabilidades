...
#Owner             => E.F.P.                                                    #
#Programa RETC811  => INCORPORA PAGO DE DISPOSICION DE RECURSOS TIPO RET. "J"   #
#Fecha creacion    => 27 ENERO DEL 2004                                         #
#Actualizacion     => FRANCO ULLOA VIDELA                                       #
...
MAIN
    ...
    CALL STARTLOG("RETC811.log")
   
    LET gr_datos.nom_prog   = ARG_VAL(0)
    LET gr_datos.tipo_ret   = "J"
    LET HOY                 = TODAY
