...
# Owner              => E.F.P.                                                  #
# Programa RETC9431T => REVERZAR LA LIQUIDACION DE TRANSFERENCIA ISSSTE         #
...
FUNCTION init()
    ...
    LET gr_bitacora.programa      = "RETC9431T"
    LET gr_bitacora.desc_tramite  = "LIQ TRANSFERENCIAS ISSSTE"
...
FUNCTION f_captura_folio()
    ...
    DEFINE folio_liq LIKE ret_trans_issste.folio
    ...
    OPEN WINDOW main_rev AT 4,4 WITH FORM "RETC9431T1" ATTRIBUTE(BORDER) 
    DISPLAY " <CTRL-C> Salir                                             <ESC> Ejecutar " AT 1,1 ATTRIBUTE(REVERSE)
    DISPLAY " RETC9431T    REVERSO DE LIQUIDACION DE TRANSFERENCIAS ISSSTE              " AT 3,1 ATTRIBUTE(REVERSE)
...
FUNCTION f_reverso(pi_folio)
    ...
    LET gar_tablas_rev[3].tabla     = "ret_trans_issste"
    LET gar_tablas_rev[3].accion    = "ACTUALIZA"
    LET gar_tablas_rev[3].num_regs  = li_num_afect

    -----------------------------------------------------------------------------

    -- Si es PENSION ISSSTE, se borra en datamart los registros insertados 
    IF gs_codigo_afore = gs_peiss THEN 
        ...
        LET gar_tablas_rev[4].tabla     = "ret_datamart_issste"
