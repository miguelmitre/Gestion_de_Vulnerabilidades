...
#Programa RETL923  => REPORTE DE PROVISION DE DISPOSICIONES ISSSTE             #
...
MAIN
    ...
    CALL STARTLOG("RETL923.log")
    CALL init()

    OPEN WINDOW retl9231 AT 4,4 WITH FORM "RETL9231" ATTRIBUTE (BORDER)
    DISPLAY "                                < Ctrl-C >                                       " AT 1,1 ATTRIBUTE(REVERSE)
    DISPLAY " RETL923    REPORTE, PROVISION TRANSFERENCIAS DE RECURSOS ISSSTE               " AT 3,1 ATTRIBUTE (REVERSE)
...
FUNCTION init()
    ...
    LET gc_archivo = gr_seg_modulo.ruta_listados CLIPPED,
                     "/", gc_usuario CLIPPED,
                     ".RPT_PROV_",HOY USING"DDMMYYYY",".923"
END FUNCTION
################################################################################
FUNCTION primer_paso()
   ...
   FOREACH cur_prov INTO gr_transf.nss            ,
      ...
      LET gr_transf.acciones_tot = gr_transf.acciones_ret08      +
                                   gr_transf.acciones_cv_cs      +
                                   gr_transf.acciones_ahorro_sol

      OUTPUT TO REPORT rpt_provision(gr_transf.*)
   END FOREACH
   ...
   OUTPUT
    ...
    FIRST PAGE HEADER
      ...
      END FOR
       ...
       PRINT COLUMN 63,"REPORTE DE PROVISION DE TRANSFERENCIAS DE RECURSOS ISSSTE",
            '\033015'
       SKIP 2 LINES

       PRINT COLUMN 001, "AFORE               :", gr_afore.razon_social CLIPPED,
             COLUMN 172, "PAGINA              :" ,PAGENO USING "####",
             '\033015'

       PRINT COLUMN 001, "PROGRAMA            :RETL923",
             COLUMN 172, "FECHA PROVISION     :",gr_captura.fecha_provision USING"DD/MM/YYYY",
             '\033015'

       PRINT COLUMN 001, "FOLIO INTERNO       :",gr_captura.folio USING "#########&",
             COLUMN 172, "FECHA GENERACION    :",HOY USING "DD/MM/YYYY",
             '\033015'


    PAGE HEADER
      PRINT COLUMN 001, "FOLIO INTERNO       :", gr_captura.folio USING "#########&",
            COLUMN 063, "REPORTE DE PROVISION DE TRANSFERENCIAS DE RECURSOS ISSSTE",
            COLUMN 172, "PAGINA              :" ,PAGENO USING "####",
            '\033015'
    ...
    BEFORE GROUP OF lr_rpt.tipo_retiro
      ...
      PRINT COLUMN 001,"|",
            ...
            COLUMN 073,"|",      --regimen
            COLUMN 108,"MONTOS A LIQUIDAR DE LA CUENTA INDIVIDUAL (ACCIONES) RETIRO TIPO ",lr_rpt.tipo_retiro,
            COLUMN 202,"|",
                       '\033015'
     ...
     PRINT COLUMN 001,"|",
      ...
      PRINT COLUMN 001,"|    NSS",
            ...
            COLUMN 111,"|    CV / CS",
            COLUMN 128,"|  AHORRO  SOL.",
            COLUMN 145,"|  FOVISSSTE 08",
            COLUMN 162,"|  FOVISSSTE 08",
            COLUMN 177,"|FECHA INICIO",
            COLUMN 190,"|DIAGNOSTICO",
            COLUMN 202,"|",
            '\033015'
      ...
      PRINT COLUMN 001,"|",
            ...
            COLUMN 111,"|    ACCIONES",
            COLUMN 128,"|    ACCIONES",
            COLUMN 145,"|PARTICIPACIONES",
            COLUMN 162,"|     PESOS",
            COLUMN 177,"| DE PENSION",
            COLUMN 190,"|",
            COLUMN 202,"|",
            '\033015'
    ...
    ON EVERY ROW
      PRINT COLUMN 002, lr_rpt.nss                             ,
            ...
            COLUMN 129, lr_rpt.acciones_ahorro_sol   USING "########&.&&&&&&",
            COLUMN 146, lr_rpt.acciones_fov08        USING "########&.&&&&&&",
            COLUMN 163, lr_rpt.pesos_fov08           USING "##########&.&&",
            COLUMN 179, lr_rpt.fecha_ini_pen         USING "DD-MM-YYYY",
            COLUMN 195, lr_rpt.diag_procesar         USING "##&",
                        '\033015'
    ...
    AFTER GROUP OF lr_rpt.tipo_retiro
    	...
    	FOR li_siefore = 1 TO 5
            ...
            PRINT COLUMN 001, "\332",L10,L1,                    --nss
                              ...
                              "\302",L10,L5,L1,                 --cv_cs
                              "\302",L10,L5,L1,                 --ahorro_sol
                              "\302",L10,L10,L10,L10,L10,L5,L1, --linea
                              "\277",
                              '\033015'
            ...
            PRINT COLUMN 001, "|", lar_total_retiro[li_cont].lar_total_siefore[li_siefore].nss_tot  USING "##########&",
                  ...
                  COLUMN 128, "|", lar_total_retiro[li_cont].lar_total_siefore[li_siefore].acciones_ahorro_sol   USING "########&.&&&&&&",
                  COLUMN 145, "|",
                  COLUMN 202, "|",
                  '\033015'
            ...
            PRINT COLUMN 001, "\300",L10,L1,                    --nss
                              ...
                              "\301",L10,L5,L1,                 --cv_cs
                              "\301",L10,L5,L1,                 --ahorro_sol
                              "\301",L10,L10,L10,L10,L10,L5,L1, --linea
                              "\331",
                              '\033015'
      ...
      IF lar_gran_total_retiro[li_cont].nss_tot > 0 THEN
         ...
         PRINT COLUMN 001, "|     TOTAL DE NSS UNICOS POR TIPO DE RETIRO ", lar_gran_total_retiro[li_cont].tipo_retiro,
               ...
               COLUMN 077, "|",
               COLUMN 145, "|", lar_gran_total_retiro[li_cont].acciones_fov08        USING "########&.&&&&&&",
               COLUMN 162, "|", lar_gran_total_retiro[li_cont].pesos_fov08           USING "##########&.&&"  ,
               COLUMN 177, "|",
               COLUMN 202, "|",
               '\033015'
    ...
    ON LAST ROW
       ...
       FOR li_siefore = 1 TO 5
             ...
             PRINT COLUMN 001, "|", lar_gran_total_siefore[li_siefore].nss_tot  USING "##########&",
                   ...
                   COLUMN 128, "|", lar_gran_total_siefore[li_siefore].acciones_ahorro_sol   USING "########&.&&&&&&",
                   COLUMN 145, "|",
                   COLUMN 202, "|",
                   '\033015'
       ...
       PRINT COLUMN 001, "|     TOTAL DE NSS UNICOS",
             ...
             COLUMN 077, "|",
             COLUMN 145, "|", lr_total_gral.acciones_fov08        USING "########&.&&&&&&",
             COLUMN 162, "|", lr_total_gral.pesos_fov08           USING "##########&.&&"  ,
             COLUMN 177, "|",
             COLUMN 202, "|",
             '\033015'
