...
#Propietario       => E.F.P.                                                   #
#Programa RETC8051 => REVERSO GENERACION DE SALDOS DEL PROCESO                 #
#                     PENSION GARANTIZADA  (RET C)                             #
...
MAIN
    ...
    CALL init() #i
    OPEN WINDOW retc82211 AT 4,4 WITH FORM "RETC82211" ATTRIBUTE(BORDER)
    DISPLAY " <Ctrl-C> Salir                                              TIPO RETIRO C     " AT 1,1 ATTRIBUTE(REVERSE)
    DISPLAY " RETC8221 REVERSO GEN. DE SALDOS DEL PROCESO PENSION GARANTIZADA               " AT 3,1 ATTRIBUTE(REVERSE)
