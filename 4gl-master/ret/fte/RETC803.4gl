...
#Owner             => E.F.P.                                                    #
#Programa RETC803  => INCORPORA PAGO DE DISPOSICION DE RECURSOS TIPO RET. "E"   #
#Fecha creacion    => 04 DE FEBRERO DEL 2004                                    #
...
MAIN
    ...
    CALL STARTLOG("RETC803.log")
   
    LET gr_datos.nom_prog   = ARG_VAL(0)
    LET gr_datos.tipo_ret   = "E"
    LET HOY                 = TODAY
