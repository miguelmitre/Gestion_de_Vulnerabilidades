...
MAIN
    ...
    CALL init() #i
    OPEN WINDOW retc81611 AT 4,4 WITH FORM "RETC81611" ATTRIBUTE(BORDER)
    DISPLAY " <Ctrl-C> Salir                                              TIPO RETIRO E     " AT 1,1 ATTRIBUTE(REVERSE)
    DISPLAY " RETC8161 REVERSO NOTIFICA Y PROVISIONA DISPOSICION DE RECURSOS                " AT 3,1 ATTRIBUTE(REVERSE)
    ...
    INPUT BY NAME vfolio_oper05 WITHOUT DEFAULTS
        ...
        AFTER FIELD vfolio_oper05
            ...
            FOREACH cur_1 INTO vtipo_movimiento
                ...
                IF vtipo_movimiento = 830
                OR vtipo_movimiento = 10 THEN
                    # EL FOLIO ES UNICO PARA RETIRO E
                ELSE
                    ERROR "    ERROR...FOLIO NO UNICO PARA TIPO RETIRO E "
                    ATTRIBUTE(NORMAL)
                    NEXT FIELD vfolio_oper05
                END IF
            END FOREACH
