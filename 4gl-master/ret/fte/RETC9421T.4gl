...
# Owner              => E.F.P.                                                  #
# Programa RETC9421T => REVERZO DE LA PRELIQUIDACION DE TRANSFERENCIA ISSSTE    #
...
FUNCTION init()
    ...
    LET gr_bitacora.programa      = "RETC9421T"
    LET gr_bitacora.desc_tramite  = "PRELIQ TRANSFERENCIAS ISSSTE"
...
FUNCTION f_captura_folio()
    ...
    DEFINE folio_preliq LIKE ret_trans_issste.folio
    ...
    WHERE  estado_solicitud = gr_edo.preliquidado


    OPEN WINDOW main_rev AT 4,4 WITH FORM "RETC9421T1" ATTRIBUTE(BORDER) 
    DISPLAY " <CTRL-C> Salir                                             <ESC> Ejecutar " AT 1,1 ATTRIBUTE(REVERSE)
    DISPLAY " RETC9421T  REVERSO DE PRELIQUIDACION DE TRANSFERENCIAS ISSSTE             " AT 3,1 ATTRIBUTE(REVERSE)
    DISPLAY HOY USING "DD-MM-YYYY" AT 3,65 ATTRIBUTE(REVERSE)
    
    --CAPTURA DEL FOLIO A REVERSAR
    INPUT BY NAME folio_preliq WITHOUT DEFAULTS
        
        AFTER FIELD folio_preliq
            IF folio_preliq IS NULL THEN
    ...
    RETURN ls_procesa, folio_preliq
...
FUNCTION f_reverso(pi_folio)
    ...
    DISPLAY "R. ELIMINADOS EN tmp_ret_preliquida  : ", li_num_afect
            USING "<<<,<<&" AT 10,14

    LET gar_tablas_rev[1].tabla     = "tmp_ret_preliquida"
    ...
    LET gar_tablas_rev[2].tabla     = "ret_trans_issste"
