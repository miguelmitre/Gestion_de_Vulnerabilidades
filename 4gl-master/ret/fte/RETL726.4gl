...
#Programa RETL726  => REPORTE DE LIQUIDACION DE DISPOSICION          (PESOS )  #
#By                => CESAR DAVID CHAVEZ MARTINEZ                              #
#Fecha             => 26 DE OCTUBRE 2009                                       #
#Fecha N_Nvo Retiro > Noviembre de 2011                                        #
#Sistema           => Retiros Ref. Punto 2.5 Disposicion                       #
################################################################################
DATABASE safre_af
GLOBALS
...
MAIN
    ...
    CALL STARTLOG("RETL726.log")
    CALL init()

    OPEN WINDOW RETL7261 AT 4,4 WITH FORM "RETL7261" ATTRIBUTE (BORDER)
    DISPLAY "                                                                  < Ctrl-C > " AT 1,1 ATTRIBUTE(REVERSE)
    DISPLAY " RETL7261  REPORTE DE LIQUIDACION DE DISPOSICION EN PESOS                  " AT 3,1 ATTRIBUTE (REVERSE)
...
FUNCTION init()
    ...
    LET  gc_archivo  =  gr_seg_modulo.ruta_listados CLIPPED,
                        "/", gc_usuario CLIPPED,
                        ".LIQ_DISPO",HOY USING"DDMMYYYY" CLIPPED,".820"
END FUNCTION
   ...
   OUTPUT
    ...
    FIRST PAGE HEADER
      ...
      END FOR
       ...
       PRINT COLUMN 55,"REPORTE DE LIQUIDACION DE DISPOSICIONES EN PESOS         ",
            '\033015'
       SKIP 2 LINES
       ...
       PRINT COLUMN 001, "PROGRAMA            :RETL726",
    ...
    PAGE HEADER
      PRINT COLUMN 001, "FOLIO INTERNO       :", gr_captura.folio USING "#########&",
            COLUMN 055, "REPORTE DE LIQUIDACION DE DISPOSICIONES EN PESOS          ",
            COLUMN 206, "PAGINA              :" ,PAGENO USING "####",
            '\033015'
    ...
    BEFORE GROUP OF lr_rpt.tipo_retiro
      ...
      PRINT COLUMN 001,"|",
            ...
            COLUMN 055,"|",      --regimen
            COLUMN 108,"MONTOS LIQUIDADOS DE DISPOSICIONES DE PESOS                           ",lr_rpt.tipo_retiro,
            COLUMN 243,"|",
                       '\033015'
