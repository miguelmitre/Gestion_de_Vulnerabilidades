...
#Propietario       => E.F.P.        			                                #
#Programa RETL809  => Reporte de Liquidacion de disposicion de Recursos         #
...
#c-----------------
    ...
    OPEN WINDOW ventana_21 AT 10,4 WITH FORM "RETL8091" ATTRIBUTE( BORDER)
    DISPLAY "RETL809                     (Ctrl-C) Salir             (ESC) Ejecutar         " AT 1,1 ATTRIBUTE(REVERSE,green)
...
#aq-------------------------------------------
   ...
   END RECORD
    ...
    LET select_stmt5 = " SELECT CASE WHEN tipo_movimiento = 820 THEN 'D' ",
                       ...
                       "        siefore,monto_en_pesos,fecha_conversion ", 
...
#rci--------------------------------------------------
    ...
    ---------------------------------
        ...
        LET lr_montos.a_pagar = GROUP SUM(l_record.monto_en_pesos)                  
        IF lr_montos.a_pagar IS NULL OR lr_montos.a_pagar = ' ' THEN
            LET lr_montos.a_pagar = 0        	                                                             
        END IF     

        LET lr_montos.r97 = GROUP SUM(l_record.monto_en_pesos)
                            WHERE l_record.subcuenta = 1  
        IF lr_montos.r97 IS NULL OR lr_montos.r97 = ' ' THEN
            LET lr_montos.r97 = 0        	                                                             
        END IF     

        LET lr_montos.cv = GROUP SUM(l_record.monto_en_pesos)
        ...
        LET lr_montos.cs = GROUP SUM(l_record.monto_en_pesos)
                           WHERE l_record.subcuenta = 5          
        IF lr_montos.cs IS NULL OR lr_montos.cs = ' ' THEN
            LET lr_montos.cs = 0        	                                                             
        END IF     
 
        LET lr_montos.r92 = GROUP SUM(l_record.monto_en_pesos)
                            WHERE l_record.subcuenta = 7         
        IF lr_montos.r92 IS NULL OR lr_montos.r92 = ' ' THEN
            LET lr_montos.r92 = 0
        END IF     

        LET lr_montos.rcv = GROUP SUM(l_record.monto_en_pesos)
        ...
        PRINT 
            ...
            COLUMN 056,lr_sol_tx.tipo_seguro                        ,
            COLUMN 063,lr_sol_tx.tipo_pension                       ,
            COLUMN 070,nombre_siefore                               ,
            COLUMN 075,lr_mto_reten.reten_sb USING "#######&.&&"    ,
            COLUMN 090,lr_mto_reten.reten_sb + 
                       lr_montos.r97         +
                       lr_montos.cv          +
                       lr_montos.cs          +
                       lr_montos.r92         USING "#######&.&&"    ,
            COLUMN 106,lr_montos.r97     +
                       lr_montos.cv      +
                       lr_montos.cs      +
                       lr_montos.r92     +
                       lr_montos.viv97   +
                       lr_montos.viv92   +
                       lr_montos.viv72       USING "#######&.&&"    ,
            COLUMN 120,lr_montos.r97         USING "#######&.&&"    , 
            COLUMN 135,lr_montos.cv          USING "#######&.&&"    , 
...
--            COLUMN 230,lr_montos.rcv         USING "#######&.&&"
        ...
        IF l_record.siefore = 1 THEN
            ...
            LET reg_s1[ind].bruto    = reg_s1[ind].bruto     + 
                                       ...
                                       lr_montos.cs      +
                                       lr_montos.r92     
            LET reg_s1[ind].a_pagar  = reg_s1[ind].a_pagar   + 
                                       lr_montos.r97     +
                                       lr_montos.cv      +
                                       lr_montos.cs      +
                                       lr_montos.r92     +
...
--          LET reg_s1[ind].rcv      = reg_s1[ind].rcv       + lr_montos.rcv
            LET reg_s1[ind].rcv      = reg_s1[ind].rcv       + 
                                       lr_montos.r97         +
                                       lr_montos.cv          +
                                       lr_montos.cs
                                       
            --ACUMULADO PARA EL TOTAL SIEFORE 1        
            ...
            LET reg_s1[8].bruto    = reg_s1[8].bruto         + 
                                     ...
                                     lr_montos.cs            +
                                     lr_montos.r92     
            LET reg_s1[8].a_pagar  = reg_s1[8].a_pagar       + 
                                     lr_montos.r97           +
                                     lr_montos.cv            +
                                     lr_montos.cs            +
                                     lr_montos.r92           +
        ...
        ELSE
         IF l_record.siefore = 2 THEN
            ...
            LET reg_s2[ind].bruto    = reg_s2[ind].bruto     + 
                                       ...
                                       lr_montos.cs          +
                                       lr_montos.r92     
            LET reg_s2[ind].a_pagar  = reg_s2[ind].a_pagar     + 
                                       lr_montos.r97           +
                                       lr_montos.cv            +
                                       lr_montos.cs            +
                                       lr_montos.r92           +
...
--          LET reg_s2[ind].rcv      = reg_s2[ind].rcv       + lr_montos.rcv
            LET reg_s2[ind].rcv      = reg_s2[ind].rcv       + 
                                       lr_montos.r97         +
                                       lr_montos.cv          +
                                       lr_montos.cs
            ...
            LET reg_s2[8].bruto      = reg_s2[8].bruto       + 
                                       ...
                                       lr_montos.cs          +
                                       lr_montos.r92     
            LET reg_s2[8].a_pagar    = reg_s2[8].a_pagar     + 
                                       lr_montos.r97         +
                                       lr_montos.cv          +
                                       lr_montos.cs          +
                                       lr_montos.r92         +
         ...
         ELSE
          IF l_record.siefore = 3 THEN
             ...
             LET reg_s3[ind].bruto    = reg_s3[ind].bruto     + 
                                        ...
                                        lr_montos.cs          +
                                        lr_montos.r92     
             LET reg_s3[ind].a_pagar  = reg_s3[ind].a_pagar     + 
                                        lr_montos.r97           +
                                        lr_montos.cv            +
                                        lr_montos.cs            +
                                        lr_montos.r92           +
...
--            LET reg_s3[ind].rcv      = reg_s3[ind].rcv       + lr_montos.rcv
              LET reg_s3[ind].rcv      = reg_s3[ind].rcv       + 
                                         lr_montos.r97         +
                                         lr_montos.cv          +
                                         lr_montos.cs
              --ACUMULADO PARA EL TOTAL SIEFORE 3
              ...
              LET reg_s3[8].bruto      = reg_s3[8].bruto       + 
                                         ...
                                         lr_montos.cs          +
                                         lr_montos.r92     
              LET reg_s3[8].a_pagar    = reg_s3[8].a_pagar     + 
                                         lr_montos.r97         +
                                         lr_montos.cv          +
                                         lr_montos.cs          +
                                         lr_montos.r92         +
          ...
          ELSE
           IF l_record.siefore = 4 THEN
              ...
              LET reg_s4[ind].bruto    = reg_s4[ind].bruto     + 
                                       ...
                                       lr_montos.cs          +
                                       lr_montos.r92     
              LET reg_s4[ind].a_pagar  = reg_s4[ind].a_pagar     + 
                                     lr_montos.r97           +
                                     lr_montos.cv            +
                                     lr_montos.cs            +
                                     lr_montos.r92           +
            ...
            --LET reg_s4[ind].rcv      = reg_s4[ind].rcv       + lr_montos.rcv
              LET reg_s4[ind].rcv      = reg_s4[ind].rcv       + 
                                         lr_montos.r97         +
                                         lr_montos.cv          +
                                         lr_montos.cs
              --ACUMULADO PARA EL TOTAL  SIEFORE 4
              ...
              LET reg_s4[8].bruto      = reg_s4[8].bruto       + 
                                         ...
                                         lr_montos.cs          +
                                         lr_montos.r92     
              LET reg_s4[8].a_pagar    = reg_s4[8].a_pagar     + 
                                         lr_montos.r97         +
                                         lr_montos.cv          +
                                         lr_montos.cs          +
                                         lr_montos.r92         +
           ...
           ELSE
            IF l_record.siefore = 5 THEN
               ...
               LET reg_s5[ind].bruto    = reg_s5[ind].bruto     + 
                                          ...
                                          lr_montos.cs          +
                                          lr_montos.r92     
               LET reg_s5[ind].a_pagar  = reg_s5[ind].a_pagar     + 
                                          lr_montos.r97           +
                                          lr_montos.cv            +
                                          lr_montos.cs            +
                                          lr_montos.r92           +
             ...
             --LET reg_s5[ind].rcv      = reg_s5[ind].rcv    + lr_montos.rcv
               LET reg_s5[ind].rcv      = reg_s5[ind].rcv    + 
                                          lr_montos.r97      +
                                          lr_montos.cv       +
                                          lr_montos.cs
              --ACUMULADO PARA EL TOTAL SIEFORE 5
              ...
              LET reg_s5[8].bruto      = reg_s5[8].bruto       + 
                                         ...
                                         lr_montos.cs          +
                                         lr_montos.r92     
              LET reg_s5[8].a_pagar    = reg_s5[8].a_pagar     + 
                                         lr_montos.r97         +
                                         lr_montos.cv          +
                                         lr_montos.cs          +
                                         lr_montos.r92         +
    ...
    AFTER GROUP OF l_record.tipo_retiro
        ...
        IF reg_s1[ind].tot > 0 THEN
            ...
            PRINT
                ...
                COLUMN 070,"SB1",
                COLUMN 074,"|",
                COLUMN 075,reg_s1[ind].reten   USING "#######&.&&",
                COLUMN 089,"|",
                COLUMN 090,reg_s1[ind].bruto   USING "#######&.&&",
                COLUMN 104,"|",
                COLUMN 106,reg_s1[ind].a_pagar USING "#######&.&&",
                COLUMN 119,"|",
                COLUMN 120,reg_s1[ind].r97     USING "#######&.&&",
                COLUMN 134,"|",
                COLUMN 135,reg_s1[ind].cv      USING "#######&.&&",
                COLUMN 149,"|",
                COLUMN 150,reg_s1[ind].cs      USING "#######&.&&",
                COLUMN 165,"|",
                COLUMN 166,reg_s1[ind].viv97   USING "#######&.&&",
                COLUMN 181,"|",
                COLUMN 182,reg_s1[ind].viv92   USING "#######&.&&",
                COLUMN 197,"|",
                COLUMN 198,reg_s1[ind].r92     USING "#######&.&&",
                COLUMN 213,"|",
                COLUMN 214,reg_s1[ind].viv72   USING "#######&.&&",
                COLUMN 229,"|",
                COLUMN 230,reg_s1[ind].rcv     USING "#######&.&&",
                COLUMN 245,"|",
            '\033015'

             PRINT COLUMN 1,"\300",L10,L1,
                            "\301",L10,L10,L10,L5,L2,L2,L5,L1,L5,L2,L2,
                            "\301",L5,     
                            "\301",L10,L2,L2,
                            "\301",L10,L2,L2,
                            "\301",L10,L2,L2,
        ...
        IF reg_s2[ind].tot > 0 THEN
            ...
            PRINT
                ...
                COLUMN 070,"SB2",
                COLUMN 074,"|",
                COLUMN 075,reg_s2[ind].reten   USING "#######&.&&",
                COLUMN 089,"|",
                COLUMN 090,reg_s2[ind].bruto   USING "#######&.&&",
                COLUMN 104,"|",
                COLUMN 106,reg_s2[ind].a_pagar USING "#######&.&&",
                COLUMN 119,"|",
                COLUMN 120,reg_s2[ind].r97     USING "#######&.&&",
                COLUMN 134,"|",
                COLUMN 135,reg_s2[ind].cv      USING "#######&.&&",
                COLUMN 149,"|",
                COLUMN 150,reg_s2[ind].cs      USING "#######&.&&",
                COLUMN 165,"|",
                COLUMN 166,reg_s2[ind].viv97   USING "#######&.&&",
                COLUMN 181,"|",
                COLUMN 182,reg_s2[ind].viv92   USING "#######&.&&",
                COLUMN 197,"|",
                COLUMN 198,reg_s2[ind].r92     USING "#######&.&&",
                COLUMN 213,"|",
                COLUMN 214,reg_s2[ind].viv72   USING "#######&.&&",
                COLUMN 229,"|",
                COLUMN 230,reg_s2[ind].rcv     USING "#######&.&&",
                COLUMN 245,"|",
            '\033015'
        ...
        IF reg_s3[ind].tot > 0 THEN
            ...
            PRINT
                ...
                COLUMN 070,"SB3",
                COLUMN 074,"|",
                COLUMN 075,reg_s3[ind].reten   USING "#######&.&&",
                COLUMN 089,"|",
                COLUMN 090,reg_s3[ind].bruto   USING "#######&.&&",
                COLUMN 104,"|",
                COLUMN 106,reg_s3[ind].a_pagar USING "#######&.&&",
                COLUMN 119,"|",
                COLUMN 120,reg_s3[ind].r97     USING "#######&.&&",
                COLUMN 134,"|",
                COLUMN 135,reg_s3[ind].cv      USING "#######&.&&",
                COLUMN 149,"|",
                COLUMN 150,reg_s3[ind].cs      USING "#######&.&&",
                COLUMN 165,"|",
                COLUMN 166,reg_s3[ind].viv97   USING "#######&.&&",
                COLUMN 181,"|",
                COLUMN 182,reg_s3[ind].viv92   USING "#######&.&&",
                COLUMN 197,"|",
                COLUMN 198,reg_s3[ind].r92     USING "#######&.&&",
                COLUMN 213,"|",
                COLUMN 214,reg_s3[ind].viv72   USING "#######&.&&",
                COLUMN 229,"|",
                COLUMN 230,reg_s3[ind].rcv     USING "#######&.&&",
                COLUMN 245,"|",
            '\033015'
        ...
        IF reg_s4[ind].tot > 0 THEN
            ...
            PRINT
                ...
                COLUMN 070,"SB4",
                COLUMN 074,"|",
                COLUMN 075,reg_s4[ind].reten   USING "#######&.&&",
                COLUMN 089,"|",
                COLUMN 090,reg_s4[ind].bruto   USING "#######&.&&",
                COLUMN 104,"|",
                COLUMN 106,reg_s4[ind].a_pagar USING "#######&.&&",
                COLUMN 119,"|",
                COLUMN 120,reg_s4[ind].r97     USING "#######&.&&",
                COLUMN 134,"|",
                COLUMN 135,reg_s4[ind].cv      USING "#######&.&&",
                COLUMN 149,"|",
                COLUMN 150,reg_s4[ind].cs      USING "#######&.&&",
                COLUMN 165,"|",
                COLUMN 166,reg_s4[ind].viv97   USING "#######&.&&",
                COLUMN 181,"|",
                COLUMN 182,reg_s4[ind].viv92   USING "#######&.&&",
                COLUMN 197,"|",
                COLUMN 198,reg_s4[ind].r92     USING "#######&.&&",
                COLUMN 213,"|",
                COLUMN 214,reg_s4[ind].viv72   USING "#######&.&&",
                COLUMN 229,"|",
                COLUMN 230,reg_s4[ind].rcv     USING "#######&.&&",
                COLUMN 245,"|",
            '\033015'
        ...
        IF reg_s5[ind].tot > 0 THEN
            ...
            PRINT
                ...
                COLUMN 070,"SB5",
                COLUMN 074,"|",
                COLUMN 075,reg_s5[ind].reten   USING "#######&.&&",
                COLUMN 089,"|",
                COLUMN 090,reg_s5[ind].bruto   USING "#######&.&&",
                COLUMN 104,"|",
                COLUMN 106,reg_s5[ind].a_pagar USING "#######&.&&",
                COLUMN 119,"|",
                COLUMN 120,reg_s5[ind].r97     USING "#######&.&&",
                COLUMN 134,"|",
                COLUMN 135,reg_s5[ind].cv      USING "#######&.&&",
                COLUMN 149,"|",
                COLUMN 150,reg_s5[ind].cs      USING "#######&.&&",
                COLUMN 165,"|",
                COLUMN 166,reg_s5[ind].viv97   USING "#######&.&&",
                COLUMN 181,"|",
                COLUMN 182,reg_s5[ind].viv92   USING "#######&.&&",
                COLUMN 197,"|",
                COLUMN 198,reg_s5[ind].r92     USING "#######&.&&",
                COLUMN 213,"|",
                COLUMN 214,reg_s5[ind].viv72   USING "#######&.&&",
                COLUMN 229,"|",
                COLUMN 230,reg_s5[ind].rcv     USING "#######&.&&",
                COLUMN 245,"|",
            '\033015'
        ...
        FOR i = 1 TO 7
              ...
              PRINT COLUMN 1,"\332",L10,L1,
               ...
               '\033015'
                PRINT
                    ...
                    COLUMN 070,"SB1",
                    COLUMN 074,"|",
		    COLUMN 075,reg_s1[i].reten   USING "#######&.&&",
                    COLUMN 089,"|",
                    COLUMN 090,reg_s1[i].bruto   USING "#######&.&&",
                    COLUMN 104,"|",
                    COLUMN 106,reg_s1[i].a_pagar USING "#######&.&&",
                    COLUMN 119,"|",
                    COLUMN 120,reg_s1[i].r97     USING "#######&.&&",
                    COLUMN 134,"|",
                    COLUMN 135,reg_s1[i].cv      USING "#######&.&&",
                    COLUMN 149,"|",
                    COLUMN 150,reg_s1[i].cs      USING "#######&.&&",
                    COLUMN 165,"|",
                    COLUMN 166,reg_s1[i].viv97   USING "#######&.&&",
                    COLUMN 181,"|",
                    COLUMN 182,reg_s1[i].viv92   USING "#######&.&&",
                    COLUMN 197,"|",
                    COLUMN 198,reg_s1[i].r92     USING "#######&.&&",
                    COLUMN 213,"|",
                    COLUMN 214,reg_s1[i].viv72   USING "#######&.&&",
                    COLUMN 229,"|",
		    COLUMN 230,reg_s1[i].rcv     USING "#######&.&&",
                    COLUMN 245,"|",
            '\033015'
            ...
            '\033015'
                ...
                PRINT
                    ...
                    COLUMN 070,"SB2",
                    COLUMN 074,"|",
	            COLUMN 075,reg_s2[i].reten   USING "#######&.&&",
                    COLUMN 089,"|",
                    COLUMN 090,reg_s2[i].bruto   USING "#######&.&&",
                    COLUMN 104,"|",
                    COLUMN 106,reg_s2[i].a_pagar USING "#######&.&&",
                    COLUMN 119,"|",
                    COLUMN 120,reg_s2[i].r97     USING "#######&.&&",
                    COLUMN 134,"|",
                    COLUMN 135,reg_s2[i].cv      USING "#######&.&&",
                    COLUMN 149,"|",
                    COLUMN 150,reg_s2[i].cs      USING "#######&.&&",
                    COLUMN 165,"|",
                    COLUMN 166,reg_s2[i].viv97   USING "#######&.&&",
                    COLUMN 181,"|",
                    COLUMN 182,reg_s2[i].viv92   USING "#######&.&&",
                    COLUMN 197,"|",
                    COLUMN 198,reg_s2[i].r92     USING "#######&.&&",
                    COLUMN 213,"|",
                    COLUMN 214,reg_s2[i].viv72   USING "#######&.&&",
                    COLUMN 229,"|",
	            COLUMN 230,reg_s2[i].rcv     USING "#######&.&&",
                    COLUMN 245,"|",
            '\033015'
              ...
              PRINT COLUMN 1,"\332",L10,L1,
               ...
               '\033015'
                ...
                PRINT
                    ...
                    COLUMN 070,"SB3",
                    COLUMN 074,"|",
	            COLUMN 075,reg_s3[i].reten   USING "#######&.&&",
                    COLUMN 089,"|",
                    COLUMN 090,reg_s3[i].bruto   USING "#######&.&&",
                    COLUMN 104,"|",
                    COLUMN 106,reg_s3[i].a_pagar USING "#######&.&&",
                    COLUMN 119,"|",
                    COLUMN 120,reg_s3[i].r97     USING "#######&.&&",
                    COLUMN 134,"|",
                    COLUMN 135,reg_s3[i].cv      USING "#######&.&&",
                    COLUMN 149,"|",
                    COLUMN 150,reg_s3[i].cs      USING "#######&.&&",
                    COLUMN 165,"|",
                    COLUMN 166,reg_s3[i].viv97   USING "#######&.&&",
                    COLUMN 181,"|",
                    COLUMN 182,reg_s3[i].viv92   USING "#######&.&&",
                    COLUMN 197,"|",
                    COLUMN 198,reg_s3[i].r92     USING "#######&.&&",
                    COLUMN 213,"|",
                    COLUMN 214,reg_s3[i].viv72   USING "#######&.&&",
                    COLUMN 229,"|",
	            COLUMN 230,reg_s3[i].rcv     USING "#######&.&&",
                    COLUMN 245,"|",
            '\033015'
              ...
              PRINT COLUMN 1,"\332",L10,L1,
               ...
               '\033015'
                ...
                PRINT
                    ...
                    COLUMN 070,"SB4",
                    COLUMN 074,"|",
	            COLUMN 075,reg_s4[i].reten   USING "#######&.&&",
                    COLUMN 089,"|",
                    COLUMN 090,reg_s4[i].bruto   USING "#######&.&&",
                    COLUMN 104,"|",
                    COLUMN 106,reg_s4[i].a_pagar USING "#######&.&&",
                    COLUMN 119,"|",
                    COLUMN 120,reg_s4[i].r97     USING "#######&.&&",
                    COLUMN 134,"|",
                    COLUMN 135,reg_s4[i].cv      USING "#######&.&&",
                    COLUMN 149,"|",
                    COLUMN 150,reg_s4[i].cs      USING "#######&.&&",
                    COLUMN 165,"|",
                    COLUMN 166,reg_s4[i].viv97   USING "#######&.&&",
                    COLUMN 181,"|",
                    COLUMN 182,reg_s4[i].viv92   USING "#######&.&&",
                    COLUMN 197,"|",
                    COLUMN 198,reg_s4[i].r92     USING "#######&.&&",
                    COLUMN 213,"|",
                    COLUMN 214,reg_s4[i].viv72   USING "#######&.&&",
                    COLUMN 229,"|",
	            COLUMN 230,reg_s4[i].rcv     USING "#######&.&&",
                    COLUMN 245,"|",
            '\033015'
              ...
              PRINT COLUMN 1,"\332",L10,L1,
               ...
               '\033015'
                ...
                PRINT
                    ...
                    COLUMN 070,"SB5",
                    COLUMN 074,"|",
	            COLUMN 075,reg_s5[i].reten   USING "#######&.&&",
                    COLUMN 089,"|",
                    COLUMN 090,reg_s5[i].bruto   USING "#######&.&&",
                    COLUMN 104,"|",
                    COLUMN 106,reg_s5[i].a_pagar USING "#######&.&&",
                    COLUMN 119,"|",
                    COLUMN 120,reg_s5[i].r97     USING "#######&.&&",
                    COLUMN 134,"|",
                    COLUMN 135,reg_s5[i].cv      USING "#######&.&&",
                    COLUMN 149,"|",
                    COLUMN 150,reg_s5[i].cs      USING "#######&.&&",
                    COLUMN 165,"|",
                    COLUMN 166,reg_s5[i].viv97   USING "#######&.&&",
                    COLUMN 181,"|",
                    COLUMN 182,reg_s5[i].viv92   USING "#######&.&&",
                    COLUMN 197,"|",
                    COLUMN 198,reg_s5[i].r92     USING "#######&.&&",
                    COLUMN 213,"|",
                    COLUMN 214,reg_s5[i].viv72   USING "#######&.&&",
                    COLUMN 229,"|",
	            COLUMN 230,reg_s5[i].rcv     USING "#######&.&&",
                    COLUMN 245,"|",
            '\033015'
      ...
      --------------------------------------------------
           IF reg_s1[8].tot > 0 THEN
            ...
            PRINT
                 ...
                 COLUMN 070,"SB1",
                 COLUMN 074,"|",
	         COLUMN 075,reg_s1[8].reten   USING "#######&.&&",
                 COLUMN 089,"|",
                 COLUMN 090,reg_s1[8].bruto   USING "#######&.&&",
                 COLUMN 104,"|",
                 COLUMN 106,reg_s1[8].a_pagar USING "#######&.&&",
                 COLUMN 119,"|",
                 COLUMN 120,reg_s1[8].r97     USING "#######&.&&",
                 COLUMN 134,"|",
                 COLUMN 135,reg_s1[8].cv      USING "#######&.&&",
                 COLUMN 149,"|",
                 COLUMN 150,reg_s1[8].cs      USING "#######&.&&",
                 COLUMN 165,"|",
                 COLUMN 166,reg_s1[8].viv97   USING "#######&.&&",
                 COLUMN 181,"|",
                 COLUMN 182,reg_s1[8].viv92   USING "#######&.&&",
                 COLUMN 197,"|",
                 COLUMN 198,reg_s1[8].r92     USING "#######&.&&",
                 COLUMN 213,"|",
                 COLUMN 214,reg_s1[8].viv72   USING "#######&.&&",
                 COLUMN 229,"|",
	         COLUMN 230,reg_s1[8].rcv     USING "#######&.&&",
                 COLUMN 245,"|",
            '\033015'
        ...
        IF reg_s2[8].tot > 0 THEN
            ...
            PRINT
                 ...
                 COLUMN 070,"SB2",
                 COLUMN 074,"|",
	         COLUMN 075,reg_s2[8].reten   USING "#######&.&&",
                 COLUMN 089,"|",
                 COLUMN 090,reg_s2[8].bruto   USING "#######&.&&",
                 COLUMN 104,"|",
                 COLUMN 106,reg_s2[8].a_pagar USING "#######&.&&",
                 COLUMN 119,"|",
                 COLUMN 120,reg_s2[8].r97     USING "#######&.&&",
                 COLUMN 134,"|",
                 COLUMN 135,reg_s2[8].cv      USING "#######&.&&",
                 COLUMN 149,"|",
                 COLUMN 150,reg_s2[8].cs      USING "#######&.&&",
                 COLUMN 165,"|",
                 COLUMN 166,reg_s2[8].viv97   USING "#######&.&&",
                 COLUMN 181,"|",
                 COLUMN 182,reg_s2[8].viv92   USING "#######&.&&",
                 COLUMN 197,"|",
                 COLUMN 198,reg_s2[8].r92     USING "#######&.&&",
                 COLUMN 213,"|",
                 COLUMN 214,reg_s2[8].viv72   USING "#######&.&&",
                 COLUMN 229,"|",
	         COLUMN 230,reg_s2[8].rcv     USING "#######&.&&",
                 COLUMN 245,"|",
            '\033015'
        ...
        IF reg_s3[8].tot > 0 THEN
            ...
            PRINT
                 ...
                 COLUMN 070,"SB3",
                 COLUMN 074,"|",
	         COLUMN 075,reg_s3[8].reten   USING "#######&.&&",
                 COLUMN 089,"|",
                 COLUMN 090,reg_s3[8].bruto   USING "#######&.&&",
                 COLUMN 104,"|",
                 COLUMN 106,reg_s3[8].a_pagar USING "#######&.&&",
                 COLUMN 119,"|",
                 COLUMN 120,reg_s3[8].r97     USING "#######&.&&",
                 COLUMN 134,"|",
                 COLUMN 135,reg_s3[8].cv      USING "#######&.&&",
                 COLUMN 149,"|",
                 COLUMN 150,reg_s3[8].cs      USING "#######&.&&",
                 COLUMN 165,"|",
                 COLUMN 166,reg_s3[8].viv97   USING "#######&.&&",
                 COLUMN 181,"|",
                 COLUMN 182,reg_s3[8].viv92   USING "#######&.&&",
                 COLUMN 197,"|",
                 COLUMN 198,reg_s3[8].r92     USING "#######&.&&",
                 COLUMN 213,"|",
                 COLUMN 214,reg_s3[8].viv72   USING "#######&.&&",
                 COLUMN 229,"|",
	         COLUMN 230,reg_s3[8].rcv     USING "#######&.&&",
                 COLUMN 245,"|",
            '\033015'
        ...
        IF reg_s4[8].tot > 0 THEN
            ...
            PRINT
                 ...
                 COLUMN 070,"SB4",
                 COLUMN 074,"|",
	         COLUMN 075,reg_s4[8].reten   USING "#######&.&&",
                 COLUMN 089,"|",
                 COLUMN 090,reg_s4[8].bruto   USING "#######&.&&",
                 COLUMN 104,"|",
                 COLUMN 106,reg_s4[8].a_pagar USING "#######&.&&",
                 COLUMN 119,"|",
                 COLUMN 120,reg_s4[8].r97     USING "#######&.&&",
                 COLUMN 134,"|",
                 COLUMN 135,reg_s4[8].cv      USING "#######&.&&",
                 COLUMN 149,"|",
                 COLUMN 150,reg_s4[8].cs      USING "#######&.&&",
                 COLUMN 165,"|",
                 COLUMN 166,reg_s4[8].viv97   USING "#######&.&&",
                 COLUMN 181,"|",
                 COLUMN 182,reg_s4[8].viv92   USING "#######&.&&",
                 COLUMN 197,"|",
                 COLUMN 198,reg_s4[8].r92     USING "#######&.&&",
                 COLUMN 213,"|",
                 COLUMN 214,reg_s4[8].viv72   USING "#######&.&&",
                 COLUMN 229,"|",
	         COLUMN 230,reg_s4[8].rcv     USING "#######&.&&",
                 COLUMN 245,"|",
            '\033015'
        ...
        IF reg_s5[8].tot > 0 THEN
            ...
            PRINT
                 ...
                 COLUMN 070,"SB5",
                 COLUMN 074,"|",
	         COLUMN 075,reg_s5[8].reten   USING "#######&.&&",
                 COLUMN 089,"|",
                 COLUMN 090,reg_s5[8].bruto   USING "#######&.&&",
                 COLUMN 104,"|",
                 COLUMN 106,reg_s5[8].a_pagar USING "#######&.&&",
                 COLUMN 119,"|",
                 COLUMN 120,reg_s5[8].r97     USING "#######&.&&",
                 COLUMN 134,"|",
                 COLUMN 135,reg_s5[8].cv      USING "#######&.&&",
                 COLUMN 149,"|",
                 COLUMN 150,reg_s5[8].cs      USING "#######&.&&",
                 COLUMN 165,"|",
                 COLUMN 166,reg_s5[8].viv97   USING "#######&.&&",
                 COLUMN 181,"|",
                 COLUMN 182,reg_s5[8].viv92   USING "#######&.&&",
                 COLUMN 197,"|",
                 COLUMN 198,reg_s5[8].r92     USING "#######&.&&",
                 COLUMN 213,"|",
                 COLUMN 214,reg_s5[8].viv72   USING "#######&.&&",
                 COLUMN 229,"|",
	         COLUMN 230,reg_s5[8].rcv     USING "#######&.&&",
                 COLUMN 245,"|",
            '\033015'
        ...
        PRINT 
            ...
            COLUMN 166,reg_s1[8].viv97 +
                       ...
                       reg_s3[8].viv97 +
                       reg_s4[8].viv97 +
                       reg_s5[8].viv97    USING "#######&.&&",
            COLUMN 181,"|",
            COLUMN 182,reg_s1[8].viv92 +
                       reg_s2[8].viv92 +
                       reg_s3[8].viv92 +
                       reg_s4[8].viv92 +
                       reg_s5[8].viv92    USING "#######&.&&",
            COLUMN 197,"|",
            COLUMN 213,"|",
