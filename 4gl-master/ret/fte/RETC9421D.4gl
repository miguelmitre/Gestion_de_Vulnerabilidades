...
# Owner              => E.F.P.                                                  #
# Programa RETC9421D => REVERZO DE LA PRELIQUIDACION DE TRANSFERENCIA ISSSTE    #
...
FUNCTION init()
    ...
    LET gr_bitacora.programa      = "RETC9421D"
    LET gr_bitacora.desc_tramite  = "PRELIQ DISPOSICION ISSSTE"
...
FUNCTION f_captura_folio()
    ...
    DEFINE folio_preliq LIKE ret_sol_issste_tx.folio
    ...
    OPEN WINDOW main_rev AT 4,4 WITH FORM "RETC9421D1" ATTRIBUTE(BORDER) 
    DISPLAY " <CTRL-C> Salir                                             <ESC> Ejecutar " AT 1,1 ATTRIBUTE(REVERSE)
    DISPLAY " RETC9421D   REVERSO DE PRELIQUIDACION DE DISPOSICION ISSSTE               " AT 3,1 ATTRIBUTE(REVERSE)
