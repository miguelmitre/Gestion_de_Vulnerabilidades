...
# Owner              => E.F.P.                                                  #
# Programa RETC9621  => REVERZO DE LA GENERACION DE LA OP. 43                   #
...
FUNCTION init()
    ...
    LET gr_bitacora.programa      = "RETC9621"
    LET gr_bitacora.desc_tramite  = "GENERA OP43 TRANSF ISSSTE"
...
FUNCTION f_captura_folio()
    ...
    OPEN WINDOW main_rev AT 4,4 WITH FORM "RETC96211" ATTRIBUTE(BORDER) 
    DISPLAY " <CTRL-C> Salir                                             <ESC> Ejecutar " AT 1,1 ATTRIBUTE(REVERSE)
    DISPLAY " RETC9621 REVERSO DE GENERACION DE OP.43 TRANSFERENCIAS ISSSTE             " AT 3,1 ATTRIBUTE(REVERSE)
