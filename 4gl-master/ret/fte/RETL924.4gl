...
#Programa RETL924  => REPORTE DE PRELIQUIACION TRANSFERENCIAS ISSSTE (PESOS)   #
...
MAIN
    ...
    CALL STARTLOG("RETL924.log")
    CALL init()

    OPEN WINDOW RETL9241 AT 4,4 WITH FORM "RETL9241" ATTRIBUTE (BORDER)
    DISPLAY "                                < Ctrl-C >                                       " AT 1,1 ATTRIBUTE(REVERSE)
    DISPLAY " RETL924   REPORTE PRELIQUIDACION DE TRANSFERENCIAS DE RECURSOS ISSSTE PESOS   " AT 3,1 ATTRIBUTE (REVERSE)
...
FUNCTION init()
    ...
    LET gc_archivo = gr_seg_modulo.ruta_listados CLIPPED,
                     "/", gc_usuario CLIPPED,
                     ".RPT_LIQ_",HOY USING"DDMMYYYY",".924"
END FUNCTION
################################################################################
FUNCTION primer_paso()
   ...
   FOREACH cur_liq INTO  gr_transf.nss            ,
      ...
      LET gr_transf.pesos_neto       = 0
      LET gr_transf.pesos_ret08      = 0
      LET gr_transf.pesos_cv_cs      = 0
      LET gr_transf.pesos_ahorro_sol = 0
      LET gr_transf.pesos_fov08      = 0
      LET gr_transf.pesos_rcv        = 0
      ...
      FOREACH cur_montos USING gr_transf.nss        ,
         ...
         CASE
         	  WHEN lr_montos.subcuenta = 30
         	  	 LET gr_transf.pesos_ret08 = gr_transf.pesos_ret08 + lr_montos.pesos
         	  WHEN lr_montos.subcuenta = 31 OR
         	  	   lr_montos.subcuenta = 32
         	  	 LET gr_transf.pesos_cv_cs = gr_transf.pesos_cv_cs + lr_montos.pesos
         	  WHEN lr_montos.subcuenta = 33 OR
         	  	   lr_montos.subcuenta = 34
         	  	 LET gr_transf.pesos_ahorro_sol = gr_transf.pesos_ahorro_sol + lr_montos.pesos
         	  WHEN lr_montos.subcuenta = 35
         	  	 LET gr_transf.pesos_fov08 = gr_transf.pesos_fov08 + lr_montos.pesos
         END CASE
      END FOREACH

      #Neto
      LET gr_transf.pesos_neto  = gr_transf.pesos_ret08     +
                                  gr_transf.pesos_cv_cs     +
                                  gr_transf.pesos_ahorro_sol+
                                  gr_transf.pesos_fov08

      #RCV
      LET gr_transf.pesos_rcv = gr_transf.pesos_ret08      +
                                gr_transf.pesos_cv_cs
   ...
   OUTPUT
    ...
    FIRST PAGE HEADER
      ...
      END FOR
       ...
       PRINT COLUMN 001, "PROGRAMA            :RETL924",
    ...
    ON EVERY ROW
      PRINT COLUMN 002, lr_rpt.nss                             ,
            ...
            COLUMN 059, lr_rpt.pesos_neto            USING "############&.&&",
            COLUMN 076, lr_rpt.pesos_ret08           USING "############&.&&",
            COLUMN 093, lr_rpt.pesos_cv_cs           USING "############&.&&",
            COLUMN 110, lr_rpt.pesos_ahorro_sol      USING "############&.&&",
            COLUMN 127, lr_rpt.pesos_fov08           USING "############&.&&",
            COLUMN 144, lr_rpt.pesos_rcv             USING "############&.&&",
    ...
    AFTER GROUP OF lr_rpt.tipo_retiro
    	...
    	FOR li_siefore = 1 TO 5
            ...
            PRINT COLUMN 001, "|", lar_total_retiro[li_cont].lar_total_siefore[li_siefore].nss_tot  USING "##########&",
                  ...
                  COLUMN 058, "|", lar_total_retiro[li_cont].lar_total_siefore[li_siefore].pesos_neto           USING "############&.&&",
                  COLUMN 075, "|", lar_total_retiro[li_cont].lar_total_siefore[li_siefore].pesos_ret08          USING "############&.&&",
                  COLUMN 092, "|", lar_total_retiro[li_cont].lar_total_siefore[li_siefore].pesos_cv_cs          USING "############&.&&",
                  COLUMN 109, "|", lar_total_retiro[li_cont].lar_total_siefore[li_siefore].pesos_ahorro_sol     USING "############&.&&",
                  COLUMN 126, "|",
                  COLUMN 143, "|", lar_total_retiro[li_cont].lar_total_siefore[li_siefore].pesos_rcv            USING "############&.&&",
                  COLUMN 160, "|",
                  COLUMN 185, "|",
                  '\033015'
      ...
      IF lar_gran_total_retiro[li_cont].nss_tot > 0 THEN
         ...
         PRINT COLUMN 001, "|     TOTAL DE NSS UNICOS POR TIPO DE RETIRO ", lar_gran_total_retiro[li_cont].tipo_retiro,
               ...
               COLUMN 075, "|",
               COLUMN 126, "|", lar_gran_total_retiro[li_cont].pesos_fov08           USING "############&.&&",
               COLUMN 143, "|",
               COLUMN 185, "|",
               '\033015'
    ...
    ON LAST ROW
       ...
       FOR li_siefore = 1 TO 5
             ...
             PRINT COLUMN 001, "|", lar_gran_total_siefore[li_siefore].nss_tot  USING "##########&",
                   ...
                   COLUMN 055, "|S", li_siefore USING "&",
                   COLUMN 058, "|", lar_gran_total_siefore[li_siefore].pesos_neto       USING "############&.&&",
                   COLUMN 075, "|", lar_gran_total_siefore[li_siefore].pesos_ret08      USING "############&.&&",
                   COLUMN 092, "|", lar_gran_total_siefore[li_siefore].pesos_cv_cs      USING "############&.&&",
                   COLUMN 109, "|", lar_gran_total_siefore[li_siefore].pesos_ahorro_sol USING "############&.&&",
                   COLUMN 126, "|",
                   COLUMN 143, "|", lar_gran_total_siefore[li_siefore].pesos_rcv        USING "############&.&&",
                   COLUMN 160, "|",
                   COLUMN 185, "|",
                   '\033015'
       ...
       PRINT COLUMN 001, "|     TOTAL DE NSS UNICOS",
             ...
             COLUMN 075, "|",
             COLUMN 126, "|", lr_total_gral.pesos_fov08           USING "############&.&&",
             COLUMN 143, "|",
             COLUMN 185, "|",
             '\033015'
