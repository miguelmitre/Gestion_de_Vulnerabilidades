...
# Owner             => E.F.P.                                                   #
# Programa RETC8131 => REVERZAR LA LIQUIDACION DE TRANSFERENCIA TIPO RETIRO "B" #
# Fecha creacion    => 01 DE ABRIL DE 2008                                      #
...
MAIN
    ...
    OPEN WINDOW f81511 AT 2,2 WITH FORM "RETC81511" ATTRIBUTE(BORDER) 
    DISPLAY "   < Ctrl-C > Salir                                        RETIRO 'B'       " AT 1,1 ATTRIBUTE(REVERSE)
    DISPLAY " RETC8151    REVERSO DE LIQUIDACION DE TRANSFERENCIAS DEVOLUCION AL G.F.    " AT 3,1 ATTRIBUTE(REVERSE)
...
#i-------------
    ...
    LET gr_bitacora.programa      = "RETC8151"
    LET gr_bitacora.desc_tramite  = "LIQUIDACION RETIRO B"
...
FUNCTION reversa_liquidacion(p_folio)
    ...
    WHERE  folio           = p_folio
    AND    tipo_oper_recep = v_tipo_retiro

    LET v_cont_des = SQLCA.sqlerrd[3]
    
    DISPLAY "R. ELIMINADOS EN ret_seguimiento   : ", v_cont_des
            USING "<<<,<<&" AT 11,10

    LET gar_tablas_rev[2].tabla     = "ret_seguimiento"
