...
#Owner             => E.F.P.                                                    #
#Programa RETC815  => LIQUIDACION DE CV - RETIRO B                              #
#                     (DEVOLUCION AL GOBIERNO FEDERAL LEY 73)                   #
#Fecha creacion    => 06 DE FEBRERO DEL 2004                                    #
#By                => DMR                                                       #
...
FUNCTION f_abre_ventana()
    ...
    OPEN WINDOW retc8151 AT 4,4 WITH FORM "RETC8151" ATTRIBUTE(BORDER)
    DISPLAY "   < Ctrl-C > Salir                                        RETIRO 'B'       " AT 1,1 ATTRIBUTE(REVERSE)
    DISPLAY " RETC815   GENERA LIQUIDACION DE MONTOS DE DEVOLUCION (LEY 73)              " AT 3,1 ATTRIBUTE(REVERSE)
