...
#Propietario       => E.F.P.                                                   #
#Programa RETC8051 => REVERSO GENERA NOTIFICACION DE DISPOSICION DE RECURSOS   #
#                     SOLICITUD OP.05 POR RETIROS TOTAL POR NEGATIVA DE PENSION#
...
MAIN
    ...
    CALL init() #i
    OPEN WINDOW retc80511 AT 4,4 WITH FORM "RETC80511" ATTRIBUTE(BORDER)
    DISPLAY " <Ctrl-C> Salir                                              TIPO RETIRO D     " AT 1,1 ATTRIBUTE(REVERSE)
    DISPLAY " RETC8051 REVERSO NOTIFICA Y PROVISIONA DISPOSICION DE RECURSOS                " AT 3,1 ATTRIBUTE(REVERSE)
    ...
    INPUT BY NAME vfolio_oper05 WITHOUT DEFAULTS
        ...
        AFTER FIELD vfolio_oper05
            ...
            FOREACH cur_1 INTO vtipo_movimiento
                ...
                IF vtipo_movimiento = 820
                OR vtipo_movimiento = 10 THEN
                    # EL FOLIO ES UNICO PARA RETIRO D
                ELSE
                    ERROR "    ERROR...FOLIO NO UNICO PARA TIPO RETIRO D "
                    ATTRIBUTE(NORMAL)
                    NEXT FIELD vfolio_oper05
                END IF
            END FOREACH
