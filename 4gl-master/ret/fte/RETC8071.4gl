...
#Propietario       => E.F.P.                                                   #
#Programa RETC8071 => REVERSO INCORPORA PAGO DE RCV Y VIV (RETIRO TOTAL)       #
...
MAIN
    ...
    CALL init() #i
    OPEN WINDOW retc80711 AT 4,4 WITH FORM "RETC80711" ATTRIBUTE(BORDER)
    DISPLAY " <Ctrl-C> Salir                                              TIPO RETIRO D     " AT 1,1 ATTRIBUTE(REVERSE)
    DISPLAY " RETC8071      REVERSO INCORPORA PAGO DISPOSICION DE RECURSOS                  " AT 3,1 ATTRIBUTE(REVERSE)
