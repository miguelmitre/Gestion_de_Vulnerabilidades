################################################################################
#Owner             => E.F.P.                                                   #
#Programa CAPACITA => PREPARA AMBIENTE PARA CAPACITACION DE RETIRO             #
#Fecha creacion    => 18 DE ENERO DEL 2001                                     #
#By                => FRANCO ESTEBAN ULLOA VIDELA                              #
#Fecha actualiz.   => 14 DE NOVIEMBRE DEL 2002                                 #
#Actualizacion     => FRANCO ESTEBAN ULLOA VIDELA                              #
#Fecha actualiza   => 20 DE AGOSTO DEL 2004                                    #
#Sistema           => RET                                                      #
################################################################################
DATABASE safre_af
GLOBALS
...
MAIN
    ...
    OPEN WINDOW capacita1 AT 2,2 WITH FORM "CAPACITA21" ATTRIBUTE(BORDER)
    DISPLAY " CAPACITA2         AMBIENTE PARA CAPACITACION - RETIROS                        " AT 3,1 ATTRIBUTE(REVERSE)
...
#rp-------------------
    ...
    DELETE FROM glo_valor_accion
     WHERE ( fecha_valuacion = TODAY OR fecha_valuacion = "01/01/0001" )
...
#trH-------------------
    ...
    DELETE
    FROM   afi_mae_siefore
    WHERE  n_seguro = "06613704490";

    LOAD FROM "afi_mae_sieforeH.unl" INSERT INTO afi_mae_siefore
    ...
    --LOAD FROM "ret_estadoH.unl" INSERT INTO ret_estado
    ...
    --LOAD FROM "cta_his_marcaH.unl" INSERT INTO cta_his_marca 
    --LOAD FROM "cta_act_marcaH.unl" INSERT INTO cta_act_marca
    ...
    DELETE
    FROM   ret_solicitud_tx
    WHERE  nss        IN("06613704490")
    AND    tipo_retiro = "H";
    }

    --LOAD FROM "ret_solicitud_txH.unl" INSERT INTO ret_solicitud_tx
...
#trD-------------------
    ...
    DELETE
    FROM   ret_consecutivo
    WHERE  consecutivo = 23;

    LOAD FROM "ret_consecutivoD.unl" INSERT INTO ret_consecutivo 
    ...
    DELETE
    FROM   ret_solicitud_tx
    WHERE  nss        IN("21633714445")
    AND    tipo_retiro = "D";

    --LOAD FROM "ret_solicitud_txD.unl" INSERT INTO ret_solicitud_tx
