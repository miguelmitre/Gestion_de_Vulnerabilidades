...
# Owner              => E.F.P.                                                  #
# Programa RETC9421P => REVERZO DE LA PRELIQUIDACION DE RETIROS PARCIALES ISSSTE#
# Fecha creacion     => 6 DE NOVIEMBRE DE 2009                                  #
...
FUNCTION init()
    ...
    LET gr_bitacora.programa      = "RETC9421P"
    LET gr_bitacora.desc_tramite  = "PRELIQ RET PAR ISSSTE"
...
FUNCTION f_captura_folio()
    ...
    DEFINE folio_preliq LIKE ret_parcial_issste.folio
    ...
    OPEN WINDOW main_rev AT 4,4 WITH FORM "RETC9421P1" ATTRIBUTE(BORDER) 
    DISPLAY " <CTRL-C> Salir                                             <ESC> Ejecutar " AT 1,1 ATTRIBUTE(REVERSE)
    DISPLAY " RETC9421P   REVERSO DE PRELIQUIDACION DE RET PARCIAL ISSSTE               " AT 3,1 ATTRIBUTE(REVERSE)
