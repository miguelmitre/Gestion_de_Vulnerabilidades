...
# Owner              => E.F.P.                                                  #
# Programa RETC9431P => REVERZAR LA LIQUIDACION DE RETIROS PARCIALES ISSSTE     #
...
FUNCTION init()
    ...
    LET gr_bitacora.programa      = "RETC9431P"
    LET gr_bitacora.desc_tramite  = "LIQ RET PARCIAL ISSSTE"
...
FUNCTION f_captura_folio()
    ...
    DEFINE folio_liq LIKE ret_parcial_issste.folio
    ...
    OPEN WINDOW main_rev AT 4,4 WITH FORM "RETC9431P1" ATTRIBUTE(BORDER) 
    DISPLAY " <CTRL-C> Salir                                             <ESC> Ejecutar " AT 1,1 ATTRIBUTE(REVERSE)
    DISPLAY " RETC9431P     REVERSO DE LIQUIDACION DE RET PARCIAL ISSSTE                " AT 3,1 ATTRIBUTE(REVERSE)
...
FUNCTION f_reverso(pi_folio)
    ...
    LET gar_tablas_rev[2].tabla     = "ret_ctr_envio"
    ...
    LET gar_tablas_rev[4].tabla     = "ret_parcial_issste"
