...
#                     SOLICITUD OP.05 POR RETIRO "M"                           #
#Fecha creacion    => 27 DE DICIEMBRE DE 2007                                  #
...
MAIN
    ...
    CALL init() #i
    OPEN WINDOW retc83411 AT 4,4 WITH FORM "RETC83411" ATTRIBUTE(BORDER)
    DISPLAY " <Ctrl-C> Salir                                              TIPO RETIRO M     " AT 1,1 ATTRIBUTE(REVERSE)
    DISPLAY " RETC8341 REVERSO NOTIFICA Y PROVISIONA DISPOSICION DE RECURSOS                " AT 3,1 ATTRIBUTE(REVERSE)
