...
#Propietario       => E.F.P.                                              #
#Programa RETL804  => Reporte de Liquidacion de transferencia de Recursos #
#                     (en pesos)                                          #
...
#c-----------------
    ...
    OPEN WINDOW ventana_21 AT 10,4 WITH FORM "RETL8041" ATTRIBUTE( BORDER)
    DISPLAY "RETL804                     (Ctrl-C) Salir             (ESC) Ejecutar         " AT 1,1 ATTRIBUTE(REVERSE,green)
...
DEFINE l_record RECORD
 ...
 OUTPUT
    ...
    FORMAT
      ...
      PRINT COLUMN 1,"|           |                                | TIPO | TIPO  | TIPO |                     MONTOS TRANSFERIDOS DE LA CUENTA INDIVIDUAL ( EN PESOS )                                                 |"
          --  '\033015'
      ...
      PRINT COLUMN 1,"|           |                                |      |       |      |    |               |               |               |               |               |                 |             |         |"
          --  '\033015'
      PRINT COLUMN 1,"|           |                                |SEGURO|PENSION|PRESTA| SB |     PESOS     |     PESOS     |     PESOS     |     PESOS     |     PESOS     |  DE  PENSION    |             |         |"
           -- '\033015'
    ...
    -------------------------------
        ...
        LET lr_montos.total = GROUP SUM(l_record.monto_en_pesos)
        ...
        IF l_record.siefore = 1 THEN
           ...
           LET reg_s1[4].total      = reg_s1[4].total    +   
                                      lr_montos.r97      +
                                      lr_montos.cv       +
                                      lr_montos.cs  
        ...
        ELSE
         IF l_record.siefore = 2 THEN
           ...
           LET reg_s2[4].total      = reg_s2[4].total    +   
                                      lr_montos.r97      +
                                      lr_montos.cv       +
                                      lr_montos.cs  
         ...
         ELSE
          IF l_record.siefore = 3 THEN
             ...
             LET reg_s3[4].total      = reg_s3[4].total    +   
                                        lr_montos.r97      +
                                        lr_montos.cv       +
                                        lr_montos.cs  
          ...
          ELSE
           IF l_record.siefore = 4 THEN
             ...
             LET reg_s4[4].total      = reg_s4[4].total    +   
                                        lr_montos.r97      +
                                        lr_montos.cv       +
                                        lr_montos.cs  
           ...
           ELSE
            IF l_record.siefore = 5 THEN
             ...
             LET reg_s5[4].total      = reg_s5[4].total    +   
                                        lr_montos.r97      +
                                        lr_montos.cv       +
                                        lr_montos.cs  
    ...
    IF reg_s1[ind].tot > 0 THEN
        ...
        PRINT COLUMN 1,"\332",L10,L1,
		 ...
		 COLUMN 074,reg_s1[ind].total   USING "#######&.&&",
                 ...
                 COLUMN 137,"|",
                 COLUMN 140,reg_s1[ind].viv97   USING "#######&.&&",
                 COLUMN 153,"|"
            --'\033015'
    ...
    IF reg_s2[ind].tot > 0 THEN
        ...
        PRINT COLUMN 1,"\332",L10,L1,
		 ...
		 COLUMN 074,reg_s2[ind].total   USING "#######&.&&",
                 ...
                 COLUMN 137,"|",
                 COLUMN 140,reg_s2[ind].viv97   USING "#######&.&&",
                 COLUMN 153,"|"
           -- '\033015'
    ...
    IF reg_s3[ind].tot > 0 THEN
        ...
        PRINT COLUMN 1,"\332",L10,L1,
		 ...
		 COLUMN 074,reg_s3[ind].total   USING "#######&.&&",
                 ...
                 COLUMN 137,"|",
                 COLUMN 140,reg_s3[ind].viv97   USING "#######&.&&",
                 COLUMN 153,"|"
            --'\033015'
    ...
    IF reg_s4[ind].tot > 0 THEN
        ...
        PRINT COLUMN 1,"\332",L10,L1,
		 ...
		 COLUMN 074,reg_s4[ind].total   USING "#######&.&&",
                 ...
                 COLUMN 137,"|",
                 COLUMN 140,reg_s4[ind].viv97   USING "#######&.&&",
                 COLUMN 153,"|"
            --'\033015'
    ...
    IF reg_s5[ind].tot > 0 THEN
        ...
        PRINT COLUMN 1,"\332",L10,L1,
		 ...
		 COLUMN 074,reg_s5[ind].total   USING "#######&.&&",
                 ...
                 COLUMN 137,"|",
                 COLUMN 140,reg_s5[ind].viv97   USING "#######&.&&",
                 COLUMN 153,"|"
           -- '\033015'
   ...
   --------------
       ...
       FOR i = 1 TO 3
		 ...
		 COLUMN 074,reg_s1[i].total   USING "#######&.&&",
                 ...
                 COLUMN 137,"|",
                 COLUMN 140,reg_s1[i].viv97   USING "#######&.&&",
                 COLUMN 153,"|"
            --'\033015'
    ...
    IF reg_s2[i].tot > 0 THEN
		 ...
		 COLUMN 074,reg_s2[i].total   USING "#######&.&&",
                 ...
                 COLUMN 137,"|",
                 COLUMN 140,reg_s2[i].viv97   USING "#######&.&&",
                 COLUMN 153,"|"
            --'\033015'
    ...
    IF reg_s3[i].tot > 0 THEN
		 ...
		 COLUMN 074,reg_s3[i].total   USING "#######&.&&",
                 ...
                 COLUMN 137,"|",
                 COLUMN 140,reg_s3[i].viv97   USING "#######&.&&",
                 COLUMN 153,"|"
            --'\033015'
    ...
    IF reg_s4[i].tot > 0 THEN
		 ...
		 COLUMN 074,reg_s4[i].total   USING "#######&.&&",
                 ...
                 COLUMN 137,"|",
                 COLUMN 140,reg_s4[i].viv97   USING "#######&.&&",
                 COLUMN 153,"|"
            --'\033015'
    ...
    IF reg_s5[i].tot > 0 THEN
		 ...
		 COLUMN 074,reg_s5[i].total   USING "#######&.&&",
                 ...
                 COLUMN 137,"|",
                 COLUMN 140,reg_s5[i].viv97   USING "#######&.&&",
                 COLUMN 153,"|"
            --'\033015'
      ...
      --------------------------------------------------
        ...
        PRINT
               ...
               COLUMN 137,"|",
               COLUMN 140,reg_s1[4].viv97   USING "#######&.&&",
               COLUMN 153,"|"
            --'\033015'
       ...
       PRINT COLUMN 001,"|",reg_s2[4].tot   USING "#######"        ,
             ...
             COLUMN 137,"|",
             COLUMN 140,reg_s2[4].viv97   USING "#######&.&&",
             COLUMN 153,"|"
            --'\033015'
       ...
       PRINT COLUMN 001,"|",reg_s3[4].tot   USING "#######"        ,
             ...
             COLUMN 137,"|",
             COLUMN 140,reg_s3[4].viv97   USING "#######&.&&",
             COLUMN 153,"|"
            --'\033015'
       ...
       PRINT COLUMN 001,"|",reg_s4[4].tot   USING "#######"        ,
             ...
             COLUMN 137,"|",
             COLUMN 140,reg_s4[4].viv97   USING "#######&.&&",
             COLUMN 153,"|"
            --'\033015'
       ...
       PRINT COLUMN 001,"|",reg_s5[4].tot   USING "#######"        ,
             ...
             COLUMN 137,"|",
             COLUMN 140,reg_s5[4].viv97   USING "#######&.&&",
             COLUMN 153,"|"
            --'\033015'
