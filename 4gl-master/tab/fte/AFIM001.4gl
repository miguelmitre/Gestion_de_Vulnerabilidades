...
--                ERROR "Tipo Solic. solo puede ser 1)Registro 2)Traspaso 8) Independientes"
            IF (r_afi.tipo_solicitud = 1   OR
                ...
                r_afi.tipo_solicitud = 12) THEN 
            ELSE
               ERROR "Tipo Solic. solo puede ser 1)Reg 2)Trasp",
                     "3)Uni 6-7)Sep 8)No Afi 10)Act y 11-12)Reg Int"
                LET r_afi.tipo_solicitud = NULL
                DISPLAY BY NAME r_afi.tipo_solicitud
                NEXT FIELD tipo_solicitud
            END IF
            ...
            IF r_afi.tipo_solicitud = 1 OR
               r_afi.tipo_solicitud = 2 THEN
                ...
                IF SQLCA.SQLCODE = 0 THEN
                    DISPLAY r_afi.desc_solicitud
                ELSE
                    ERROR "Tipo Solic. solo puede ser 1)Registro 2)Trasp"
                    LET r_afi.tipo_solicitud = NULL
                    NEXT FIELD tipo_solicitud
                END IF
            ELSE
            ...
            IF r_afi.tipo_solicitud = 1 OR
               r_afi.tipo_solicitud = 2 THEN
                ...
                IF SQLCA.SQLCODE = 0 THEN
                    DISPLAY r_afi.desc_solicitud
                ELSE
                    ERROR "Tipo Solic. solo puede ser 1)Registro 2)Trasp 8) Indep"
                    LET r_afi.tipo_solicitud = NULL
                    NEXT FIELD tipo_solicitud
                END IF
            END IF
