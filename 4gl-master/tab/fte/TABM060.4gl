...
#Propietario       => E.F.P.                                              #
#Programa TABM060  => CATALOGO DE CONSULTA DE MARCAS ACTIVAS              #
...
GLOBALS
   ...
   DEFINE l_record2   ARRAY[400] OF RECORD
          ...
          estado        LIKE cta_his_marca.estado_marca,
   ...
   DEFINE g_repor  RECORD
          ...
          estado2               LIKE cta_his_marca.estado_marca,
...
FUNCTION proceso()
   LET HOY=today
   OPEN WINDOW ventana_1 AT 3,3 WITH FORM "TABM0601" ATTRIBUTE( BORDER)
   DISPLAY " TABM060                    MARCAS ACTIVAS                                                     " AT 3,1 ATTRIBUTE(REVERSE)
...
#c-----------------
   ...
   CONSTRUCT cla_where ON nss FROM nss
      ON KEY (control-m)
         LET int_flag = FALSE     
         EXIT CONSTRUCT
      ON KEY (control-c)
   ...
   LET sel_where = "SELECT nss,marca_cod,fecha_ini,hora_ini,estado_marca,marca_causa,fecha_causa FROM cta_act_marca WHERE ",
   ...
   IF (pos-1) >= 1 THEN
      ...
      DISPLAY ARRAY l_record TO scr_1.*
         ON KEY (control-p)
              ...
              LET g_marca.estado_marca  = l_record[pos].estado
              ...
              LET g_repor.estado        = l_record[pos].estado
...
FUNCTION Historico()
   LET banderac = 0
   LET banderah = 0
   OPEN WINDOW ventana_2 AT 10,3 WITH FORM "TABM0602" ATTRIBUTE (BORDER)
...
#----------------------
   ...
   START REPORT rpt_marca_activa TO g_impre
      ...
      FOR i=1 TO (pos+1)
          ...
          LET g_repor.estado2       = l_record2[i].estado
