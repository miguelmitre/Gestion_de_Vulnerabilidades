################################################################################
#Owner             => E.F.P.
#Programa ESTB063  => ANEXO 64 ( Este Archivo contiene la Informacion de los 
...
#pp-------------------------
    ...
    OPEN WINDOW ESTB063  AT 4,4 WITH FORM "ESTB0631" ATTRIBUTE(BORDER)
    DISPLAY "                               <Ctrl-c> Salir                              " AT 1,1 ATTRIBUTE(REVERSE)

    DISPLAY " ESTB063                    ANEXO 64  PARA CONSAR                               " AT 3,1 ATTRIBUTE(REVERSE)
...
LET lanza_proceso = "nohup fglgo ESTB064 ","'",fecha_gen,"'"    
