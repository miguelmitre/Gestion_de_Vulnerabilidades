################################################################################
#Owner             => E.F.P.
#Programa ESTB098  => ANEXO 64 ( Este Archivo contiene la Informacion de los 
#                     movimientos diarios que se realizan en los procesos 
#                     Operativos de las Administradoras ).  
#Fecha de Creacion => 28 Septiembre del 2009.
#                     --VERSION ESPECIAL-- 
...
#pp-------------------------
    ...
    OPEN WINDOW ESTB098  AT 4,4 WITH FORM "ESTB0981" ATTRIBUTE(BORDER)
    DISPLAY "                               <Ctrl-c> Salir                              " AT 1,1 ATTRIBUTE(REVERSE)

    DISPLAY " ESTB098                    ANEXO 64  PARA CONSAR                               " AT 3,1 ATTRIBUTE(REVERSE)
...
LET lanza_proceso = "nohup fglgo ESTB099 ","'",fecha_gen,"'"    
