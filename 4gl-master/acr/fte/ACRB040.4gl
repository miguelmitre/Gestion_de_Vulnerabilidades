...
#Propietario       => E.F.P.                                               #
#Programa ACRB040  => CONSULTA NSS CREDITOS EN GARANTIA                    #
#Fecha             => 10 DE OCTUBRE DE 2001                                #
#Autor             => MAURO MUNIZ CABALLERO                                #
#Sistema           => ACR                                                  #
#Modificacion      => Cambio de tabla en la busqueda (acr_det_tra_cred).   #
#                     Copia del programa ACR009.			   #
#Fecha Mod.        => 23 - Enero - 2003					   #
############################################################################
...
#pp-------------------------
    ...
    OPEN WINDOW ventana_1 AT 3,2 WITH FORM "ACRB0401" ATTRIBUTE( BORDER)

    DISPLAY " ACRB040         CONSULTA   CREDITOS   EN   GARANTIA                           " AT 3,1 ATTRIBUTE(REVERSE)

    DISPLAY HOY USING "DD-MM-YYYY" AT 3,67 ATTRIBUTE(REVERSE)

    MENU " CREDITOS EN GARANTIA "
        COMMAND "Consulta" " Consulta Creditos en Garantia"
            CALL Consulta()
...
#C-----------------
    ...
    DISPLAY "       NSS     FECHA SOLICITUD                              ESTADO SOLICITUD   " AT 5,1 ATTRIBUTE(REVERSE)
    ...
    FOREACH cursor_c INTO reg[pos].nss_afore THRU reg[pos].estado
        IF reg[pos].estado = 0 OR
           reg[pos].estado = 1 THEN
            LET reg[pos].desc_estado = 'ENVIADA'
        ELSE
