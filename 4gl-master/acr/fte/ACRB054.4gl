...
#Propietario       => E.F.P.                                               #
#Programa ACRB054  => CONSULTA TRANSFERENCIA POR ANUALIDAES GARANTIZADAS   #
...
#pp-------------------------
    ...
    OPEN WINDOW v1 AT 3,2 WITH FORM "ACRB0541" ATTRIBUTE( BORDER)

    DISPLAY "ACRB054     CONSULTA TRANSFERENCIA POR ANUALIDADES GARANTIZADAS                 " AT 3,1 ATTRIBUTE(REVERSE)                                               

    DISPLAY HOY USING "DD-MM-YYYY" AT 3,67 ATTRIBUTE(REVERSE)

    MENU " TRANSFERENCIA POR ANUALIDADES GARANTIZADAS "
