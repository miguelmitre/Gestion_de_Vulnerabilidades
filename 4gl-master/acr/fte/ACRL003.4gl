...
#pp-------------------------
    ...
    DISPLAY " ACRL003 " AT 3,1 ATTRIBUTE(REVERSE)
...
#c-----------------
    ...
    OPEN WINDOW ventana_21 AT 10,4 WITH FORM "ACRL0032" ATTRIBUTE( BORDER)
    ...
    IF (pos-1) >= 1 THEN
       ...
       ERROR ""
       OPEN WINDOW ventana_2 AT 6,4 WITH FORM "ACRL0031" ATTRIBUTE( BORDER)
       ...
       DISPLAY " ACRL003      Consulta de Provision Devolucion excedentes                         " AT 3,1 ATTRIBUTE(REVERSE,green) 
...
#a----------------
    ...
    LET G_LISTA = g_param_dis.ruta_listados CLIPPED,"/",g_usuario CLIPPED,
                  ".PROV_DEV_", HOY USING "DDMMYY","_",hora CLIPPED
...
REPORT rpt_cuenta_arc(g)
    ...
    FORMAT
      PAGE HEADER
        PRINT COLUMN 20,"LISTADO DE PROVISION DEVOLUCION SALDOS EXCEDENTES"
        PRINT COLUMN  2,"FOL.",
              COLUMN  7,"MOV.",
              COLUMN 12, "SUB.",
              COLUMN 17, "FEC.VAL.",
...
REPORT rpt_cuenta_imp(g)
    ...
    FORMAT
      PAGE HEADER
        PRINT COLUMN 2,"ACRL003",
              COLUMN 20,"LISTADO DE PROVISION DEVOLUCION DE EXCEDENTES ",
