...
#Propietario       => E.F.P.                                                #
#Programa ACRB007  => LIQUIDACION DEVOLUCION SALDOS ACREDITADOS             #
...
#Modificacion      => DMR 28/Ene/2014 STARTLOG personalizado, se modifico la#
#                  => pantalla previa de montos a liquidar que cuadren con  #
#                  => lo liquidado CPL-1495                                 #
#############################################################################
DATABASE safre_af
...
MAIN
   ...
   CALL STARTLOG(FGL_GETENV("USER")||".ACRB007.log")
...
#i---------------
   ...
   DISPLAY " ACRB007     LIQUIDACION DEVOLUCION SALDOS ACREDITADOS                         " AT 3,1 ATTRIBUTE(REVERSE)
   DISPLAY HOY USING "dd/mm/yyyy" AT 3,67 ATTRIBUTE(REVERSE)

   MENU "LIQUIDA"
      COMMAND "Liquidar" "Liquidacion de devolucion de saldos (acreditados)"
         CALL liquida()
...
#l----------------
   ...
   INPUT BY NAME tipo,cuatro,fecha1,fecha2
      ...
      AFTER FIELD tipo
         ...
         DISPLAY tipo_desc CLIPPED AT 5,43 ATTRIBUTE(REVERSE)
...
--      DISPLAY g_sal[i].* TO scr_liquida[i].*    #CPL-1495
   END FOR
...
#rc-------------------------------
   ...
   SELECT  n_seguro,partic_v97,partic_v92
