...
#Propietario       => E.F.P.                                               #
#Programa ACRB058  => CONSULTA NSS DEVOL DE SALDOS POR ANUALIDAES GARANT   #
...
#pp-------------------------
    ...
    OPEN WINDOW ventana_1 AT 3,2 WITH FORM "ACRB0581" ATTRIBUTE( BORDER)

    DISPLAY " ACRB058  CONSULTA DEVOLUCION SALDOS POR ANUALIDADES GARANTIZADAS               " AT 3,1 ATTRIBUTE(REVERSE)

    DISPLAY HOY USING "DD-MM-YYYY" AT 3,67 ATTRIBUTE(REVERSE)

    MENU " DEVOLUCION DE SALDOS ANUALIDADES GARANTIZADAS"
