...
GLOBALS
   ...
   DEFINE l_reg RECORD LIKE acr_interes_trasp.*
...
#di-------------------------
   ...
   DEFINE 
      l_reg RECORD LIKE acr_interes_trasp.*,
      l_cta RECORD
         nss	       CHAR(11),
	 subcuenta     SMALLINT,
   ...
   FOREACH cursor_ant1 INTO g_pend1.*
      ...
      WHILE TRUE
         ...
         INSERT INTO acr_interes_trasp VALUES (l_reg.*)
