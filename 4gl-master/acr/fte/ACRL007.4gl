...
#pp-------------------------
    ...
    DISPLAY " ACRL007 " AT 3,1 ATTRIBUTE(REVERSE)
...
#c-----------------
    ...
    OPEN WINDOW ventana_21 AT 10,4 WITH FORM "ACRL0072" ATTRIBUTE( BORDER)
    ...
    IF (pos-1) >= 1 THEN
       ...
       ERROR ""
       OPEN WINDOW ventana_2 AT 6,4 WITH FORM "ACRL0071" ATTRIBUTE( BORDER)
       ...
       DISPLAY " ACRL007   Consulta Provision Devolucion Saldos Cred 43bis                     " AT 3,1 ATTRIBUTE(REVERSE,green) 
...
#a----------------
    ...
    LET G_LISTA = g_param_dis.ruta_listados CLIPPED,"/",g_usuario CLIPPED,
                  ".PROV_DEV_CRED_", HOY USING "DDMMYY","_",hora CLIPPED
...
FUNCTION cuentas_archi()
    ...
    LET G_LISTA = "chmod 777 ",g_param_dis.ruta_listados CLIPPED,
                           "/",g_usuario CLIPPED,".PROV_DEV_CRED_",
...
REPORT rpt_cuenta_arc(g)
    ...
    FORMAT
      PAGE HEADER
        PRINT COLUMN 20,"LISTADO DE PROVISION DEVOLUCION SALDOS PAGOS CRED"
        PRINT COLUMN  2,"FOL.",
              COLUMN  7,"MOV.",
              COLUMN 12, "SUB.",
              COLUMN 17, "FEC.VAL.",
...
FUNCTION imprimir()
    ...
    LET G_IMPRE = g_param_dis.ruta_listados CLIPPED,"/",g_usuario CLIPPED,
             ".LIS_PROV_DEV_CRED_",HOY USING "DDMMYY","_",hora CLIPPED
...
REPORT rpt_cuenta_imp(g)
    ...
    FORMAT
      PAGE HEADER
        PRINT COLUMN 2,"ACRL007",
              COLUMN 20,"LISTADO DE PROVISION DEVOLUCION DE PAGOS CRED ",
              COLUMN 65, TODAY USING "mm/dd/yyyy"
        SKIP 2 LINE
        PRINT COLUMN  2,"FOLIO",
              COLUMN  7,"MOVIMIENTO",
              COLUMN 12, "SUBCUENTA",
              COLUMN 17, "FECHA VALOR",
              COLUMN 30, "MONTO EN PESOS",
