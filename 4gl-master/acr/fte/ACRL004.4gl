...
#pp-------------------------
    ...
    DISPLAY " ACRL004 " AT 3,1 ATTRIBUTE(REVERSE)
...
#c-----------------
    ...
    OPEN WINDOW ventana_21 AT 10,4 WITH FORM "ACRL0042" ATTRIBUTE( BORDER)
    ...
    IF (pos-1) >= 1 THEN
      ...
      ERROR ""
      OPEN WINDOW ventana_2 AT 6,4 WITH FORM "ACRL0041" ATTRIBUTE( BORDER)
      ...
      DISPLAY "ACRL004       Consulta de Liquidacion devolucion excedentes              " AT 3,1 ATTRIBUTE(REVERSE,green)
...
FUNCTION archivo()
    ...
    LET G_LISTA = g_param_dis.ruta_listados CLIPPED,"/",g_usuario CLIPPED,
                    ".LIQ_DEV_", HOY USING "DDMMYY","_",hora CLIPPED
...
REPORT rpt_cuenta_arc(g)
    ...
    FORMAT
      PAGE HEADER
        PRINT COLUMN 30,"LISTADO DE LIQUIDACION DEVOLUCION EXCEDENTES  "
        PRINT COLUMN  2,"FOL.",
              COLUMN  7, "SUB",
              COLUMN 12, "MOV",
              COLUMN 17, "FEC.CONV.",
...
#imp---------------
    ...
    LET G_IMPRE = g_param_dis.ruta_listados CLIPPED,"/",g_usuario CLIPPED,
                  ".LIQ_DEV_ACR.",HOY USING "DDMMYY", "_",hora CLIPPED
...
#rci--------------------
    ...
    PAGE HEADER
       ...
       PRINT COLUMN 2,"ACRL004",
             COLUMN 30,"LISTADO DE LIQUIDACION DEVOLUCION DE SALDOS EXCEDENTES",
