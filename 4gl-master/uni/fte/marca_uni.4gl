...
FUNCTION control_cuenta(vfolio_09)
   ...
   AND    estado       = vrecibido_09
   AND    nss_cta1 NOT IN (SELECT nss
                              FROM   cta_act_marca
                              WHERE  marca_cod IN (vintra_cta1_09,vextra_cta1_09))
   ...
   FOREACH cur_2 INTO nss_ctau_09,
      ...
      DISPLAY "nss        : ", nss_ctau_09
      DISPLAY "marca_entra: ", vmarca_ent_09
