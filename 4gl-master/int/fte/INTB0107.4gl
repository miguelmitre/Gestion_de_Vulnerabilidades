...
#Propietario       => E.F.P.                                        #
#Programa          => INTB0107 Y INTB01009                          #
#Descripcion       => NOTIFICACION DE CONSTANCIA DE REGISTRO ASIGNA-#
#                  => CION.                                         #
#Sistema           => INT .                                         #
...
##   DEFER INTERRUPT       
    CALL STARTLOG(FGL_GETENV("USER")||".INTB0107.log")    
    ...
    OPEN WINDOW INTB0107 AT 2,2 WITH FORM "INTB01071" ATTRIBUTE(BORDER)
         DISPLAY " < ESC > Procesar                                          < Ctrl-C > Salir    " AT 1,1 ATTRIBUTE(REVERSE)
                                                                                
         DISPLAY " INTB0107          CONSTANCIA DE REG.EN ADMON. ASIGNACION                      "
...
{                             " a.paterno, a.materno, a.nombres,        ",
             ...
             LET selec_tab = selec_tab CLIPPED, 
			     " WHERE a.fentcons = b.fecha_registro ",
                             ...
                             " AND   b.docto_cod = 30202           ",
                             " AND   b.edo_genera = 10             ",
                             " AND a.tipo_solicitud = 1     ",
                             " AND a.finitmte IS NOT NULL   ",
            ...
            END IF
{
             ...
             LET v_arch = v_ruta CLIPPED,"/", "30202",
                          f_arch CLIPPED, hora1 CLIPPED,
                          ".",   v_arch
             ...
             LET leyenda_cza = "CONSTANCIA DE REGISTRO EN ADMINISTRADORA DE ",
                               "FONDOS PARA EL RETIRO, ORIGEN ASIGNACION"

             START REPORT r_report TO v_det
             CALL detalle_notifica91("02",407,2)

             START REPORT r_report TO v_cza
             CALL cabeza_notifica9("02",leyenda_cza,407,1)
