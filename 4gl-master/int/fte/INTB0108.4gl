...
##   DEFER INTERRUPT       
   CALL STARTLOG(FGL_GETENV("USER")||".INTB0108.log")    
...
let ban = 0
    ...
    OPEN WINDOW INTB0108 AT 2,2 WITH FORM "INTB01061" ATTRIBUTE(BORDER)
         ...
         CONSTRUCT inter_noti ON   fecha_mov_banxico, n_seguro
         ...
         IF ban  = 0 THEN
             LET selec_tab1= " SELECT a.fecha_mov_banxico, a.cve_ced_cuenta,",
                             ...
                             " a.importe_bono, a.fecha_red_bono, a.folio ",  #1261 Se agrega a.folio
             ...
             LET selec_tab1= selec_tab1 CLIPPED,
                             ...
                             " AND  c.edo_genera = 10               ",
                             " AND  b.tipo_solicitud IN(1,2,3,4,6,7)        ",
                             " AND  a.tipo_traspaso IN('20','25','51','83','84','85') ",
