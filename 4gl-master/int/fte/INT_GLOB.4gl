...
# Modifica: CPL-1643 fusión de Afirme con Profuturo GNP FSR
#--------------------------------------------------------------------
#
DATABASE safre_af 
  GLOBALS
...
FUNCTION llena_comision()
  DEFINE   cat       RECORD
   ...
   IF cuantos < cuantos2 THEN #CPL-1686 FIN (ANTES FIJO 11)
...
FUNCTION llena_comision_tras(vfecha_mov_banxico, vnss)
  ...
  DEFINE   cat       RECORD
           ...
           llena_com   RECORD
               ...
               rendim_afo_a,  rendim_afo_b,
               rendim_afo_c,  rendim_afo_d,
               rendim_afo_e,  rendim_afo_f,
               rendim_afo_g,  rendim_afo_h,
               rendim_afo_i,  rendim_afo_j,
               rendim_afo_k,  rendim_afo_l,
               rendim_afo_m,  rendim_afo_n,
               rendim_afo_o,  rendim_afo_p,
               rendim_afo_q,  rendim_afo_r,
               rendim_afo_s,  rendim_afo_t,
               rendim_afo_u,  rendim_afo_v,
               rendim_afo_w,  rendim_afo_x,
               rendim_afo_y,  rendim_afo_z    CHAR(06),
               ...
               rendim_neto_a,  rendim_neto_b,
               rendim_neto_c,  rendim_neto_d,
               rendim_neto_e,  rendim_neto_f,
               rendim_neto_g,  rendim_neto_h,
               rendim_neto_i,  rendim_neto_j,
               rendim_neto_k,  rendim_neto_l,
               rendim_neto_m,  rendim_neto_n,
               rendim_neto_o,  rendim_neto_p,
               rendim_neto_q,  rendim_neto_r,
               rendim_neto_s,  rendim_neto_t,
               rendim_neto_u,  rendim_neto_v,
               rendim_neto_w,  rendim_neto_x,
               rendim_neto_y,  rendim_neto_z    CHAR(06)
   ...
   SELECT COUNT(*) 
    ...
    WHERE vfecha_mov_banxico BETWEEN a.fecha_ini AND a.fecha_fin
   ...
   FOREACH apt_comis_trasp INTO cat.*
      ...
      LET comision    = cat.comis_afo USING "##&.&&","%"
      LET rendim_afo  = cat.rendim_afo  USING "#&.&&","%"
      LET rendim_neto = cat.rendim_neto USING "#&.&&","%"


      CASE j
           WHEN 1  LET llena_com.afore_a       = afore
                   LET llena_com.rendim_afo_a  = rendim_afo
                   LET llena_com.comis_a       = comision
                   LET llena_com.rendim_neto_a = rendim_neto
           WHEN 2  LET llena_com.afore_b       = afore
                   LET llena_com.rendim_afo_b  = rendim_afo
                   LET llena_com.comis_b       = comision
                   LET llena_com.rendim_neto_b = rendim_neto
           WHEN 3  LET llena_com.afore_c       = afore
                   LET llena_com.rendim_afo_c  = rendim_afo
                   LET llena_com.comis_c       = comision
                   LET llena_com.rendim_neto_c = rendim_neto
           WHEN 4  LET llena_com.afore_d       = afore
                   LET llena_com.rendim_afo_d  = rendim_afo
                   LET llena_com.comis_d       = comision
                   LET llena_com.rendim_neto_d = rendim_neto
           WHEN 5  LET llena_com.afore_e       = afore
                   LET llena_com.rendim_afo_e  = rendim_afo
                   LET llena_com.comis_e       = comision
                   LET llena_com.rendim_neto_e = rendim_neto
           WHEN 6  LET llena_com.afore_f       = afore
                   LET llena_com.rendim_afo_f  = rendim_afo
                   LET llena_com.comis_f       = comision
                   LET llena_com.rendim_neto_f = rendim_neto
           WHEN 7  LET llena_com.afore_g       = afore
                   LET llena_com.rendim_afo_g  = rendim_afo
                   LET llena_com.comis_g       = comision
                   LET llena_com.rendim_neto_g = rendim_neto
           WHEN 8  LET llena_com.afore_h       = afore
                   LET llena_com.rendim_afo_h  = rendim_afo
                   LET llena_com.comis_h       = comision
                   LET llena_com.rendim_neto_h = rendim_neto
           WHEN 9  LET llena_com.afore_i       = afore
                   LET llena_com.rendim_afo_i  = rendim_afo
                   LET llena_com.comis_i       = comision
                   LET llena_com.rendim_neto_i = rendim_neto
           WHEN 10 LET llena_com.afore_j       = afore
                   LET llena_com.rendim_afo_j  = rendim_afo
                   LET llena_com.comis_j       = comision
                   LET llena_com.rendim_neto_j = rendim_neto
           WHEN 11 LET llena_com.afore_k       = afore
                   LET llena_com.rendim_afo_k  = rendim_afo
                   LET llena_com.comis_k       = comision
                   LET llena_com.rendim_neto_k = rendim_neto
           WHEN 12 LET llena_com.afore_l       = afore
                   LET llena_com.rendim_afo_l  = rendim_afo
                   LET llena_com.comis_l       = comision
                   LET llena_com.rendim_neto_l = rendim_neto
           WHEN 13 LET llena_com.afore_m       = afore
                   LET llena_com.rendim_afo_m  = rendim_afo
                   LET llena_com.comis_m       = comision
                   LET llena_com.rendim_neto_m = rendim_neto
           WHEN 14 LET llena_com.afore_n       = afore
                   LET llena_com.rendim_afo_n  = rendim_afo
                   LET llena_com.comis_n       = comision
                   LET llena_com.rendim_neto_n = rendim_neto
           WHEN 15 LET llena_com.afore_o       = afore
                   LET llena_com.rendim_afo_o  = rendim_afo
                   LET llena_com.comis_o       = comision
                   LET llena_com.rendim_neto_o = rendim_neto
           WHEN 16 LET llena_com.afore_p       = afore
                   LET llena_com.rendim_afo_p  = rendim_afo
                   LET llena_com.comis_p       = comision
                   LET llena_com.rendim_neto_p = rendim_neto
           WHEN 17 LET llena_com.afore_q       = afore
                   LET llena_com.rendim_afo_q  = rendim_afo
                   LET llena_com.comis_q       = comision
                   LET llena_com.rendim_neto_q = rendim_neto
           WHEN 18 LET llena_com.afore_r       = afore
                   LET llena_com.rendim_afo_r  = rendim_afo
                   LET llena_com.comis_r       = comision
                   LET llena_com.rendim_neto_r = rendim_neto
           WHEN 19 LET llena_com.afore_s       = afore
                   LET llena_com.rendim_afo_s  = rendim_afo
                   LET llena_com.comis_s       = comision
                   LET llena_com.rendim_neto_s = rendim_neto
           WHEN 20 LET llena_com.afore_t       = afore
                   LET llena_com.rendim_afo_t  = rendim_afo
                   LET llena_com.comis_t       = comision
                   LET llena_com.rendim_neto_t = rendim_neto
           WHEN 21 LET llena_com.afore_u       = afore
                   LET llena_com.rendim_afo_u  = rendim_afo
                   LET llena_com.comis_u       = comision
                   LET llena_com.rendim_neto_u = rendim_neto
           WHEN 22 LET llena_com.afore_v       = afore
                   LET llena_com.rendim_afo_v  = rendim_afo
                   LET llena_com.comis_v       = comision
                   LET llena_com.rendim_neto_v = rendim_neto
           WHEN 23 LET llena_com.afore_w       = afore
                   LET llena_com.rendim_afo_w  = rendim_afo
                   LET llena_com.comis_w       = comision
                   LET llena_com.rendim_neto_w = rendim_neto
           WHEN 24 LET llena_com.afore_x       = afore
                   LET llena_com.rendim_afo_x  = rendim_afo
                   LET llena_com.comis_x       = comision
                   LET llena_com.rendim_neto_x = rendim_neto
           WHEN 25 LET llena_com.afore_y       = afore
                   LET llena_com.rendim_afo_y  = rendim_afo
                   LET llena_com.comis_y       = comision
                   LET llena_com.rendim_neto_y = rendim_neto
           WHEN 26 LET llena_com.afore_z       = afore
                   LET llena_com.rendim_afo_z  = rendim_afo
                   LET llena_com.comis_z       = comision
                   LET llena_com.rendim_neto_z = rendim_neto
      END CASE
   ...
   IF llena_com.afore_p IS NULL THEN
       LET llena_com.afore_p       = "                    "
       LET llena_com.rendim_afo_p  = "      "
       LET llena_com.comis_p       = "       "
       LET llena_com.rendim_neto_p = "      "
   END IF

   IF llena_com.afore_q IS NULL THEN
       LET llena_com.afore_q       = "                    " 
       LET llena_com.rendim_afo_q  = "      "
       LET llena_com.comis_q       = "       "
       LET llena_com.rendim_neto_q = "      "
   END IF

   IF llena_com.afore_r IS NULL THEN
       LET llena_com.afore_r       = "                    " 
       LET llena_com.rendim_afo_r  = "      "
       LET llena_com.comis_r       = "       "
       LET llena_com.rendim_neto_r = "      "
   END IF

   IF llena_com.afore_s IS NULL THEN
       LET llena_com.afore_s       = "                    " 
       LET llena_com.rendim_afo_s  = "      "
       LET llena_com.comis_s       = "       "
       LET llena_com.rendim_neto_s = "      "
   END IF

   IF llena_com.afore_t IS NULL THEN
       LET llena_com.afore_t       = "                    " 
       LET llena_com.rendim_afo_t  = "      "
       LET llena_com.comis_t       = "       "
       LET llena_com.rendim_neto_t = "      "
   END IF

   IF llena_com.afore_u IS NULL THEN
       LET llena_com.afore_u       = "                    " 
       LET llena_com.rendim_afo_u  = "      "
       LET llena_com.comis_u       = "       "
       LET llena_com.rendim_neto_u = "      "
   END IF

   IF llena_com.afore_v IS NULL THEN
       LET llena_com.afore_v       = "                    " 
       LET llena_com.rendim_afo_v  = "      "
       LET llena_com.comis_v       = "       "
       LET llena_com.rendim_neto_v = "     " 
   END IF

   IF llena_com.afore_w IS NULL THEN
       LET llena_com.afore_w       = "                    " 
       LET llena_com.rendim_afo_w  = "      "
       LET llena_com.comis_w       = "       "
       LET llena_com.rendim_neto_w = "      "
   END IF

   IF llena_com.afore_x IS NULL THEN
       LET llena_com.afore_x       = "                    " 
       LET llena_com.rendim_afo_x  = "      "
       LET llena_com.comis_x       = "       "
       LET llena_com.rendim_neto_x = "      "
   END IF

   IF llena_com.afore_y IS NULL THEN
       LET llena_com.afore_y       = "                    " 
       LET llena_com.rendim_afo_y  = "      "
       LET llena_com.comis_y       = "       "
       LET llena_com.rendim_neto_y = "      "
   END IF

   IF llena_com.afore_z IS NULL THEN
       LET llena_com.afore_z       = "                    " 
       LET llena_com.rendim_afo_z  = "      "
       LET llena_com.comis_z       = "       "
       LET llena_com.rendim_neto_z = "      "
   END IF
...
## cve_cur
   ...
   RETURN cve_cur
END FUNCTION
####################FUNCION DE DESCRIPCION DEL MES  ###############
FUNCTION descri_mes(mes)
  DEFINE mes   CHAR(2),
         des_mes CHAR(10)

  INITIALIZE des_mes TO NULL
  CASE mes
      WHEN "01" LET des_mes = "Enero     "
      WHEN "02" LET des_mes = "Febrero   "
      WHEN "03" LET des_mes = "Marzo     "
      WHEN "04" LET des_mes = "Abril     "
      WHEN "05" LET des_mes = "Mayo      "
      WHEN "06" LET des_mes = "Junio     "
      WHEN "07" LET des_mes = "Julio     "
      WHEN "08" LET des_mes = "Agosto    "
      WHEN "09" LET des_mes = "Septiembre"
      WHEN "10" LET des_mes = "Octubre   "
      WHEN "11" LET des_mes = "Noviembre "
      WHEN "12" LET des_mes = "Diciembre "
  END CASE
  RETURN des_mes
END FUNCTION
...
###################################################################
FUNCTION llena_comision_registro(vfecha_mov_banxico, vnss)
  DEFINE vfecha_mov_banxico DATE
  DEFINE vnss               CHAR(11)
  DEFINE   cat       RECORD
              afore_x      CHAR(03),
...
####################################################################
#FUNCION PARA CONSTANCIAS DE NO AFILIADOS (Valida que las comisiones
#                                          esten capturadas)
####################################################################
FUNCTION valida_comision_indepen()
  DEFINE   
    cat                       RECORD
      afore_x                 CHAR(03),
      comis_afo               DECIMAL(5,2)
   ...
   SELECT a.tipo_comparativo
   INTO   tipo_com
   FROM   tab_tipo_comparativo a
   WHERE  a.desc_tipo_comparativo MATCHES 'COMISIONES NO AFILIADOS'

   SELECT MAX(a.fecha) INTO max_fecha FROM tab_comparativo a
   WHERE  a.tipo_comparativo = tipo_com
   ...
   FROM   tab_comparativo a
   WHERE  a.fecha = max_fecha
   AND    a.tipo_comparativo = tipo_com
   #CPL-1686 INICIO
   SELECT tot_afore
   INTO cuantos2
   FROM tab_comp_afore
   ...
   IF cuantos < cuantos2 THEN #CPL-1686 FIN (ANTES FIJO 8)
      PROMPT "No estan completas las Afores en el Comparativo, NO AFIL <Enter>"
      FOR enter
      RETURN 1
   END IF
   ...
   IF cuantos < cuantos2 THEN #CPL-1686 FIN (ANTES FIJO 8)
      PROMPT "No estan completas las Afores en el Comparativo, ISSSTE BANXICO ",
             "<Enter> " FOR enter
      RETURN 1
   END IF
   ...
   IF cuantos < cuantos2 THEN #CPL-1686 FIN (ANTES FIJO 8)
      PROMPT "No estan completas las Afores en el Comparativo, ISSSTE ICEFA ",
             "<Enter> " FOR enter
      RETURN 1
   END IF
...
###################################################################
# FUNCION PARA CONSTANCIAS DE NO AFILIADOS 
###################################################################
FUNCTION llena_comision_no_afiliados(vfecha_mov_banxico, vnss)
  DEFINE vfecha_mov_banxico DATE
  DEFINE vnss               CHAR(11)
  DEFINE   
    cat                       RECORD
...
DEFINE DESPLIEGA CHAR(100)
   ...
   LET DESPLIEGA = "siefore ",vsiefore, "fecha  ", vfecha_mov_banxico, " ",
                  "cuantos ", cuantos
  ...
  --   PROMPT DESPLIEGA FOR enter 
   ...
   DECLARE apt_comis_noafil CURSOR FOR
      SELECT a.afore_cod, a.rendimiento, a.comision, a.rendimiento_neto
        FROM tab_rendimiento_neto a
       WHERE vfecha_mov_banxico BETWEEN a.fecha_ini AND a.fecha_fin
         AND a.siefore_cod = vsiefore
       ORDER BY a.rendimiento_neto DESC
   FOREACH apt_comis_noafil INTO cat.*
   ...
   IF llena_com.afore_h IS NULL THEN
      LET llena_com.afore_h = "                    "
      LET llena_com.rendim_afo_h  = "      "
      LET llena_com.comis_h = "       "
      LET llena_com.rendim_neto_h = "      "
   END IF
   
   IF llena_com.afore_i IS NULL THEN
      LET llena_com.afore_i = "                    "
      LET llena_com.rendim_afo_i  = "      "
      LET llena_com.comis_i = "       "
      LET llena_com.rendim_neto_i = "      "
   END IF
   
   IF llena_com.afore_j IS NULL THEN
      LET llena_com.afore_j = "                    "
      LET llena_com.rendim_afo_j  = "      "
      LET llena_com.comis_j = "       "
      LET llena_com.rendim_neto_j = "      "
   END IF
   
   IF llena_com.afore_k IS NULL THEN
      LET llena_com.afore_k = "                    "
      LET llena_com.rendim_afo_k  = "      "
      LET llena_com.comis_k = "       "
      LET llena_com.rendim_neto_k = "      "
   END IF
   
   IF llena_com.afore_l IS NULL THEN
      LET llena_com.afore_l = "                    "
      LET llena_com.rendim_afo_l  = "      "
      LET llena_com.comis_l = "       "
      LET llena_com.rendim_neto_l = "      "
   END IF
   
   IF llena_com.afore_m IS NULL THEN
      LET llena_com.afore_m = "                    "
      LET llena_com.rendim_afo_m  = "      "
      LET llena_com.comis_m = "       "
      LET llena_com.rendim_neto_m = "      "
   END IF
   
   IF llena_com.afore_n IS NULL THEN
      LET llena_com.afore_n = "                    "
      LET llena_com.rendim_afo_n  = "      "
      LET llena_com.comis_n = "       "
      LET llena_com.rendim_neto_n = "      "
   END IF
   
   IF llena_com.afore_o IS NULL THEN
      LET llena_com.afore_o = "                    "
      LET llena_com.rendim_afo_o  = "      "
      LET llena_com.comis_o = "       "
      LET llena_com.rendim_neto_o = "      "
   END IF
   IF llena_com.afore_p IS NULL THEN
      LET llena_com.afore_p = "                    "
      LET llena_com.rendim_afo_p  = "      "
