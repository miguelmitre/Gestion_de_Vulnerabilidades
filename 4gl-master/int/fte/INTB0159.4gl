...
#Propietario       => E.F.P.                                        #
#Programa          => INTB0159 Y INTB01009                          #
#Descripcion       => NOTIFICACION DE CONSTANCIA DE REGISTRO AFILIA-#
#                  => CION.                                         #
#Sistema           => INT .                                         #
#Fecha Elaboracion => 11 de abril del 2002   .                      #
#Elaborado por     => Laura Eugenia Cortes Guzman                   #
#Fecha Ult.Modif.  => 07 de Marzo del 2006.                         #
...
MAIN
   ...
   DEFER INTERRUPT       
     CALL STARTLOG(FGL_GETENV("USER")||".INTB0159.log")         
...
{    CALL llena_comision_registro() RETURNING gen_compara.*,ban
    ...
    IF reci <> "S" THEN
       OPEN WINDOW INTB0159 AT 2,2 WITH FORM "INTB01591" ATTRIBUTE(BORDER)
         DISPLAY " < ESC > Procesar                                          <",
                 " Ctrl-C > Salir    " AT 1,1 ATTRIBUTE(REVERSE)
                                                                                
            DISPLAY " INTB0159              CONSTANCIA DE NO AFILIACIO",
            ...
            IF ban  = 0 THEN
			 ...
			 fentcons1,"'",
                ...
                LET v_arch = v_ruta CLIPPED,"/", "30501",
                ...
                LET v_cza  = v_ruta CLIPPED,"/", v_cza  CLIPPED, "_", usuario CLIPPED #CPL-1686
{
                ...
                LET leyenda_cza = "CONSTANCIA DE REGISTRO DE NO AFILIADO"

                START REPORT r_report TO v_det
                CALL detalle_notifica9("01",458,2)

                START REPORT r_report TO v_cza
                CALL cabeza_notifica9("01",leyenda_cza,458,1)
