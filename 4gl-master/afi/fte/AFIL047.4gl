...
#p----------------
    ...
    OPEN WINDOW ventana1 AT 2,2 WITH FORM "AFIL0471" ATTRIBUTE(BORDER)

    DISPLAY " AFIL047               REPORTE CIFRAS AFILIADOS POR FECHA                      " AT 3,1 ATTRIBUTE(REVERSE)

    DISPLAY hoy USING "DD-MM-YYYY" AT 3,68 ATTRIBUTE(REVERSE)

    MENU "REP CIFRAS AFILIADOS"
...
FUNCTION Inicializa()
    ...
    LET salida = g_param.ruta_listados CLIPPED,"/",usuario CLIPPED,
                ".CIFRAS_AFI.", hoy USING "DDMMYY","_", hora1
...
FUNCTION Genera_consulta()
    ...
    CONSTRUCT cla_where ON a.fentcons, a.tipo_solicitud 
              	        FROM fentcons, tipo_solicitud
    ...
    LET cla_sel = " SELECT a.fentcons, ",
                  ...
                  " GROUP  BY 1,2,3,4,5 ",
                  " ORDER  BY a.tipo_solicitud, a.status_interno, a.fentcons "
    ...
    FOREACH cur_solicitud INTO g_reg.fentcons,
         ...
         LET arr1[i].numero         = i
         LET arr1[i].fentcons	    = g_reg.fentcons
    ...
    IF pantalla = 0 THEN
         ...
         LET g_eco = "echo ", nom_arch CLIPPED, " > ",
                  g_param.ruta_listados CLIPPED,"/rescate.CIFRAS_AFI.",
    ...
    ELSE
         ...
         OPEN WINDOW ventana2 AT 2,2 WITH FORM "AFIL0472" ATTRIBUTE(BORDER)

         DISPLAY "                        < Ctrl - P > Imprimir                                  " AT 3,4 ATTRIBUTE(BOLD)

         DISPLAY " AFIL047               REPORTE CIFRAS AFILIADOS POR FECHA                      " AT 4,1 ATTRIBUTE(REVERSE)
         ...
         IF (i - 1) >= 1 THEN
              ...
              ON KEY (Control-p)
                 ...
                 FOREACH cur_solic_rpt INTO g_reg.fentcons,
                                            g_reg.tipo_solicitud,
                                            g_reg.desc_solicitud,
                                            g_reg.status_interno,
                                            g_reg.estado_desc,
...
REPORT rep_solicitud(g_reg)
    ...
    PRINT COLUMN 33, "R E P O R T E     C I F R A S     D E    A F I L I A D O S"
    ...
    PRINT 
    PRINT COLUMN 9, "PROGRAMA : AFIL047"
