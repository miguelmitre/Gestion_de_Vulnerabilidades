...
-- Propietario  => E.F.P.                                                    --
-- Programa     => AFIL013                                                   --
-- Descripcion  => GENERA ARCHIVO PLANO DE CAPTURA DE SOLICITUDES            --
-- Sistema      => AFI                                                       --
...
GLOBALS
   ...
   DEFINE nom_arch CHAR(300)
   DEFINE g_eco    CHAR(300)
...
FUNCTION Inicializa()
   ...
   LET nom_arch = usuario CLIPPED, ".CAPT.", hoy USING "DDMMYY","_",
                hora1
...
FUNCTION Genera_consulta()
   OPEN WINDOW ventana1 AT 2,2 WITH FORM "AFIL0131" ATTRIBUTE(BORDER)

   DISPLAY " AFIL013                 GENERA ARCHIVO DE CAPTURA                             " AT 3,1 ATTRIBUTE(REVERSE)
   ...
   LET g_eco = "echo ", nom_arch CLIPPED, " > ",
               g_param.ruta_listados CLIPPED,"/rescate.CAPT.",
               hoy USING "DDMMYY","_",hora1
