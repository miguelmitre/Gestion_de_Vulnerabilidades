...
#Propietario       => E.F.P.                                              #
#Programa AFIC002  => CARGA DE ARCHIVO GENERADO POR OPERADORA BDNSAR      #
#Sistema           => AFI.                                                #
...
#Fecha             => 29 NOVIEMBRE 2004                                   #
#                  => EDUARDO RESENDIZ MEDINA                             #
#                  => 25 AGOSTO 2010 CIRCULAR UNICA                       #
###########################################################################
...
GLOBALS
    ...
    DEFINE reg_det RECORD
        ...
        ind_infonavit        CHAR(01)     ,          ---circ unica
        ...
        periodo              CHAR(06)     ,
        salario              DECIMAL(9,2) ,
        num_fol_edocta       CHAR(08)     ,           ---circ unica
        const_curp           CHAR(01)                 ---circ unica
    END RECORD 
...
#----------------
    ...
    WHENEVER ERROR CONTINUE
        DATABASE safre_tmp
        DROP TABLE safre_tmp:plano3

        CREATE TABLE safre_tmp:plano3
...
#pp-------------------------
    ...
    DISPLAY " AFIC002      CARGA ARCHIVO RESPUESTA CERTIF. (LIB. PEND.)                     " AT 3,1 ATTRIBUTE(REVERSE)
	...
	ELSE
        ...
        FOR i = 1 TO longitud
           IF g_reg.generar[i] = "." THEN
              LET i  = i + 1
	      LET i2 = i + 2
              IF g_reg.generar[i,i2] = 'lib' THEN
	...
	END FOR
        ...
        WHENEVER ERROR CONTINUE
            LOAD FROM carga INSERT INTO safre_tmp:plano3
        WHENEVER ERROR STOP

        SELECT COUNT(*)
        INTO   g_plano3
        FROM   safre_tmp:plano3

        IF g_plano3 IS NULL OR g_plano3 = 0 THEN
...
#ct-------------------
    ...
    WHENEVER ERROR CONTINUE
        DATABASE safre_tmp
        DROP TABLE encabezado3
        DROP TABLE detalle3
        DROP TABLE sumario3
    WHENEVER ERROR STOP

    CREATE TABLE encabezado3
        (campo1  CHAR(2),
         campo2  CHAR(2),
         campo3  CHAR(2),
         campo4  CHAR(2),
    ...
    CREATE TABLE detalle3
        (tipo_registro       CHAR(02)     ,
         ...
         clave_promotor      CHAR(10)     ,
         --fec_recp_sol_afore  CHAR(08)     ,
         fecha_elaboracion   CHAR(08)     ,        #fecha firma sol CIRC UNICA
         folio_solicitud     DECIMAL(16,0),
         sexo                SMALLINT     ,
         entidad_nacimiento  CHAR(02)     ,
         ind_uni_aut         CHAR(01)     , 
...
#-------------------------
    ...
    DEFINE
        ...
        campo_53  CHAR(06),
        campo_54  CHAR(07),
        campo_55  CHAR(08),                ---circ unica
        campo_56  CHAR(01),                ---circ unica
    ...
    FOREACH cursor_1 INTO carga_reg
        ...
        IF cont_reg = 1 THEN
            ...
            INSERT INTO safre_tmp:encabezado3
            VALUES (campo_011 ,
                    campo_012 ,
                    campo_013 ,
                    campo_014 ,
        ...
        IF cont_reg <> total_reg AND cont_reg <> 1 THEN
            ...
            LET campo_46 = carga_reg[517,517]              ---circ unica
            ...
            LET campo_55 = carga_reg[555,562]              ---circ unica
            LET campo_56 = carga_reg[563,563]              ---circ unica

        INSERT INTO safre_tmp:detalle3 
        VALUES (campo_01 ,
                campo_02 ,
                campo_03 ,
                campo_04 ,
        ...
        IF cont_reg = total_reg THEN
            ...
            INSERT INTO safre_tmp:sumario3 
            VALUES (campo_201 ,
                    campo_202 ,
                    campo_203 ,
                    campo_204 ,
...
--->erm 14 Marzo 2006
  ...
  LET G_IMPRE3 = g_paramgrales.ruta_listados  CLIPPED,"/",g_usuario CLIPPED,
                  ".REP_LIB_PEND." CLIPPED,
                  hoy USING "dd-mm-yy",".",hora CLIPPED

  START REPORT listado_3 TO G_IMPRE3

  OUTPUT TO REPORT listado_3(total_resp,aceptar)
...
REPORT listado_3(ltotal_resp, laceptar)    ---erm 13 Marzo 2006
  DEFINE
    cont_reg INTEGER,
    l_sol    CHAR(12),
    vtip_sol SMALLINT,
...
--    ON EVERY ROW
    ...
    ON LAST ROW
      ...
      SKIP 1 LINE
      PRINT 
        COLUMN 03,"Total Registros Certificados            : ",laceptar USING "#######&"
      SKIP 1 LINE
      PRINT
