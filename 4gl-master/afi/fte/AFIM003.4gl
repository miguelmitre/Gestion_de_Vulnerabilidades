...
#Propietario       => E.F.P.                                             #
#Programa AFIM003  => MANTENIMIENTO A TELEFONOS DE AFILIADOS             #
...
GLOBALS
    ...
    DEFINE g_afili RECORD 
        ...
        extension        INTEGER,
        hora_ini   DATETIME HOUR TO MINUTE,                 ---28-18 31072008
        tipo_hora_ini    CHAR(2),                ---28-18
        desc_tipo_hora_ini CHAR(2),              ---28-18
        hora_fin   DATETIME HOUR TO MINUTE,                 ---28-18 31072008
        tipo_hora_fin    CHAR(2),                ---28-18
        desc_tipo_hora_fin CHAR(2),              ---28-18
        dia              CHAR(1),                ---28-18
        desc_dia         CHAR(18)                ---28-18
    END RECORD
...
{
    display g_parametro1
    display g_parametro2
    display g_parametro3
    display g_parametro4
    sleep 5
...
#pp------------------------
    ...
    DISPLAY " AFIM003        MANTENIMIENTO SOLICITUDES DE AFILIACION                        " AT 3,1 ATTRIBUTE(REVERSE)
...
#Dtd--------------------------
    ...
    OPEN WINDOW vent_1 AT 05,12 WITH FORM "AFIM00181" ATTRIBUTE(BORDER)
