...
#Propietario       => E.F.P.                                                #
#Programa AFIM002  => MANTENIMIENTO DE DIRECCIONES SOLICITUDES AFILIACION   #
...
#pp-------------------------
    ...
    OPEN WINDOW ventana_3 AT 2,2 WITH FORM "AFIM0021" ATTRIBUTE(BORDER)
    DISPLAY " AFIM002           MANTENIMIENTO SOLICITUDES AFILIACION                        " AT 3,1 ATTRIBUTE(REVERSE)
        ...
        ON KEY ( ESC )
             ...
             IF aux_pausa MATCHES "[Ss]" THEN
                ...
                SET    nss            = g_afiliados.n_seguro   ,
                       n_folio        = g_parametro1           ,
                       tipo_solicitud = g_parametro4           ,
                ...
                IF g_afiliados.tipo_solicitud = 1   OR
                   ...
                   g_afiliados.tipo_solicitud = 12  AND 
                   g_afiliados.marca_envio    = 'X' THEN
