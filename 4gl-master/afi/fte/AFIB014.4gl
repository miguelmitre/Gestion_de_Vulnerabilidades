...
#Propietario       => E.F.P.                                               #
#Programa AFIB014  => CONSULTA CERTIFICACION LIBERACION PENDIENTES         #
...
#pp-------------------------
    ...
    DISPLAY " AFIB014    CONSULTA RESULTADO CERTIF LIBERACION PENDIENTES                    " AT 3,1 ATTRIBUTE(REVERSE)

    DISPLAY HOY USING "DD-MM-YYYY" AT 3,67 ATTRIBUTE(REVERSE)

    MENU " Certificacion Lib Pendientes "
...
#C-----------------
    ...
    FOREACH cursor_c INTO reg[pos].n_seguro THRU reg[pos].fentcons
        ...
        IF reg[pos].cod_operacion = '03' OR
           reg[pos].cod_operacion = '90' THEN
        ...
        IF reg[pos].cod_operacion = '62' OR
           reg[pos].cod_operacion = '63' OR
           reg[pos].cod_operacion = '64' OR
           reg[pos].cod_operacion = '65' OR
           reg[pos].cod_operacion = '66' OR
           reg[pos].cod_operacion = '67' THEN
