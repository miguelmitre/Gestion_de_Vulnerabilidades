...
#Propietario       => E.F.P.                                               #
#Programa AFIB023  => CONSULTA CERTIFICACION DE NO AFILIADOS               #
...
#pp-------------------------
    ...
    DISPLAY " AFIB023     CONSULTA RESULTADO CERTIFICACION NO AFILIADOS                     " AT 3,1 ATTRIBUTE(REVERSE)

    DISPLAY HOY USING "DD-MM-YYYY" AT 3,67 ATTRIBUTE(REVERSE)

    MENU " Certificacion Independientes "
