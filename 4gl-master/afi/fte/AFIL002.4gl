...
#Propietario       => E.F.P. 					       #
#Programa AFIL002  => CARTA DE ENVIO DE ACEPTACION AL AFILIADO (REG.)  #
#Sistema           => AFI  					       #
...
#DEFER INTERRUPT
    ...
    OPEN WINDOW ventana_1 AT 2,2 WITH FORM "AFIL0021" ATTRIBUTE(BORDER)
    DISPLAY " AFIL002           CARTAS AFILIADOS POR REGISTO ACEPTADOS                      " AT 3,1 ATTRIBUTE(REVERSE)
	...
	IF aux_pausa MATCHES "[Ss]" THEN
	    ...
	    LET G_LISTA =  g_paramgrales.ruta_spool CLIPPED,"/",
                           g_usuario CLIPPED,".CARTAS_ACEP_REG.",
...
SKIP 2 LINES
	...
	PRINT '\033e\033(10U\033&l0O\033&k0S\033&l6d\033(s0B'
        PRINT
            COLUMN 04,"CERTIFICADO DE REGISTRO EN ADMINISTRADORA DE FONDOS PARA EL RETIRO "
        SKIP 1 LINES
        PRINT
                      #123456789012345678901234567890123456789012345678901234567890123456789012
            COLUMN 04,"USTED HA QUEDADO  FORMALMENTE  REGISTRADO  EN  ESTA  ADMINISTRADORA EN"
        PRINT
            COLUMN 04,"CUMPLIMIENTO  A SU  SOLICITUD DE REGISTRO  PRESENTADA.  ESTE DOCUMENTO"
        PRINT
