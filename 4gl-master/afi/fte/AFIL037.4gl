...
#Propietario       => E.F.P.                                                #
#Programa AFIL037  => RESULTADOS DEL PROCESO DE MODIFICACIONES              #
...
#pp-------------------------
    ...
    OPEN WINDOW AFIL0371 AT 4,4 WITH FORM "AFIL0371" ATTRIBUTE(BORDER)
    DISPLAY " AFIL037   REPORTE DEL RESULTADO DE MODIFICACIONES DE PROCESAR                 " AT 3,1 ATTRIBUTE(REVERSE)
  ...
  LET reg_mod.fecha_lote = MDY(fecha_lote[5,6],fecha_lote[7,8],fecha_lote[1,4])
    ...
    SELECT @folio_rec, @id_rec, @status_rec
      INTO reg_mod.folio_rec, reg_mod.id_rec, reg_mod.status_rec 
...

{
            ...
            COLUMN 46,"NOMBRE"     ,
            COLUMN 87,"SOLICITUD " ,
            COLUMN 98,"DOCTO. PROBATORIO" ,
            COLUMN 117,"DIAG" ,
            COLUMN 123,"DESCRIPCION " ,
            COLUMN 192,"USUARIO"
}
        PRINT '\033e\033(10U\033&l1O\033&k2S\033&l12d'  
        PRINT
    ...
    ON EVERY ROW
        ...
        PRINT   
            ...
            COLUMN 175,reg_mod.status_rec USING "----"

{ 
            COLUMN 01,reg_mod.nss_solicitud       ,
            COLUMN 13,reg_mod.curp_solicitud      ,
            COLUMN 32,reg_mod.rfc_trabajador      ,
            COLUMN 46,nombre                 CLIPPED,
            COLUMN 87,reg_mod.tipo_solicitud USING "&"  ,
            COLUMN 89,reg_mod.folio_solicitud USING "--------" ,
            COLUMN 98,reg_mod.tip_prob          ,
            COLUMN 100,reg_mod.doc_prob          ,
            COLUMN 117,reg_mod.cod_operacion CLIPPED,
            COLUMN 119,reg_mod.diag_proceso       ,
            COLUMN 123,reg_mod.descripcion   CLIPPED,
            COLUMN 171,reg_mod.usuario
}
