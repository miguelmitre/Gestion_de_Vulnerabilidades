...
#Propietario       => E.F.P. 					       #
#Programa AFIL006  => CARTA DE ENVIO DE RECHAZO AL AFILIADO (TRASP)    #
#Sistema           => AFI. 					       #
...
#DEFER INTERRUPT
    ...
    DISPLAY " AFIL006          CARTAS DE RECHAZOS DE AFILIACION (TRASP)                     " AT 3,1 ATTRIBUTE(REVERSE)
	...
	IF aux_pausa MATCHES "[Ss]" THEN
	    ...
	    LET G_LISTA =  g_paramgrales.ruta_spool CLIPPED,"/",g_usuario CLIPPED,".CARTAS_RECH_TRASP_",HOY USING "DD-MM-YY","_",hora CLIPPED
	    ...
	    LET G_LISTA =  "chmod 777 ",g_paramgrales.ruta_spool CLIPPED ,"/",g_usuario CLIPPED,".CARTAS_RECH_TRASP_",HOY USING "DD-MM-YY","_",hora CLIPPED
            RUN G_LISTA
        ELSE
