...
#i---------------
	...
	DATABASE safre_tmp
	DROP TABLE tmp_cza_notifica
	DROP TABLE tmp_det_notifica
	DROP TABLE tmp_sum_notifica
...
create table tmp_cza_notifica 
  (
    ...
    cve_ent_genera char(3),
    f_transf_lote date,
    consec_dia decimal(9,0)
  );

create table tmp_sum_notifica 
  (
    tipo_registro char(2),
    tipo_ent_origen char(2),
    cve_ent_origen char(3),
    ...
    f_transf_lote date,
    consec_dia decimal(9,0),
    no_reg_entrada decimal(9,0),
    no_reg_salida decimal(9,0)
  );
...
#-------------------------
    ...
    FOREACH cursor_1 INTO carga_reg
        ...
        IF cont_reg = 1 THEN
            ...
            INSERT INTO safre_tmp:tmp_cza_notifica
            VALUES (campo_011,
                    campo_012,
                    campo_013,
                    campo_014,
        ...
        IF cont_reg = total_reg THEN
            ...
            INSERT INTO safre_tmp:tmp_sum_notifica
            VALUES (campo_201,
                    campo_202,
                    campo_203,
                    campo_204,
