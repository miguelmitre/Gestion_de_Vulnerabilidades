...
-- Propietario  => E.F.P.                                                    --
-- Programa     => COMB028                                                   --
-- Descripcion  => Agrupa com_comis_detalle comision tipo C de com tipo b    --
-- Sistema      => COM                                                       --
...
MAIN
   ...
   LET vmensaje = "COMISION TIPO CB CALCULADA"
...
---   WHERE  estado_comision = 90 -- c/c TC bim numsm>=8 en 1ra rec
  WHERE  estado_comision in(85,95) -- c/c TC bim numsm>=8 en 1ra rec y com TB
   GROUP  BY 1,2,3,4,12
   ORDER  BY 1,2,3,4
   ...
   FOREACH cursor_1 INTO g_reg.*
      ...
      INSERT INTO com_comis_resumen VALUES  
        (g_reg.codven,            # codven
         ...
         0,                       # total_bono
         25,                      # estado_comision --agp c/c TC numsms>=8 1r re
         hoy,                     # fecha_calculo
         g_usuario,               # usuario
         0,                       # consolida
         0)                       # pago      
      ...
      LET cla_sel = "UPDATE com_comis_detalle ",
                    "SET    estado_comision = 115,",  -- Agrupado con salario
                    "       fecha_calculo = ","'",hoy,"'",
                   " WHERE  estado_comision in(85,95) ", 
