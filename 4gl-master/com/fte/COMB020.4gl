...
-- Propietario  => E.F.P.                                                    --
-- Programa     => COMB020                                                   --
-- Descripcion  => Agrupa com_comis_detalle comision tipo B en comis_resumen --
-- Sistema      => COM                                                       --
...
MAIN
   ...
   LET vmensaje = "COMISION TIPO B CALCULADA"
...
FUNCTION Proceso_principal()
   ...
   WHERE  estado_comision = 60 -- con pago por num_sm<8 y cunple 5 afiliaciones
   GROUP  BY 1,2,3,4,12
   ORDER  BY 1,2,3,4
...

{
      INSERT INTO com_comis_resumen VALUES  
        (g_reg.codven,            # codven
         ...
         0,                       # total_bono
         10,                      # estado_comision --agrupacion num_sm<8 y 5afi
         hoy,                     # fecha_calculo
         g_usuario,               # usuario
         0,                       # consolida
         0)                       # pago      
      ...
      LET cla_sel = "UPDATE com_comis_detalle ",
                    "SET    estado_comision = 70,",  -- Agrupado con salario
                    "       fecha_calculo = ","'",hoy,"'",
                   " WHERE  estado_comision = 60 ", 
