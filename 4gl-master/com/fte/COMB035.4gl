...
-- Propietario  => E.F.P.                                                    --
-- Programa     => COMB034                                                   --
-- Descripcion  => Calcula comision donde edo_comis in (240)     de          --
--              => com_comis_detalle de acuerdo a 1ra recaudacion            --
-- Sistema      => COM                                                       --
-- Autor        => GERARDO ALFONSO VEGA PAREDES                              --
-- Fecha        => 06 diciembre 2004.                                        --
-- Modificado   =>                                                           --
-- Fecha        =>                                                           --
-------------------------------------------------------------------------------
...
FUNCTION Calculo_afiliacion()
   ...
   WHERE  estado_comision = 240
   AND    fecha_corte = "11/19/2004"
----   AND    nivel = 1
   GROUP  BY 1
   ORDER  BY 1
