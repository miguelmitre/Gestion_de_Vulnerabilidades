...
MAIN
	...
	OPEN WINDOW ventana_1 AT 2,2 WITH FORM "COMC0201" ATTRIBUTE( BORDER)
	DISPLAY " COMC020  PAGO DE COMISIONES A SUBDIRECTORES DESCUE. NO APORTE                " AT 3,1 ATTRIBUTE(REVERSE) 
 ...
 OUTPUT
  ...
  FORMAT
     PAGE HEADER
      ...
      PRINT COLUMN 02,'\033(s7B',"COMC020                                                                                                                                     ",today USING "dd-mm-yyyy",'\033(s0B'
      SKIP 2 LINE
      PRINT COLUMN 80,'\033(s7B',"REPORTE DE PAGO DE COMISIONES A SUBDIREC.",'\033(s0B'
      PRINT COLUMN 80,'\033(s7B',"       DESCUENTO POR NO APORTE      ",'\033(s0B'
      SKIP 1 LINE
    ...
    BEFORE GROUP OF lnuevo.niv_sup
      ...
      PRINT COLUMN 01,'\033(s7B',"COD GERENTE   NOMBRE GERENTE                     GRP VENTA   FECHA CORTE           MASA SALARIAL   SAMS          ADELANTO     DESCUENTO  ",'\033(s0B'
...
--    VALUES(lnuevo.codven,lnuevo.nombre_pro,lnuevo.coduni_n1,lnuevo.n_folio,lnuevo.nss,lnuevo.nombre_cli,lnuevo.tipo_solicitud,lnuevo.salario_base_comis,lnuevo.num_sm,val_porcen,lnuevo.monto_comision)
      ...
      SKIP  1 LINES
      PRINT COLUMN 085,'_________________________________________TOTALES POR SUBDIRECCION___________________________________________'
...
FUNCTION Busca_gerentes(vcoduni_n1)
   ...
   OPEN WINDOW ventana_2 AT 9,2 WITH FORM "COMC0202" 
...
FUNCTION Mostrar_nombre2(vcoduni_n1)
   ...
   OPEN WINDOW ventana001 AT 09,2 WITH FORM "COMC0204" 
