...
MAIN
   ...
   LET vmensaje = "COMISION TIPO C CALCULADA 2da RECAUDACION"
   ...
   DISPLAY "FIN CALCULO TIPO C 2da RECAUDACION"
...
FUNCTION Proceso_principal()
   ...
   WHERE  estado_comision = 130 -- c/c TC bim numsm>=8 en 2ra rec
   GROUP  BY 1,2,3,4,12
   ORDER  BY 1,2,3,4
...

{
      INSERT INTO com_comis_resumen VALUES  
        (g_reg.codven,            # codven
         ...
         0,                       # total_bono
         30,                      # estado_comision --agp c/c TC numsms>=8 1r re
         hoy,                     # fecha_calculo
         g_usuario,               # usuario
         0,                       # consolida
         0)                       # pago      
      ...
      LET cla_sel = "UPDATE com_comis_detalle ",
                    "SET    estado_comision = 150,",  -- Agrupado con salario
                    "       fecha_calculo = ","'",hoy,"'",
                   " WHERE  estado_comision = 130 ", 
