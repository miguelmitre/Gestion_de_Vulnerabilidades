...
MAIN
	...
	DEFER INTERRUPT
        ...
        CALL STARTLOG("COMC013D.log")

        LET xfecha_corte2 = ARG_VAL(1)
...
FUNCTION imprime()
   ...
   END RECORD,
    ...
    LET G_IMPRE = g_param_dis.ruta_rescate CLIPPED,"/",g_usuario CLIPPED,
                              ".RESDO_CTA_PENDI",HOY USING "DDMMYYYY"

    LET G_LISTA = g_param_dis.ruta_rescate CLIPPED,"/",g_usuario CLIPPED,
                              ".AEDO_CTA_PENDI",HOY USING "DDMMYYYY"
    ...
    LET cla_sel ="SELECT b.n_folio,               ",
                 ...
                 "       tab_status_afi c,        ",
                 "       pro_mae_promotor p       ",
                 "WHERE b.frecafor <= '",xfecha_corte2 CLIPPED,
