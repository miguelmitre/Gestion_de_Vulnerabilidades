...
#                  => DESCUENTO POR NO APORTE DETALLE                          #
#Fecha             => 07 Feb  2005.        	                                  #
...
MAIN
	...
	OPEN WINDOW ventana_1 AT 2,2 WITH FORM "COMC0221" ATTRIBUTE( BORDER)
	DISPLAY " COMC022   REPORTE DE PAGO DE COMISIONES DESCUENTO POR NO APORTE                     " AT 3,1 ATTRIBUTE(REVERSE) 
 ...
 OUTPUT
  ...
  FORMAT
     PAGE HEADER
      ...
      PRINT COLUMN 02,'\033(s7B',"COMC022                                                                                                                                     ",today USING "dd-mm-yyyy",'\033(s0B'
      SKIP 2 LINE
    ...
    BEFORE GROUP OF lnuevo.niv_sup
      ...
      PRINT COLUMN 05,"FOLIO        NSS        NOMBRE DEL TRABAJADOR                      TIPO SOLICITUD     SALARIO       SAMS     %CELDA      ADELANTO         DESCUENTO"
    ...
    ON EVERY ROW
      ...
      PRINT COLUMN 004,lnuevo.n_folio              USING "&&&&&&&&&",
       ...
       COLUMN 121,lnuevo.adelanto                  USING "#########&&.&&",
       column 137,lnuevo.monto_comision            USING "#########&&.&&"
...
--    VALUES(lnuevo.codven,lnuevo.nombre_pro,lnuevo.coduni_n1,lnuevo.n_folio,lnuevo.nss,lnuevo.nombre_cli,lnuevo.tipo_solicitud,lnuevo.salario_base_comis,lnuevo.num_sm,val_porcen,lnuevo.monto_comision)
      ...
      PRINT COLUMN 085,GROUP SUM(lnuevo.salario_base_comis) USING "#########&&.&&","   ",GROUP SUM(lnuevo.num_sm) USING "####&.&&","           ",GROUP SUM(lnuevo.adelanto) USING "#########&&.&&","  ",GROUP SUM(lnuevo.monto_comision) USING "#########&&.&&"," ",GROUP SUM(lnuevo.comis_pagada) USING "#########&&.&&"
      PRINT COLUMN 085,'    SUBT_SALA.    SUBT_SAMS             SUBT_ADELANTO     SUBT_DESCUEN.  DESCUE_EJECU.'
      SKIP  2 LINES
      ...
      PRINT COLUMN 085,GROUP SUM(lnuevo.salario_base_comis) USING "#########&&.&&","   ",GROUP SUM(lnuevo.num_sm) USING "####&.&&","           ",GROUP SUM(lnuevo.adelanto) USING "#########&&.&&","  ",GROUP SUM(lnuevo.monto_comision) USING "#########&&.&&"," ",GROUP SUM(lnuevo.comis_pagada) USING "#########&&.&&"
      PRINT COLUMN 085,'    TOTA_SALA.    TOTA_SAMS             TOTA_ADELANTO   TOTA_DESCUEN.  DESCUE_EJECU.'
      ...
      PRINT COLUMN 085,'_____________________________________________________________________________________'
      PRINT COLUMN 085,SUM(lnuevo.salario_base_comis) USING "#########&&.&&","   ",SUM(lnuevo.num_sm) USING "####&.&&","           ",SUM(lnuevo.adelanto) USING "#########&&.&&","  ",SUM(lnuevo.monto_comision) USING "#########&&.&&"," ",SUM(lnuevo.comis_pagada) USING "#########&&.&&"
      PRINT COLUMN 085,'    TOTA_SALA.    TOTA_SAMS             TOTA_ADELANTO     TOTA_DESCUEN.  DESCUE_EJECU.'
      PRINT COLUMN 085,'_____________________________________________________________________________________'
      PRINT COLUMN 085,'_____________________________________________________________________________________'
   ...
   DEFINE
      ...
      ban_agregados SMALLINT 
       ...
       LET cla_sel2="SELECT a.codven,a.coduni_n1,", 
                    ...
                    "trim(b.materno)",
        "FROM   safre_tmp:com_comis_detalle a,pro_mae_promotor b ", --quitar
                    "WHERE ",cla_where CLIPPED,
...
FUNCTION Busca_afiliados(vcodven,vcoduni_n1)
   ...
   OPEN WINDOW ventana_2 AT 9,2 WITH FORM "COMC0222" 
...
LET      g_grep_01  =
         'SELECT  MAX(a.fecha_corte),SUM(a.monto_comision) ',
...
FUNCTION Mostrar_nombre2(vnss)
   ...
   OPEN WINDOW ventana001 AT 09,2 WITH FORM "COMC0224" 
