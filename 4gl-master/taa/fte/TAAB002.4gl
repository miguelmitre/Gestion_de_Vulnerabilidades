...
#Propietario       => E.F.P.                                          #
#Programa TAAB002  => LANZA PROVISION REGISTROS DE APORTACIONES       #
...
#   Adecuaciones para multi-siefores                                  #
#Sistema           => TRA                                             #
#######################################################################
...
FUNCTION abre_ventana()
    ...
    DISPLAY " TAAB002                INCORPORAR REGISTROS DE TRASPASOS                      " AT 3,1 ATTRIBUTE(REVERSE)
...
FUNCTION lanza_provision()
    ...
    UPDATE taa_ctr_traspaso
       SET ini_provision = fecha_ini,
           usr_provision = vusuario
     WHERE folio = vfolio
    ...
    LET exe_nohup = "nohup fglgo ",g_param_taa.ruta_exp CLIPPED,
                    "/TAAB0021 ",vfolio, " &"
    RUN exe_nohup
