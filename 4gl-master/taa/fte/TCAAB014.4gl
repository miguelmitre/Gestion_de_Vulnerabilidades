...
#pp-------------------------
    ...
    DISPLAY " TCAAB014         VERIFICA DEVOLUCION VALIDACION DOCUMENTAL               " AT 3,1 ATTRIBUTE(REVERSE)
...
#C-----------------
    ...
    DISPLAY "FP: ", fecha_presentacion AT  5,60 ATTRIBUTE(REVERSE)
    ...
    LET sel_where = " SELECT a.n_seguro,",
                    ...
                    " AND a.tipo_traspaso IN (",individual ,",",   
                                                unificacion,",",
                                                asig_uni   ,",",
                                                asignacion ,")",
                    ...
                    " AND b.subcuenta  BETWEEN 0 AND 99",
                    " AND b.tipo_movimiento BETWEEN 0 AND 9999",
                    " AND a.tipo_traspaso = ",individual CLIPPED,
                    " AND a.estado = ",procedente CLIPPED,
                    " GROUP BY 1,3,4,5",
                    " ORDER BY 3,2 DESC"
    ...
    IF (pos-1) >= 1 THEN
        DISPLAY " <F1> Datos Generales  <F2>Saldos <Enter>Captura                               " AT 4,1 ##ATTRIBUTE(REVERSE)
...
#c01-----------------------------------------
   ...
   DISPLAY "                        CAPTURA DE ESTADO DE ",
	        "RECHAZO                           " AT 3,1 ATTRIBUTE(REVERSE)
  ...
  { 
        ...
        ON KEY(ACCEPT)
	     ...
	     ON KEY (CONTROL-C)
            ...
            PROMPT "CAPTURA CANCELADA....<ENTER> PARA CONTINUAR" FOR enter
            LET var = captura_no_cambio
            EXIT INPUT
...
LET f_b = 1
    ...
    DISPLAY" TCAAB0145      VERIFICA DEVOLUCION VALIDACION DOCUMENTAL                 " AT 3,1 ATTRIBUTE(REVERSE)   
