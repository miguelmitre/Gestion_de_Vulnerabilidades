...
#i---------------
    ...
    LET G_IMPRE = g_seg_modulo.ruta_listados CLIPPED,"/",g_usuario CLIPPED,
                  ".LIQ_REC.",HOY USING "DDMMYY", "_",hora CLIPPED
...
#pp-------------------------
    ...
    DISPLAY " TAAL003 " AT 3,1 ATTRIBUTE(REVERSE)
    DISPLAY HOY USING " dd-mm-yyyy " AT 3,60 ATTRIBUTE(REVERSE)

    MENU "MENU "
        COMMAND "Consulta " "Consulta de Montos Liquidados Afore Receptora"
            CALL Consulta()
...
#c-----------------
    ...
    OPEN WINDOW ventana_21 AT 10,4 WITH FORM "TAAL0032" ATTRIBUTE( BORDER)
    ...
    LET sel_where = " SELECT d.siefore, ",
                           ...
                           " d.fecha_valor ",
                    " FROM   dis_cuenta d , tab_subcuenta t, tab_siefore_local s",
    ...
    IF (pos-1) >= 1 THEN
        ...
        OPEN WINDOW ventana_2 AT 6,2 WITH FORM "TAAL0031" ATTRIBUTE( BORDER)
        DISPLAY " CONSULTA " AT 1,50 ATTRIBUTE(REVERSE,green)
        DISPLAY " (Ctrl-C) Salir            (Ctrl-P) Imprimir                               " AT 1,1 ATTRIBUTE(REVERSE,green)
        DISPLAY " TAAL003     Consulta de Montos Liquidados Afore  Receptora                " AT 2,1 ATTRIBUTE(REVERSE,green)
...
#ri---------------------
    ...
    FORMAT
        FIRST PAGE HEADER
            ...
            PRINT COLUMN 12,"TAAL003",
                  COLUMN 25,"LISTADO DE LIQUIDACION AFORE / AFORE (RECEPTORA)",
                  COLUMN 75, TODAY USING "mm/dd/yyyy"
            SKIP 1 LINE
            PRINT COLUMN 12,vcod_afo USING "###","  ",vdesc_afo
            PRINT 
            PRINT COLUMN 12,"Folio :",v_folios CLIPPED,
                  COLUMN 82, "Fecha Liquidacion:  ", v_fecha_valor
            SKIP 1 LINE
            PRINT
        ...
        PAGE HEADER
            PRINT COLUMN 2,"TAAL003",
                  COLUMN 10,"LISTADO DE LIQUIDACION AFORE / AFORE (RECEPTORA)",
                  COLUMN 75, TODAY USING "mm/dd/yyyy"
            SKIP 1 LINE
            PRINT COLUMN 12,vcod_afo USING "###","  ",vdesc_afo
            PRINT 
