...
GLOBALS
   ...
   DEFINE    
             ...
             g_usuario                         CHAR(008) 
   DEFINE
             g_sie          ARRAY[35,40]   OF   RECORD
             acciones                          DEC(16,6),
             pesos                             DEC(16,6),
             pesos2d                           DEC(16,2)
                                          END  RECORD
   DEFINE
             g_saldos       ARRAY[35]     OF   RECORD
             acciones                          DEC(16,6),
             pesos                             DEC(16,2)
                                          END  RECORD
   DEFINE
             g_sumario      ARRAY[35]     OF   RECORD
             nom_scta                          CHAR(30),
             scta_proc                         CHAR(02),
             pesos                             DEC(15,2),
             acciones                          DEC(16,6)
                                          END  RECORD
   DEFINE
             g_sum_rep      ARRAY[35,40]   OF   RECORD
             pesos                             DEC(16,6),
             acciones                          DEC(16,6)
                                          END  RECORD
...
FUNCTION    F_015_prepara_querys_TCAAB006()
   ...
   PREPARE  sql_12_1             FROM  g_sql_12_1
   PREPARE  sql_12_2             FROM  g_sql_12_2
   PREPARE  sql_12_3             FROM  g_sql_12_3
   PREPARE  sql_12_4             FROM  g_sql_12_4
  ...
  ###########     registro  de  detalle_02  de   vivienda       ############
     ...
     PRINT    COLUMN   01                                ,
             "02"                                        ,           #id_1
              ...
              15      SPACES                          ,              #id_41_viv
              98      SPACES                          ,              #id_42_viv
              g_num_aport_viv92        USING  "&&&&&" ,              #id_43_viv
              2       SPACES                          ,              #id_44_viv
              "00000"                  USING  "&&&&&" ,              #id_45_viv
              10      spaces                          ,              #id_46_viv
              g_num_aport_viv_issste   USING  "&&&&&" ,              #id_47_viv
              6       spaces                                         #id_48_viv
     LET      g_num_registro          =  g_num_registro  +  1
     IF       g_tot_bloques_rcv       <  8   THEN
              LET      g_bloques_rcv_reg_1    =  g_bloques_rcv   CLIPPED
     ...
     PRINT    COLUMN   01,
              ...
              54       SPACES,                                       #id_12
              g_today                            USING  "YYYYMMDD",  #id_13_rcv
              27      SPACES ,                                       #id_14
              g_cta_transfe_56_anios                               , #id_15
              33      SPACES,                                        #id_16_rcv
              g_bloques_rcv_reg_1,                                #id_17_64_rcv
              g_cod_result_operac,                                   #id_65_rcv
              g_diag_proceso,                                        #id_66_rcv
              33       SPACES                                        #id_67_rcv
