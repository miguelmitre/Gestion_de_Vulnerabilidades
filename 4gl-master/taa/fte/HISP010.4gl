...
CALL STARTLOG("HISP010.log")
    ...
    DISPLAY" HISP001       HISTORICO COMP DE TRASPASOS AFORE - AFORE                       " AT 3,1 ATTRIBUTE(REVERSE)   
...
END IF
     ...
     AFTER FIELD fecha_fin
       ...
       ELSE
         ...
         AND    fecha_liquidacion BETWEEN reg_1.fecha_ini AND reg_1.fecha_fin
         GROUP BY  1
          IF STATUS = NOTFOUND THEN
...
WHERE fecha_liquida  BETWEEN reg_1.fecha_ini AND reg_1.fecha_fin
AND   estado = 103
...
ATTRIBUTE(REVERSE)
SLEEP 4
LET lanza_proc = "nohup fglgo HISB010 ",reg_1.fecha_ini CLIPPED," ",
