...
#Por             => MARCO ANTONIO GONZALEZ ROJAS PARA LA VERSION 3          #
#Sistema         => TCAA                                                    #
#Programa        => TCAAL007(ESTE PROGAMA SE  INTEGRA CON EL OBJ GLOB_CFOLS)#
#############################################################################
DATABASE safre_af
...
#C-----------------
    ...
    PREPARE  qry_consul2   FROM g_sql_02_a
    DECLARE  cursor_c2     CURSOR FOR   qry_consul2


    LET      i_arr_1      =  0
    FOREACH  cursor_c2     INTO  g_reg_1.*,g_desc_estado
