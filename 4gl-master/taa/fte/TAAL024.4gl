...
#i---------------
    ...
    LET G_IMPRE = g_seg_modulo.ruta_listados CLIPPED,"/",g_usuario CLIPPED,
                  ".PROV_REC_VIRT.",HOY USING "DDMMYY", "_",hora CLIPPED
...
#pp-------------------------
    ...
    DISPLAY " TAAL024 " AT 3,1 ATTRIBUTE(REVERSE)
    DISPLAY HOY USING " dd-mm-yyyy " AT 3,60 ATTRIBUTE(REVERSE)

    MENU "MENU "
        COMMAND "Consulta " "Consulta de Provision Virtual Afore Receptora"
            CALL Consulta()
...
#c-----------------
    ...
    OPEN WINDOW ventana_21 AT 10,4 WITH FORM "TAAL0242" ATTRIBUTE( BORDER)
    ...
    LET sel_where = " SELECT d.siefore, ",
                           ...
                           " d.fecha_valor ",
                           #" TODAY ",
                    " FROM   dis_provision_virt d , tab_subcuenta t, tab_siefore_local s",
    ...
    IF (pos-1) >= 1 THEN
        ...
        OPEN WINDOW ventana_2 AT 6,2 WITH FORM "TAAL0241" ATTRIBUTE( BORDER)
        DISPLAY " CONSULTA " AT 1,50 ATTRIBUTE(REVERSE,green)
        DISPLAY " (Ctrl-C) Salir            (Ctrl-P) Imprimir                               " AT 1,1 ATTRIBUTE(REVERSE,green)
        DISPLAY " TAAL024         Consulta Provision Virtual Afore  Receptora               " AT 2,1 ATTRIBUTE(REVERSE,green)
...
#ri---------------------
    ...
    FORMAT
        FIRST PAGE HEADER
            ...
            PRINT COLUMN 12,"TAAL024",
                  COLUMN 25,"LISTADO DE PROVISION VIRTUAL AFORE / AFORE (RECEPTORA)",
                  COLUMN 75, TODAY USING "mm/dd/yyyy"
            SKIP 1 LINE
            PRINT COLUMN 12,vcod_afo USING "###","  ",vdesc_afo
            PRINT 
            PRINT COLUMN 12,"Folio :",v_folios CLIPPED,
                  COLUMN 82, "Fecha Provision Virtual:  ", v_fecha_valor
                  #COLUMN 82, "Fecha Provision Virtual:  ", HOY
            SKIP 1 LINE
            PRINT
        ...
        PAGE HEADER
            PRINT COLUMN 2,"TAAL024",
                  COLUMN 10,"LISTADO DE PROVISION VIRTUAL AFORE / AFORE (RECEPTORA)",
                  COLUMN 75, TODAY USING "mm/dd/yyyy"
            SKIP 1 LINE
            PRINT COLUMN 12,vcod_afo USING "###","  ",vdesc_afo
            PRINT 
