...
FUNCTION inicio()
    ...
    DISPLAY " TAAL005 " AT 3,1 ATTRIBUTE(REVERSE)
    DISPLAY HOY USING " dd-mm-yyyy " AT 3,60 ATTRIBUTE(REVERSE)
        
    MENU "MENU "
       COMMAND "Consulta " "Reporte liquidacion siefores cedentes."
           CALL Consulta()
...
FUNCTION Consulta()
    CLEAR SCREEN
    OPEN WINDOW ventana_21 AT 10,4 WITH FORM "TAAL0051" ATTRIBUTE( BORDER)
    ...
    IF (pos-1) >= 1 THEN
       ...
       ERROR ""
       OPEN WINDOW ventana_2 AT 2,4 WITH FORM "TAAL0052" ATTRIBUTE( BORDER)
       DISPLAY " CONSULTA " AT 1,50 ATTRIBUTE(REVERSE)
       DISPLAY " (Ctrl-C) Salir                                    (Ctrl-P) Imprimir    " AT 1,1 ATTRIBUTE(REVERSE,green)
       DISPLAY " TAAL004           Montos de Liquidacion Siefores Cedentes                     " AT 3,1 ATTRIBUTE(REVERSE,green) 
...
#cm-------------------
    DEFINE qry_llena_rcv     CHAR(1200)
    ...
    " SELECT a.folio          ,",
         ...
         " a.cve_subcta_1     ,",
         " a.prctj_subc_1     ,",
         " a.no_tot_acc_1 * b.precio_del_dia ,",
         " a.no_tot_acc_1     ,",
         " a.siefore_1        ,",
         " b.precio_del_dia    ",
    " FROM taa_rcv_recepcion a, taa_accion_siefore b ",
   " WHERE ",cla_where        ,
     " AND a.cve_subcta_1 IS NOT NULL ",
     " AND a.siefore_1 = b.desc_siefore ",
     " AND a.fecha_mov_banxico = b.fecha_valuacion "
    ...
    " SELECT a.folio          ,",
         ...
         " a.cve_subcta_2     ,",
         " a.prctj_subc_2     ,",
         " a.no_tot_acc_2 * b.precio_del_dia ,",
         " a.no_tot_acc_2     ,",
         " a.siefore_2        ,",
         " b.precio_del_dia    ",
    " FROM taa_rcv_recepcion a, taa_accion_siefore b ",
   " WHERE ",cla_where        ,
     " AND a.cve_subcta_2 IS NOT NULL ",
     " AND a.siefore_2 = b.desc_siefore ",
     " AND a.fecha_mov_banxico = b.fecha_valuacion "
    ...
    " SELECT a.folio          ,",
         ...
         " a.cve_subcta_3     ,",
         " a.prctj_subc_3     ,",
         " a.no_tot_acc_3 * b.precio_del_dia ,",
         " a.no_tot_acc_3     ,",
         " a.siefore_3        ,",
         " b.precio_del_dia    ",
    " FROM taa_rcv_recepcion a, taa_accion_siefore b ",
   " WHERE ",cla_where        ,
     " AND a.cve_subcta_3 IS NOT NULL ",
     " AND a.siefore_3 = b.desc_siefore ",
     " AND a.fecha_mov_banxico = b.fecha_valuacion "
    ...
    " SELECT a.folio          ,",
         ...
         " a.cve_subcta_4     ,",
         " a.prctj_subc_4     ,",
         " a.no_tot_acc_4 * b.precio_del_dia ,",
         " a.no_tot_acc_4     ,",
         " a.siefore_4        ,",
         " b.precio_del_dia      ",
    " FROM taa_rcv_recepcion a, taa_accion_siefore b ",
   " WHERE ",cla_where        ,
     " AND a.cve_subcta_4 IS NOT NULL ",
     " AND a.siefore_4 = b.desc_siefore ",
     " AND a.fecha_mov_banxico = b.fecha_valuacion "
    ...
    " SELECT a.folio          ,",
         ...
         " a.cve_subcta_5     ,",
         " a.prctj_subc_5     ,",
         " a.no_tot_acc_5 * b.precio_del_dia ,",
         " a.no_tot_acc_5     ,",
         " a.siefore_5        ,",
         " b.precio_del_dia    ",
    " FROM taa_rcv_recepcion a, taa_accion_siefore b ",
   " WHERE ",cla_where        ,
     " AND a.cve_subcta_5 IS NOT NULL ",
     " AND a.siefore_5 = b.desc_siefore ",
     " AND a.fecha_mov_banxico = b.fecha_valuacion "
    ...
    " SELECT a.folio          ,",
         ...
         " a.cve_subcta_6     ,",
         " a.prctj_subc_6     ,",
         " a.no_tot_acc_6 * b.precio_del_dia ,",
         " a.no_tot_acc_6     ,",
         " a.siefore_6        ,",
         " b.precio_del_dia    ",
    " FROM taa_rcv_recepcion a, taa_accion_siefore b ",
   " WHERE ",cla_where        ,
     " AND a.cve_subcta_6 IS NOT NULL ",
     " AND a.siefore_6 = b.desc_siefore ",
     " AND a.fecha_mov_banxico = b.fecha_valuacion "
    ...
    " SELECT a.folio          ,",
         ...
         " a.cve_subcta_7     ,",
         " a.prctj_subc_7     ,",
         " a.no_tot_acc_7 * b.precio_del_dia ,",
         " a.no_tot_acc_7     ,",
         " a.siefore_7        ,",
         " b.precio_del_dia    ",
    " FROM taa_rcv_recepcion a, taa_accion_siefore b ",
   " WHERE ",cla_where        ,
     " AND a.cve_subcta_7 IS NOT NULL ",
     " AND a.siefore_7 = b.desc_siefore ",
     " AND a.fecha_mov_banxico = b.fecha_valuacion "
    ...
    " SELECT a.folio          ,",
         ...
         " a.cve_subcta_8     ,",
         " a.prctj_subc_8     ,",
         " a.no_tot_acc_8 * b.precio_del_dia ,",
         " a.no_tot_acc_8     ,",
         " a.siefore_8        ,",
         " b.precio_del_dia    ",
    " FROM taa_rcv_recepcion a, taa_accion_siefore b ",
   " WHERE ",cla_where        ,
     " AND a.cve_subcta_8 IS NOT NULL ",
     " AND a.siefore_8 = b.desc_siefore ",
     " AND a.fecha_mov_banxico = b.fecha_valuacion "
...
FUNCTION imprimir()
    ...
    LET G_IMPRE = g_seg_modulo.ruta_listados CLIPPED,"/",g_usuario CLIPPED,
             ".LIS_LIQ_TRA.",HOY USING "DDMMYY","_",hora[1,2], hora[4,5] CLIPPED
    ...
    FORMAT
        FIRST PAGE HEADER
            ...
            PRINT COLUMN 3,"TAAL004",
                  COLUMN 16,"LISTADO DE LIQUIDACION SIEFORE CEDENTES",
