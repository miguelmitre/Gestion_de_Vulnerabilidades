...
#pp-------------------------
    ...
    OPEN WINDOW ventana_1 AT 3,2 WITH FORM "TAAB0121" ATTRIBUTE( BORDER)
...
#C-----------------
    ...
    DISPLAY "      NSS      F PRESENTACION   F LIQUIDACION   FOLIO    TIPO  TRASPASO        " AT 5,1 ATTRIBUTE(REVERSE)
    ...
    FOREACH cursor_c INTO reg[pos].n_seguro THRU reg[pos].estado
        CASE reg[pos].estado
            ...
            WHEN 12 LET reg[pos].desc_estado = 'UNIFICACION'
            WHEN 20 LET reg[pos].desc_estado = 'UNIF X ASIG'
