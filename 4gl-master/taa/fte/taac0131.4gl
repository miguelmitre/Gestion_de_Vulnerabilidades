...
#Propietario       => E.F.P.                                            #
#Programa TAAC013  => CONSULTA NSS TRASPASO DE AFORE CEDENTE            #
...
#i---------------
    ...
    LET      l_qry           =
              ...
              " FROM  safre_tmp:taa_saldos_recep  a ,",
              "       safre_tmp:det_sol_tra_ind     b ,",
              "       afi_mae_afiliado      c ,",
     ...
     LET      l_qry       =
              ...
              "   FROM  safre_tmp:taa_saldos_recep",
              "  WHERE  folio      =  ?",
              "  AND    nss        =  ?",
              "  AND    subcuenta  =  ?"
     LET       l_qry       =  l_qry    CLIPPED
...
----DISPLAY "       NSS     FECHA PRESENTACION     FECHA LIQUIDA   TIPO SOLICITUD ESTADO" AT 5,1 ATTRIBUTE(REVERSE)
    ...
    LET    g_folio     =  0
     SELECT  MAX(a.folio) 
       INTO  g_folio
     FROM    safre_tmp:taa_sum_recep  a,
             safre_tmp:taa_ctr_recep  b
...
#                          tipo_traspaso
    ...
    SELECT   a.fecha_envio_saldos,a.fecha_liquidacion
     ...
     FROM    safre_tmp:taa_ctr_recep a
    WHERE    a.folio              =  g_folio
