...
#Propietario       => E.F.P.                      
#Programa TCREAOP09 => PANTALLA LANZADORA DEL PROCESO TCREAOP09L(OP. 09 )
#Sistema           => TCAA                     
...
GLOBALS "TCREAOP09S.4gl"  #  Definicion  de  SQL
...
FUNCTION    F_010_inicio()
   ...
   LET      lanza_proceso       =  "nohup  fglgo   TCREAOP09L ",
                                   reg_ctr_folio.folio
...
FUNCTION    F_030_busca_folio_pendiente()
   ...
   OPEN     WINDOW    TCREAOP09       AT  2,2
            WITH      FORM     "TCREAOP09"  ATTRIBUTE(BORDER)
   DISPLAY  "TCREAOP09            TRASPASOS  AFORE-AFORE (CEDENTE)       ",
