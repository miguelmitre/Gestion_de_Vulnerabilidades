...
GLOBALS "TCAABX006S.4gl"  #  Definicion  de  SQL

MAIN
    OPTIONS INPUT WRAP,
    PROMPT LINE LAST,
    ACCEPT KEY CONTROL-I
    CALL     STARTLOG("TCAABX006.log")
    CALL     F_010_inicio()
END MAIN
...
FUNCTION  F_010_inicio()
   ...
   DISPLAY  "TCAABX006            TRASPASOS  AFORE-AFORE (CEDENTE)                          " AT  2,2 ATTRIBUTE(REVERSE)   
   ...
   WHILE TRUE
       PROMPT "ESTA SEGURO DE GENERAR EL PROCESO [S/N] ? " FOR g_enter
         ...
         END IF
    END WHILE
   LET lanza_proceso = "nohup fglgo TCAABX006L ",
                        reg_ctr_folio.folio             ," ",
...
FUNCTION  F_010_1_arma_fechas_folio()
   ...
   #fecha fijas --> ACS
    LET reg_ctr_folio.fecha_envio_saldos  ="03/09/2012"
    LET reg_ctr_folio.fecha_liquidacion   ="03/29/2012"
