...
GLOBALS "TCAABX017S.4gl"  #  Definicion  de  SQL

MAIN
    OPTIONS INPUT WRAP,
    PROMPT LINE LAST,
    ACCEPT KEY CONTROL-I
    CALL     STARTLOG("TCAABX017.log")
    CALL     F_010_inicio()
END MAIN
...
#i----------------------
    ...
    IF       g_cuentas_pendientes       >  0   THEN
            ...
            END      WHILE
    END IF
    LET    lanza_proceso = "nohup fglgo TCAABX017L ",
    ...
    RUN lanza_proceso
    DISPLAY "VERIFICAR ARCHIVO: ",paso
    SLEEP 2
END FUNCTION
...
FUNCTION  F_010_1_arma_fechas_folio()
   ...
   WHERE   fecha_envio_saldos      >=  g_today 
   AND     tipo_traspaso            =  1
   ...
   END IF}
    ...
    LET reg_taa_cd_ctr_folio.fecha_envio_saldos ="03/09/2012"
    LET reg_taa_cd_ctr_folio.fecha_liquidacion  ="03/09/2012"
