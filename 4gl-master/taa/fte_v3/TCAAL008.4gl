...
#Sistema         => TCAA                                                    #
#Programa        => TCAAL008(ESTE PROGAMA SE  INTEGRA CON EL OBJ GLOB_REPS) #
#############################################################################
...
#### VAR PARA ARREGLO
    ...
    DEFINE  reg_1        ARRAY[1000]  OF  RECORD
            folio                        INTEGER        ,
...
#sf----------------
    ...
    PREPARE  qry_consul   FROM  g_sql_08
    DECLARE  cursor_08     CURSOR FOR   qry_consul

    LET      i_arr_1      =  0
    FOREACH  cursor_08     INTO  g_reg_1.*,g_desc_estado
