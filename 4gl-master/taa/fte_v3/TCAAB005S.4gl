...
FUNCTION    F_910_arma_querys_TCAAB005S()
   LET      cero                     =  0
   ...
   LET      g_sql_23                 =
            ...
            ' FROM ',  g_tabname      CLIPPED ,' ' ,
            ' WHERE    nss                           =  ? ',
            ' AND      subcuenta                   IN(  ',g_c_scta,'  )' , # CPL-1153
            ' AND      tipo_movimiento               =  1; '
   ...
   LET      g_sql_25_110            =
            ...
            ' FROM ',  g_tabname      CLIPPED ,' ' ,
            ' WHERE    nss                           =  ? ',
            ' AND      subcuenta                     IN ( 10, 23 ) ', # CPL-1153
   ...
   LET      g_sql_41                  =
            ...
            ' EXECUTE PROCEDURE sp_dis_cta_his();' # CPL-1153 Se actualiza la forma en la que se obtiene los historicos de dis_cuenta
...
#Se agrega validación a dis_det_aporte y dis_det_issste
#ACS 16-Mzo-2012
   LET      g_sql_45                  =
            ...
            '                       AND  estado              in (2,4)))',
            ' AND (a.nss in (SELECT n_seguro FROM dis_det_aporte     ',
            '                WHERE folio = a.folio                   ',
            '                AND ident_viv_garantia = 1)             ',
            '      OR a.nss in (SELECT n_seguro FROM dis_det_issste  ',
            '                   WHERE folio = a.folio                ',
            '                   AND ident_viv_garantia = 1));        '
   ...
   LET      g_sql_49                  =
            ...
            ' FROM     safre_af:taa_cd_det_cedido b ',
            ' WHERE    b.folio                     =  ? ',
            ' AND      b.estado              NOT  IN(101,105,108,114,115); '  #  CPL-1296 Se agrega el estado 114-NO REGISTRADO
                                                                              #  CPL-1377 Se agreag el estado 115-ARCHIVO INCORRECTO POR ORIGENES
   ...
   LET      g_sql_66  = 
            ...
            ' AND a.tipo_movimiento NOT IN (SELECT marca_cod FROM taa_cd_tipo_traspaso) '
...
FUNCTION    F_930_arma_precios_acc_parti()
   ...
   IF      INT_FLAG                 =  FALSE     THEN
           ...
           #DISPLAY  g_sie_inf[5].precio_accion      TO  g_precio_accion_b5 # CPL-1225
   ...
   SELECT   codigo_siefore
    ...
    WHERE   codigo_siefore NOT IN(0, 5) #CPL-1225
    ORDER   BY  1
